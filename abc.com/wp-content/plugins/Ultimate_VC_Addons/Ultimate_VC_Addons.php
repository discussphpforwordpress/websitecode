...
Version: 3.16.21
Description: 可视化编辑器扩展插件。更多汉化主题、主题升级、问题咨询请访问：<strong><a href="http://www.4mudi.com">http://www.4mudi.com</a></strong>或我的<a href="http://wordpresszhuti.taobao.com">淘宝店</a>
...
if ( ! class_exists( 'Ultimate_VC_Addons' ) ) {
	...
	class Ultimate_VC_Addons {
		...
		{
			load_plugin_textdomain('ultimate_vc', FALSE, dirname(plugin_basename(__FILE__)).'/languages6851/');
			load_plugin_textdomain('bsf', FALSE, dirname(plugin_basename(__FILE__)).'/languages6851/');
		}
