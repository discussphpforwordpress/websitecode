...
function ult_tab_init() {
	...
	$settings = array(
		...
		array(
			...
			"value" => array('风格1'=>'Style_1','风格2'=>'Style_2','风格3'=>'Style_3','风格4'=>'Style_4','风格5'=>'Style_5','风格6'=>'Style_6'),
			"group" => "常规 ",
		),
		...
		array(
			...
			"value" => array("禁用" =>"Disables","启用" =>"Enable"),
			"group" => "常规 ",
			),
		...
		array(
			...
			'description' => __( '调整你的选项卡部分宽度。留空为全宽.' ),
			"group" => "常规 ",
			),
		array(
			"type" => "ult_switch",
		...
		array(
			'type' => 'textfield',
			'heading' => __( '附加Class名', 'ultimate_vc' ),
			'param_name' => 'el_class',
		...
		array(
			...
			"value" => array('禁用'=>'Disable','启用'=>'Enable'),
		...
		array(
			"type" => "number",
			"class" => "",
			"heading" => __("选项卡边框半径", "ultimate_vc"),
		...
		array(
			...
			"max" => 100,
			"suffix" => "",
			"description" => __("这不会打开激活选项卡", "ultimate_vc"),
			"group" => "选项卡",
			"edit_field_class" => "vc_col-sm-12 vc_column ult_space_border",
		),
		array(
		...
		array(
			...
			"value" => array("启用" =>"Enable","禁用" =>"Disables"),
			"group" => "图标 ",
...
/*-----------typography------------*/
		...
		array(
			...
			"heading" => __("标题字体系列", "imedica"),
			"param_name" => "main_heading_font_family",
			"description" => __("选择字体，你可以在单元格<a target='_blank' href='".admin_url('admin.php?page=bsf-google-font-manager')."'>添加新的</a>.", "imedica"),
			"group" => "排版",
			),

		array(
			"type" => "ultimate_google_fonts_style",
			"heading" 		=>	__("字体风格", "imedica"),
		...
		array(
			"type" => "ultimate_google_fonts",
			"heading" => __(" 字体系列", "smile"),
			"param_name" => "desc_font_family",
			"description" => __("选择字体，你可以在单元格<a target='_blank' href='".admin_url('admin.php?page=bsf-google-font-manager')."'>添加新的</a>.", "smile"),
			"group" => "排版",
			),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			"value" => "",
			"group" =>"Icon",
			"description" => __("点击选择图标。如果你找不到想要的图标，你可以<a href='admin.php?page=bsf-font-icon-manager' target='_blank'>在这里添加</a>.", "smile"),
