    ...
    public function system_status($plugin,$request){
        ...
        <table class="wc_status_table widefat" cellspacing="0" id="status">
        	...
        	<tbody>
        		...
        		<tr>
        			<td><?php echo __('PHP mcrypt:',XH_SOCIAL)?>(可选,解析微信推送消息时使用)</td>
        			<td class="help"><span class="xunhuweb-help-tip"></span></td>
        			<td><?php
        			     if(function_exists('mcrypt_get_block_size')){
        			         ?><span style="color:green;">YES</span><?php
        			     }else{
        			         ?><div style="color: #a00;"><span class="dashicons dashicons-warning"></span> <?php echo sprintf(__("PHP mcrypt extension is missing ,You can <code>%s</code>",XH_SOCIAL),'yum install php70w-mcrypt*');?></div><?php
        			     }
        			?></td>
        		</tr>
        	</tbody>
