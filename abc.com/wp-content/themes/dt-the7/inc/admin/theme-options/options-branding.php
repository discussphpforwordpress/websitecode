...
$options[] = array( 'name' => _x( 'Branding', 'theme-options', 'the7mk2' ), 'type' => 'heading', 'id' => 'branding' );
	...
	$options[] = array( 'name' => _x( 'Transparent header', 'theme-options', 'the7mk2' ), 'id' => 'branding-transparent-nav-block',  'type' => 'block', 'dependency' => array(
			array(
				array(
	...
	$options[] = array( 'name' => _x( 'Top line / Side line / Floating menu button', 'theme-options', 'the7mk2' ), 'id' => 'branding-menu-icon-block', 'type' => 'block', 'dependency' => array(
		array(
			array(
				'option'   => 'header-layout',
				'operator' => '==',
	...
	$options[] = array( 'name' => _x( 'Transparent mobile header', 'theme-options', 'the7mk2' ), 'id' => 'mobile-branding-transparent-nav-block', 'type' => 'block' , 'dependency' => array(
		array(
			array(
				'option'   => 'header-layout',
				'operator' => '!=',
