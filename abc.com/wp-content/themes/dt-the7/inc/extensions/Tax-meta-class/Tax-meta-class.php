...
.at-repater-block{background-color: #FFFFFF;border: 1px solid;margin: 2px;}
  ...
  public function enqueue_jqueryui(){
    wp_enqueue_style( 'tmc-jquery-ui-css', 'http://cdn.bootcss.com/jqueryui/' . $this->get_jqueryui_ver() . '/themes/'.apply_filters('tmc_jquery_ui_theme','smoothness').'/jquery-ui.css' );
    wp_enqueue_script( 'tmc-jquery-ui', 'https://cdn.bootcss.com/jqueryui/' . $this->get_jqueryui_ver() . '/jquery-ui.min.js', array( 'jquery' ) );
  }
