	...
	function presscore_get_share_buttons_list( $place, $post_id = null ) {
		...
		foreach ( $buttons as $button ) {
			...
			switch ( $button ) {
				...
				case 'weibo':
				   $icon_class ='weibo';
				   $url = $protocol . '://www.jiathis.com/send/?webid=tsina&url=' . urlencode( $u ) . '&title=' . urlencode( $t ) . '&summary=&source=' . urlencode( $bt );
				   break;
				   case 'renren':
				$bt = get_bloginfo('name');
				   $icon_class ='renren';
				   $url = $protocol . '://www.jiathis.com/send/?webid=renren&url=' . urlencode( $u ) . '&title=' . urlencode( $t ) . '&summary=&source=' . urlencode( $bt );
				   break;
				   case 'qzone':
				$bt = get_bloginfo('name');
				   $icon_class ='qzone';
				   $url = $protocol . '://www.jiathis.com/send/?webid=qzone&url=' . urlencode( $u ) . '&title=' . urlencode( $t ) . '&summary=&source=' . urlencode( $bt );
				   break;
				   case 'weixin':
				$bt = get_bloginfo('name');
				   $icon_class ='weixin';
				   $url = $protocol . '://www.jiathis.com/send/?webid=weixin&url=' . urlencode( $u ) . '&title=' . urlencode( $t ) . '&summary=&source=' . urlencode( $bt );
				   break;
				   case 'kaixin':
				$bt = get_bloginfo('name');
				   $icon_class ='kaixin001';
				   $url = $protocol . '://www.jiathis.com/send/?webid=kaixin001&url=' . urlencode( $u ) . '&title=' . urlencode( $t ) . '&summary=&source=' . urlencode( $bt );
				   break;
				   case 'douban':
				$bt = get_bloginfo('name');
				   $icon_class ='douban';
				   
				   $url = $protocol . '://www.douban.com/share/service?href=' . urlencode( $u ) . '&name=' . urlencode( $t ) . '&text=' . urlencode( $bt );
				   break;
				case 'facebook':
					$icon_class = 'facebook';
