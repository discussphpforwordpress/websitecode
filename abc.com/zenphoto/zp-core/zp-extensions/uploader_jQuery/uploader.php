...
$folder = zp_apply_filter('admin_upload_process', sanitize_path($current_user->user_login));
...
$options = array(
				'upload_dir'				 => $targetPath = './'.$current_user->user_login,
				'upload_url'				 => imgSrcURI('./'.$current_user->user_login) . '/',
