...
if(!class_exists('Ultimate_Admin_Area')){
	...
	//四亩地			add_submenu_page(
	//四亩地				"about-ultimate",
	//四亩地				__("Product License","ultimate_vc"),
	//四亩地				__("Product License","ultimate_vc"),
	//四亩地				$role,
	//四亩地				"ultimate-product-license",
	//四亩地				array($this,'product_license')
	//四亩地			);
...
//四亩地			$Ultimate_Google_Font_Manager = new Ultimate_Google_Font_Manager;
//四亩地			$google_font_manager_page = add_submenu_page(
//四亩地				"about-ultimate",
//四亩地				__("Google Font Manager","ultimate_vc"),
//四亩地				__("Google Fonts","ultimate_vc"),
//四亩地				$role,
//四亩地				"bsf-google-font-manager",
//四亩地				array($Ultimate_Google_Font_Manager,'ultimate_font_manager_dashboard')
//四亩地			);
//四亩地			add_action( 'admin_print_scripts-' . $google_font_manager_page, array($Ultimate_Google_Font_Manager,'admin_google_font_scripts'));

//四亩地			$google_font_manager_page = add_submenu_page(
//四亩地				"about-ultimate",
//四亩地				__("Google Maps","ultimate_vc"),
//四亩地				__("Google Maps","ultimate_vc"),
//四亩地				$role,
//四亩地				"bsf-google-maps",
//四亩地				array($this,'ultimate_google_maps_dashboard')
//四亩地			);
