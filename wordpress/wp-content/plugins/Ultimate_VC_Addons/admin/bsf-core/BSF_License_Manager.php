...
//四亩地			require_once BSF_UPDATER_PATH . '/BSF_Envato_Activate.php';
		}
		...
		public function license_activation_form( $args ) {
			...
			$license_form_title 	= ( isset( $args['license_form_title'] ) && ! is_null( $args['license_form_title'] ) ) ? $args['license_form_title'] : '更新与支持注册 - ';
