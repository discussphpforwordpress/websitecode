...
function get_google_fonts()
{
	...
	$gf.post(ajaxurl, data, function(response) {
		...
		{
			var ghtml = '<div class="gfont">你似乎没有任何谷歌字体。但你也可以下载它们 <a href="javascript:void(0)" id="refresh-google-fonts">点击这里.</a> <span class="spinner"></span></div>';
...
function convert_json_to_html(object)
{
	...
	$gf.each(object,function (index, gfont) {
		...
		html += '</div>';
		$gf('head').append('<link href="" type="text/css" media="all" rel="stylesheet"/>');//四亩地
	});
	return html;
}
