...
<div class="wrap about-wrap bsf-page-wrapper ultimate-smooth-scroll bend">
  <div class="wrap-container">
	...
	<!--四亩地		        <a href="<?php echo bsf_registration_page_url( $author_extend, '6892199' ); ?>" data-tab="product-license" class="nav-tab"> <?php echo __('Product License','ultimate_vc'); ?> </a>  四亩地-->
		        <?php if($author) : ?>
	...
	<div class="container ultimate-content">
        <div class="col-md-12">
		    	...
		    	<table class="form-table">
                	...
                	<th><label>步：</label></th>
		                	<td>
                        		...
                        		<span class="dashicons dashicons-editor-help bsf-has-tip" title="鼠标滚轮的滚动效果的速度." data-position="right"></span>
		                        	</div>
		                        </div>
							</td>
		                </tr>
		                <tr class="ult-smooth-options" style="<?php echo ($ultimate_smooth_scroll !== 'enable') ? 'display:none' : '' ?>">
                	<th><label>滚动速度： </label></th>
		                	<td>
		                		<div id="ult-smooth-options">
		                        	<div>
                        		...
                        		<span class="dashicons dashicons-editor-help bsf-has-tip" title="滚动效果速度." data-position="right"></span>
		                        	</div>
		                        </div>
		                	</td>
		                </tr>
			...
			<p class="submit"><input type="submit" name="submit" id="submit-settings" class="button button-primary" value="<?php echo __("保存更改","ultimate");?>"></p>
		    </div>
		</div> <!--col-md-12 -->
