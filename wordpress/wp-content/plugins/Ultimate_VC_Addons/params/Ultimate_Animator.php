...
if(!class_exists('Ultimate_Animator_Param'))
{
	class Ultimate_Animator_Param
	{
		...
		function animator_param($settings, $value){
			...
			$output .= $animators;
			$output .= '</div>';
			$output .= '<div class="anim_prev" style=" padding: 8px; width: 45%; float: left; text-align: center; margin-left: 15px;"> <span id="animate-me" style="padding: 15px; background: #1C8FCF; color: #FFF;">动画预览</span></div>';
