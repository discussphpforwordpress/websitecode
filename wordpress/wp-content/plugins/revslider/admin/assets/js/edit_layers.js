	...
	var b = a.GreenSockGlobals || a,
		...
		r = function (a, b, c, d, h) {
			...
			var j, k, n, o, q, r, s, t, u, v, w, x, y, z = e(a),
				...
				C = -1 !== A.indexOf("words"),
				D = -1 !== A.indexOf("chars"),
				E = "absolute" === b.position || !0 === b.absolute,
				F = E ? "&#173; " : " ",
				G = -999,
				H = g(a),
				I = i(a, "paddingLeft", H),
			...
			if (B || E)
				for (o = 0; Q > o; o++) t = s[o], ((k = t.parentNode === a) || E || D && !C) && (u = t.offsetTop, B && k && u !== G && "BR" !== t.nodeName && (j = [], B.push(j), G = u), E && (t._x = t.offsetLeft, t._y = u, t._w = t.offsetWidth, t._h = t.offsetHeight), B && (C !== k && D || (j.push(t), t._x -= I), k && o && (s[o - 1]._wordEnd = !0)));
			...
			a.widget("mjs.nestedSortable", a.extend({}, a.ui.sortable.prototype, {
				...
				_create: function () {
					...
					this.options.isTree && this.options.expandOnHover && (this.options.tolerance = "intersect"), a.ui.sortable.prototype._create.apply(this, arguments), this.options.isTree && a(this.items).each(function () {
						var a = this.item,
							b = a.hasClass(c.options.collapsedClass),
							d = a.hasClass(c.options.expandedClass);
				...
				_mouseDrag: function (b) {
					...
					for (this.position = this._generatePosition(b), this.positionAbs = this._convertPositionTo("absolute"), this.lastPositionAbs || (this.lastPositionAbs = this.positionAbs), this.options.scroll && (this.scrollParent[0] !== document && "HTML" !== this.scrollParent[0].tagName ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - b.pageY < t.scrollSensitivity ? (u = this.scrollParent.scrollTop() + t.scrollSpeed, this.scrollParent.scrollTop(u)) : b.pageY - this.overflowOffset.top < t.scrollSensitivity && (u = this.scrollParent.scrollTop() - t.scrollSpeed, this.scrollParent.scrollTop(u)), this.overflowOffset.left + this.scrollParent[0].offsetWidth - b.pageX < t.scrollSensitivity ? (u = this.scrollParent.scrollLeft() + t.scrollSpeed, this.scrollParent.scrollLeft(u)) : b.pageX - this.overflowOffset.left < t.scrollSensitivity && (u = this.scrollParent.scrollLeft() - t.scrollSpeed, this.scrollParent.scrollLeft(u))) : (b.pageY - v.scrollTop() < t.scrollSensitivity ? (u = v.scrollTop() - t.scrollSpeed, v.scrollTop(u)) : a(window).height() - (b.pageY - v.scrollTop()) < t.scrollSensitivity && (u = v.scrollTop() + t.scrollSpeed, v.scrollTop(u)), b.pageX - v.scrollLeft() < t.scrollSensitivity ? (u = v.scrollLeft() - t.scrollSpeed, v.scrollLeft(u)) : a(window).width() - (b.pageX - v.scrollLeft()) < t.scrollSensitivity && (u = v.scrollLeft() + t.scrollSpeed, v.scrollLeft(u))), !1 !== u && a.ui.ddmanager && !t.dropBehaviour && a.ui.ddmanager.prepareOffsets(this, b)), this.positionAbs = this._convertPositionTo("absolute"), g = this.placeholder.offset().top, this.options.axis && "y" === this.options.axis || (this.helper[0].style.left = this.position.left + "px"), this.options.axis && "x" === this.options.axis || (this.helper[0].style.top = this.position.top + "px"), this.hovering = this.hovering ? this.hovering : null, this.mouseentered = !!this.mouseentered && this.mouseentered, function () {
						...
						}.call(this), i = this._getLevel(this.placeholder), j = this._getChildLevels(this.helper), m = document.createElement(t.listType), c = this.items.length - 1; c >= 0; c--)
						if (d = this.items[c], e = d.item[0], (f = this._intersectsWithPointer(d)) && d.instance === this.currentContainer) {
							if (-1 !== e.className.indexOf(t.disabledClass))
								if (2 === f) {
					...
					if (function () {
						...
						for (;
							"li" !== p[0].nodeName.toLowerCase() || -1 !== p[0].className.indexOf(t.disabledClass) || p[0] === this.currentItem[0] || p[0] === this.helper[0];) {
					...
					if (function () {
						...
						for (;
							"li" !== q[0].nodeName.toLowerCase() || -1 !== q[0].className.indexOf(t.disabledClass) || q[0] === this.currentItem[0] || q[0] === this.helper[0];) {
							if (!q[0].nextSibling) {
								q = null;
								break
							}
				...
				_intersectsWithSides: function (a) {
					var c = this.options.isTree ? .8 : .5,
						d = b(this.positionAbs.top + this.offset.click.top, a.top + a.height * c, a.height),
						e = b(this.positionAbs.top + this.offset.click.top, a.top - a.height * c, a.height),
						f = b(this.positionAbs.left + this.offset.click.left, a.left + a.width / 2, a.width),
				...
				serialize: function (b) {
					var c = a.extend({}, this.options, b),
						d = this._getItemsAsjQuery(c && c.connected),
						e = [];
					return a(d).each(function () {
						var b = (a(c.item || this).attr(c.attribute || "id") || "").match(c.expression || /(.+)[-=_](.+)/),
							d = (a(c.item || this).parent(c.listType).parent(c.items).attr(c.attribute || "id") || "").match(c.expression || /(.+)[-=_](.+)/);
				...
				toHierarchy: function (b) {
					function c(b) {
						var e, f = (a(b).attr(d.attribute || "id") || "").match(d.expression || /(.+)[-=_](.+)/),
							g = a(b).data();
						return g.nestedSortableItem && delete g.nestedSortableItem, f ? (e = {
							id: f[2]
						}, e = a.extend({}, e, g), a(b).children(d.listType).children(d.items).length > 0 && (e.children = [], a(b).children(d.listType).children(d.items).each(function () {
							var a = c(this);
							e.children.push(a)
						})), e) : void 0
					}
					var d = a.extend({}, this.options, b),
						e = [];
				...
				_clearEmpty: function (b) {
					...
					var d = this.options,
						e = a(b).children(d.listType),
						f = e.has("li").length,
						g = d.doNotClear || f || d.protectRoot && a(b)[0] === this.element[0];
					d.isTree && c(b, d.branchClass, d.leafClass, g), g || (e.parent().removeClass(d.expandedClass), e.remove())
				},
				_getLevel: function (a) {
					var b, c = 1;
					if (this.options.listType)
						for (b = a.closest(this.options.listType); b && b.length > 0 && !b.is(".ui-sortable");) c++, b = b.parent().closest(this.options.listType);
					return c
				},
				...
				_isAllowed: function (a, b, c) {
					var d = this.options,
						e = this.placeholder.closest(".ui-sortable").nestedSortable("option", "maxLevels"),
						f = this.currentItem.parent().parent();
			...
			switch (a) {
				...
				case "delete":
					for (var h = g.length, i = 0; i < h; i++)
						for (var j in g[i]) j === b && g.splice(i, 1);
					f = !0
			}
			f && UniteAdminRev.ajaxRequest("save_color_preset", {
...
var timeline_timer = "",
	...
	UniteLayersRev = new function () {
			...
			return c = void 0 === c ? "" : c, jQuery.each(a, function (a, e) {
				...
				if ("references" !== a)
					if (e instanceof Object) {
						...
						var f = c;
						if (c = void 0 == c || 0 == c.length ? a : c + "." + a, void 0 !== b && e !== b[a] && parseInt(e, 0) != parseInt(b[a], 0) && void 0 != e && void 0 != b[a] && "renderedData" != a)
							if (t.arrLayersChanges.undo && 0 == t.arrLayersChanges.undo.length || t.arrLayersChanges.undo[t.arrLayersChanges.undo.length - 1].chain != c) {
		...
		t.core = 5, t.sub = 3, t.subsub = 0, t.newlayercoord = {
			...
			for (var a in sgfamilies)
				for (var b in initArrFontTypes)
					if (void 0 !== initArrFontTypes[b] && void 0 !== initArrFontTypes[b].label && void 0 !== sgfamilies[a] && initArrFontTypes[b].label.replace(/\ /g, "+") == sgfamilies[a].replace(/\ /g, "+")) {
			...
			if (-1 !== jQuery.inArray(b, transSettings))
				if (d) "object" != typeof a[b] && (a[b] = {}), void 0 == f || 0 == f ? a[b][layout] = c : (a[b].desktop = c, a[b].notebook = c, a[b].tablet = c, a[b].mobile = c);
				else if (void 0 !== e && null !== e)
				for (var g in e) void 0 !== a[b] && void 0 !== a[b][e[g]] ? a[b][e[g]] = c : (void 0 === a[b] && (a[b] = {}), a[b][e[g]] = c);
			else void 0 !== a[b] && void 0 !== a[b][layout] ? a[b][layout] = c : (void 0 === a[b] && (a[b] = {}), a[b][layout] = c);
			else a[b] = c;
			return a
			...
			var a = jQuery("#hor-css-linear .helplines-offsetcontainer"),
				b = jQuery("#ver-css-linear .helplines-offsetcontainer"),
				c = jQuery("#rs-grid-sizes option:selected").val(),
				d = jQuery("#rs-grid-snapto option:selected").val(),
				e = jQuery("#divLayers");
			if ("custom" != c) {
				e.css({
					position: "relative"
				}), e.find("#helpergrid").remove(), e.append('<div id="helpergrid" style="position:absolute;top:0px;left:0px;position:absolute;z-index:0;width:100%;height:100%"></div>');
				...
				a.find(".helplines").draggable({
					...
					axis: "x"
				}), b.find(".helplines").draggable({
					handle: ".helpline-drag",
					axis: "y"
				})
			}
			for (var i in t.arrLayers) {
				t.getHtmlLayerFromSerial(i).draggable({
					drag: t.onLayerDrag,
					snap: d,
					snapMode: "outer"
				})
			...
			u.timeLineTableDimensionUpdate(), u.updateAllLayerTimeline(), disableFormFields(), initMainEvents(), initButtons(), initHtmlFields(), initAlignTable(), initLoopFunctions(), scaleAndResetLayerInit(), positionChanged_Core(), initBackgroundFunctions(), jQuery("#tp-thelistofclasses ul, #tp-thelistoffonts ul").bind("scroll", function () {
				var a = jQuery(this),
					b = a.scrollTop(),
					c = a.data("olds"),
					f = (a.parent().height(), void 0 == c || c < b ? "up" : "down");
				a.find(".ui-autocomplete-category").each(function (a) {
					var c = jQuery(this),
						d = c.next().position().top,
						e = 0 == a ? 0 : 15;
				...
				if (jQuery(".demo_layer").addClass("invisible_demolayer"), a.addClass("trans_bg"), a.css("background-image", "none"), a.css("background-color", "transparent"), a.css("background-position", "top center"), a.css("background-size", "cover"), a.css("background-repeat", "no-repeat"), jQuery(".tp-bgimg").css({
					...
					if (jQuery(".demo_layer_" + b).show(), jQuery(".demo_layer_" + b).removeClass("invisible_demolayer"), void 0 !== initDemoSettings[b]) {
						var c = "percentage" == initDemoSettings[b].bg_fit ? initDemoSettings[b].bg_fit_x + "% " + initDemoSettings[b].bg_fit_y + "% " : initDemoSettings[b].bg_fit,
							d = "percentage" == initDemoSettings[b].bg_position ? initDemoSettings[b].bg_position_x + "% " + initDemoSettings[b].bg_position_y + "% " : initDemoSettings[b].bg_position;
			...
			var getGridDimension = function () {
				var a = jQuery("#divLayers"),
					b = a.offset(),
					c = jQuery("#divLayers-wrapper").offset();
				return {
					top: b.top - c.top,
					left: b.left - c.left,
			...
			jQuery("body").on("dblclick", ".layer_selected", edit_content_current_layer), setTimeout(function () {
				...
				jQuery(":focus").blur();
				var a = jQuery(this),
					b = a.closest(".layer-toolbar-li").data("serial");
				...
				var a = jQuery(this),
					b = a.find("input").is(":focus");
				b || jQuery(":focus").blur();
				var c = jQuery(this),
					d = c.closest(".layer-toolbar-li").data("serial");
				...
				var a = "layer_animation" == jQuery(this).attr("id") ? "in" : "out",
					b = jQuery(this).val(),
					c = !1;
				for (var d in initLayerAnims)
					if ("custom" + a + "-" + initLayerAnims[d].id == b) {
						switch (a) {
							case "in":
				...
				if (0 == c)
					for (var d in initLayerAnimsDefault)
						if (d == b) {
							switch (a) {
								case "in":
						...
						"out" == a && "auto" == b && jQuery("#masking-start")[0].checked && 1 == jQuery("#masking-start")[0].checked && (jQuery("#masking-end").attr("checked", !0), RevSliderSettings.onoffStatus(jQuery("#masking-end")), jQuery(".mask-end-settings").show()), t.checkAvailableAnimationFields(), t.updateLayerFromFields()
				...
				var a = jQuery(this).hasClass("save-current-animin") ? "start" : "end",
					b = "start" == a ? jQuery('select[name="layer_animation"] option:selected').val() : jQuery('select[name="layer_endanimation"] option:selected').val();
				if ("custom" !== b)
					for (var c in initLayerAnimsDefault)
						if (c === b) return alert(rev_lang.cant_modify_default_anims), !1;
				var d = {};
				if (d.params = createNewAnimObj(a), "custom" == b) {
					...
					"start" == a && void 0 !== e["orig-anim"] && jQuery("#rs-save-under-animation").val(e["orig-anim"]), "end" == a && void 0 !== e["orig-endanim"] && jQuery("#rs-save-under-animation").val(e["orig-endanim"]), jQuery("#dialog_save_animation").dialog({
						...
						buttons: {
							Save: function () {
								var b = jQuery("#rs-save-under-animation").val(),
									c = UniteAdminRev.sanitize_input(b),
									e = !0;
								for (var f in initLayerAnimsDefault)
									if (initLayerAnimsDefault[f].handle == c) return alert(rev_lang.name_is_default_animations_cant_be_changed), !1;
								for (var f in initLayerAnims)
									if (initLayerAnims[f].handle == c) {
				...
				currentAnimationType = jQuery(this).hasClass("save-as-current-animin") ? "customin" : "customout", jQuery("#dialog_save_as_animation").dialog({
					...
					buttons: {
						Save: function () {
							var b = jQuery("#rs-save-as-animation").val(),
								c = UniteAdminRev.sanitize_input(b),
								d = !1,
								e = {};
							for (var f in initLayerAnimsDefault)
				...
				var a = jQuery(this).hasClass("rename-current-animin") ? jQuery("#layer_animation option:selected").val() : jQuery("#layer_endanimation option:selected").val(),
					b = jQuery(this).hasClass("rename-current-animin") ? jQuery("#layer_animation option:selected").text() : jQuery("#layer_endanimation option:selected").text();
				if ("custom" !== a)
					for (var c in initLayerAnimsDefault)
						if (c === a) return alert(rev_lang.cant_modify_default_anims), !1;
				...
				jQuery("#rs-rename-animation").val(b), jQuery("#dialog_rename_animation").dialog({
					...
					buttons: {
						Rename: function () {
							var a = jQuery("#rs-rename-animation").val(),
								b = UniteAdminRev.sanitize_input(a),
								c = !1,
								e = !1;
							for (var f in initLayerAnimsDefault)
								if (f == b) {
							...
							var g = "";
							for (var f in initLayerAnims)
								if (f == b && (e = !0), initLayerAnims[f].id == d) {
				...
				var a = "delete-current-animin" == jQuery(this).attr("id") ? jQuery("#layer_animation").val() : jQuery("#layer_endanimation").val(),
					b = "delete-current-animin" == jQuery(this).attr("id") ? jQuery("#layer_animation option:selected").text() : jQuery("#layer_endanimation option:selected").text();
				...
				currentAnimationType = "customin";
				var a = jQuery(this),
					b = jQuery("#extra_start_animation_settings"),
					c = jQuery("#extra_end_animation_settings");
				...
				var a = jQuery(this).hasClass("reset-current-animin") ? "start" : "end",
					b = t.getCurrentLayer();
				"start" == a && void 0 !== b["orig-anim-handle"] && jQuery('#layer_animation option[value="' + b["orig-anim-handle"] + '"]').attr("selected", !0).change(), "end" == a && void 0 !== b["orig-endanim-handle"] && jQuery('#layer_endanimation option[value="' + b["orig-endanim-handle"] + '"]').attr("selected", !0).change()
			}), jQuery("#button_edit_css, #style-morestyle, .close_extra_settings").click(function () {
				var a = jQuery("#extra_style_settings"),
					b = jQuery("#button_edit_css"),
					c = jQuery("#style-morestyle");
						...
						Rename: function () {
							...
							if ("" != a) {
								var b = jQuery("#layer_caption").val(),
									c = UniteCssEditorRev.checkIfHandleExists(a);
				...
				var a = jQuery("#layer_caption").val(),
					b = UniteCssEditorRev.checkIfHandleExists(a);
					...
					buttons: {
						OK: function () {
							...
							if (jQuery('input[name="rs-css-set-on[]"]').each(function () {
									jQuery(this)[0].checked && (b = !0, c.device.push(jQuery(this).val()))
								}), jQuery('input[name="rs-css-include[]"]').each(function () {
									jQuery(this)[0].checked && c.include.push(jQuery(this).val())
				...
				var b = a.pageX - jQuery(this).offset().left,
					c = a.pageY - jQuery(this).offset().top,
					d = jQuery("#divLayers"),
					e = parseInt(d.offset().left, 0) - parseInt(jQuery("#thelayer-editor-wrapper").offset().left, 0);
				jQuery("#verlinie").css({
					left: b + "px"
				}), jQuery("#horlinie").css({
					top: c + "px"
				}), jQuery("#verlinetext").html(Math.round(b - e)), jQuery("#horlinetext").html(Math.round(c - 40)), jQuery("#hor-css-linear .helplines-offsetcontainer").data("x", a.pageX - jQuery("#hor-css-linear .helplines-offsetcontainer").offset().left), jQuery("#hor-css-linear .helplines-offsetcontainer").data("y", c)
			}), jQuery("#hor-css-linear, #ver-css-linear, #verlinie, #horlinie").click(function () {
				var a = jQuery("#hor-css-linear .helplines-offsetcontainer"),
					b = jQuery("#ver-css-linear .helplines-offsetcontainer"),
					c = a.data("x"),
					d = a.data("y") + 10,
					e = jQuery("#thelayer-editor-wrapper").outerHeight(!0),
					f = jQuery("#thelayer-editor-wrapper").outerWidth(!0);
				jQuery("#helpergrid").remove(), jQuery("#rs-grid-sizes").val("custom"), punchgs.TweenLite.to(a, .3, {
					autoAlpha: 1
				}), punchgs.TweenLite.to(b, .3, {
					autoAlpha: 1
				}), d < 40 && c > 0 && a.append('<div class="helplines" data-left="' + c + '" data-top="' + d + '" style="position:absolute;width:1px;height:' + (e - 41) + "px;background:#4AFFFF;left:" + c + 'px;top:-15px"><i class="helpline-drag eg-icon-move"></i><i class="helpline-remove eg-icon-cancel"></i></div>'), c < 40 && d > 0 && b.append('<div class="helplines" data-left="' + c + '" data-top="' + d + '"  style="position:absolute;width:' + (f - 35) + "px;height:1px;background:#4AFFFF;top:" + d + 'px;left:-15px"><i class="helpline-drag eg-icon-move"></i><i class="helpline-remove eg-icon-cancel"></i></div>');
				try {
					a.find(".helplines").draggable("destroy")
				} catch (a) {}
				try {
				...
				var b = a.find("option:selected").text(),
					c = a.find("option:selected").val();
				"custom" !== a.find("option:selected").val() && (a.find('option[value="custom"]').attr("selected", !0).change(), "customin" == currentAnimationType ? t.updateCurrentLayer({
					animation: "custom",
					"orig-anim": b,
					"orig-anim-handle": c
				...
				var a = jQuery(this),
					c = (a.find("i"), a.closest(".layer-toolbar-li")),
					d = c.data("serial"),
					e = t.getHtmlLayerFromSerial(d);
				if (void 0 === d || "" === d) return !1;
				u.isLayerLocked(e) ? (u.unlockLayer(d), jQuery(".layer-toolbar-li").each(function () {
					var a = jQuery(this);
					if (a.data("serial") == d) {
						var b = a.find(".quick-layer-lock"),
							c = b.find("i");
			...
			"undefined" != typeof rev_sizes && void 0 !== rev_sizes && (jQuery(".row-zone-container").each(function () {
				...
				var b = jQuery(this);
				jQuery(this).hasClass("slide-transition-example") || b.css({
					height: a
				})
			...
			jQuery("#divLayers, .tp_layer_group_inner_wrapper .slide_layer_type_column, .slide_layer_type_group .tp_layer_group_inner_wrapper").droppable({
				...
				over: function (a, b) {
					...
					jQuery(".slide_layer_type_column, .slide_layer_type_row, .slide_layer_type_group").removeClass("layer_selected").removeClass("layerchild_selected"), "divLayers" !== c[0].id && (punchgs.TweenLite.set(c, {
						zIndex: 0
					}), c.addClass("layer_selected").addClass("layerchild_selected")), a.target.id, c.closest(".slide_layer_type_row, .slide_layer_type_group").addClass("layer_selected"), c.closest(".row-zone-container").addClass("layerrow_selected")
				},
				out: function (a, b) {
					var c = jQuery(a.target);
			...
			var d, b = a.references.htmlLayer,
				c = b.data("dropin");
			if ("row" === a.type || "column" === a.type || "group" === a.type);
			else if (void 0 != c && c[0].classList.contains("tp_layer_group_inner_wrapper"))
				if (c[0].contains(b[0])) d = a.p_uid;
				else {
				...
				var m = t.getVal(a, "align_hor"),
					n = t.getVal(a, "align_vert");
				if (m = "left", n = "top", a = t.setVal(a, "align_hor", m), a = t.setVal(a, "align_vert", n), "text" === a.type && (a = t.setVal(a, "max_height", "auto", !0)), "shape" === a.type) {
					var o = jQuery("#layer_cover_mode option:selected").val();
				...
				var e = b.position(),
					k = t.getLayerByUniqueId(a.p_uid),
					q = void 0 != k && void 0 != k.references && void 0 != k.references.htmlLayer ? k.references.htmlLayer.position() : {
						top: 0,
						left: 0
					},
					g = {
				...
				if (a = t.setVal(a, "align_hor", "left"), a = t.setVal(a, "align_vert", "top"), -1 != a.p_uid) {
					...
					if ("column" === i.type) {
						f = i.references.htmlLayer.position();
						var j = i.references.htmlLayer.closest(".row-zone-container"),
							s = i.references.htmlLayer.closest(".slide_layer_type_row");
			...
			var a = jQuery("#divbgholder").find(".slotholder"),
				b = jQuery("#image_url").val(),
				c = "percentage" == jQuery("#slide_bg_position").val() ? jQuery("input[name='bg_position_x']").val() + "% " + jQuery("input[name='bg_position_y']").val() + "% " : jQuery("#slide_bg_position").val(),
				d = "percentage" == jQuery("#slide_bg_fit").val() ? jQuery("input[name='bg_fit_x']").val() + "% " + jQuery("input[name='bg_fit_y']").val() + "% " : jQuery("#slide_bg_fit").val(),
				e = window.RevColor.get(jQuery("#slide_bg_color").val());
			...
			switch (f) {
				case "image":
					switch (jQuery("#button_change_image").hide(), jQuery("#button_change_image_objlib").hide(), gallery_type) {
						case "gallery":
							...
							break;
						case "posts":
							b = rs_plugin_url + "public/assets/assets/sources/post.png";
							break;
						case "woocommerce":
							b = rs_plugin_url + "public/assets/assets/sources/wc.png";
							break;
						case "facebook":
							b = rs_plugin_url + "public/assets/assets/sources/fb.png";
							break;
						case "twitter":
							b = rs_plugin_url + "public/assets/assets/sources/tw.png";
							break;
						case "instagram":
							b = rs_plugin_url + "public/assets/assets/sources/ig.png";
							break;
						case "flickr":
							b = rs_plugin_url + "public/assets/assets/sources/fr.png";
							break;
						case "youtube":
							b = rs_plugin_url + "public/assets/assets/sources/yt.png";
							break;
						case "vimeo":
							b = rs_plugin_url + "public/assets/assets/sources/vm.png"
					}
				...
				case "streamtwitterboth":
					jQuery("#streamvideo_cover").show(), jQuery("#streamvideo_cover_both").show(), b = rs_plugin_url + "public/assets/assets/sources/tw.png", a.find(".defaultimg, .slotslidebg, #ken_burn_slot_example").css({
						backgroundImage: "url(" + b + ")",
				...
				case "streamyoutubeboth":
					jQuery("#streamvideo_cover").show(), jQuery("#streamvideo_cover_both").show(), b = rs_plugin_url + "public/assets/assets/sources/yt.png";
				case "youtube":
				...
				case "streamvimeoboth":
					jQuery("#streamvideo_cover").show(), jQuery("#streamvideo_cover_both").show(), b = rs_plugin_url + "public/assets/assets/sources/vm.png";
				case "vimeo":
					a.find(".defaultimg, .slotslidebg, #ken_burn_slot_example").css({
						backgroundImage: "url(" + b + ")",
						backgroundPosition: "center center",
				...
				case "streaminstagramboth":
					jQuery("#streamvideo_cover").show(), jQuery("#streamvideo_cover_both").show(), b = rs_plugin_url + "public/assets/assets/sources/ig.png";
				case "html5":
					a.find(".defaultimg, .slotslidebg").css({
						backgroundImage: "url(" + b + ")",
						backgroundPosition: "center center",
		...
		var initDisallowCaptionsOnClick = function () {
			...
			initAlignTable = function () {
				jQuery(".rs-new-align-button").click(function () {
					...
					var b = jQuery("#layer_left_text"),
						c = jQuery("#layer_top_text"),
						d = a.data("hor"),
						e = a.data("ver");
					if (void 0 === e) {
			...
			showHideToolTip = function () {
				var a = jQuery("#layer_tooltip_event").val(),
					b = jQuery(".tooltip-parrent-part"),
					c = jQuery(".tooltip-child-part");
				switch (a) {
					case "none":
						b.hide(), c.hide();
						break;
			...
			specOrVal = function (a, b, c, d) {
				var e = parseFloat(a),
					f = void 0 === d && void 0 !== e && jQuery.isNumeric(e) && !jQuery.isNumeric(a) ? a.replace(e, "") : void 0 === d ? void 0 === c ? "" : c : d;
		...
		t.check_the_font_bold = function (a) {
			...
			for (var c in initArrFontTypes)
				if (initArrFontTypes[c].label == a) {
					void 0 !== initArrFontTypes[c].variants && (b = initArrFontTypes[c].variants);
					break
				}
			var d = jQuery('select[name="font_weight_static"]'),
				e = d.find("option:selected").val();
			d.html("");
		...
		var initHtmlFields = function () {
			jQuery("body").on("change", 'select[name="layer_action[]"], select[name="no_layer_action[]"]', function () {
				...
				var a = jQuery("#kenburn-playpause-wrapper"),
					b = jQuery("#ken_burn_example").data("kbtl");
				a.hasClass("playing") ? (a.html('<i class="eg-icon-play"></i><span>播放</span>'), a.removeClass("playing"), b.pause()) : (a.html('<i class="eg-icon-pause"></i><span>暂停</span>'), a.addClass("playing"), b.play())
			...
			jQuery("#layer_text").keyup(function () {
				...
				jQuery("#mastertimer-maxtime").css({
					left: a + "px"
				}), jQuery("#mastertimer-maxcurtime").html(u.convToTime(a)), jQuery(".slide-idle-section").css({
					left: a
				}), jQuery(".mastertimer-slide .tl-fullanim").css({
					width: a + "px"
				}), u.mainMaxTimeLeft = a, u.masterTimerPositionChange(!0), u.compareLayerEndsVSSlideEnd()
			}), jQuery(".form_layers input").on("click", function () {
				jQuery(this).select()
			}), jQuery(".form_layers input").on("change blur focus", function (a) {
				var b = jQuery(this),
					c = parseFloat(b.val()),
					d = parseFloat(b.data("min")),
					e = parseFloat(b.data("max")),
					f = b.val().slice(-1) || "",
					g = b.val().slice(-2) || "",
					h = b.data("suffix"),
					i = b.data("suffixalt");
		...
		var switchLayerBackground = function (a) {
			...
			initButtons = function () {
				...
				jQuery("#button_add_layer").click(function () {
					...
					var a = 1 == jQuery(this).data("isstatic") ? rev_lang.select_static_layer_image : rev_lang.select_layer_image,
						b = 1 == jQuery(this).data("isstatic") ? "static" : null;
					...
					var a = jQuery(this),
						b = a.closest(".list-of-layer-links"),
						c = b.find(".layer-link-type-element-cs"),
						d = t.getLayerByUniqueId(b.data("uniqueid")),
						e = {};
					...
					if (-1 === jQuery.inArray(a.data("type"), [1, 2, "1", "2", "img"])) {
						...
						var e = jQuery("#dialog_addobj").data("last_open_state"),
							f = jQuery("#obj-layer-bg-switcher").hasClass("addthisasbg");
						switch (f = ("2" === a.data("type") || 2 === a.data("type")) && f, f = "layer" !== e && f, a.data("type")) {
							...
							case 2:
								...
								var g = jQuery("#button_add_layer_image").data("isstatic"),
									i = (1 == g ? rev_lang.select_static_layer_image : rev_lang.select_layer_image, g ? "static" : null),
									j = a.data("origsrc");
								if (-1 !== j.indexOf("/"))
							...
							case "svg":
								...
								if (!0 !== jQuery("#dialog_addobj").data("changesvg")) {
									...
									serial = jQuery("#dialog_addobj").data("changesvgserial"), jQuery.get(j, function (a) {
										...
										var b = t.getLayer(serial),
											c = parseInt(t.getVal(b, "max_width"), 0);
					...
					setExampleShape(), jQuery("#dialog_addshape").dialog({
						buttons: {
							Add: function () {
								var a = {};
								a.static_styles = {}, a.deformation = {}, a["deformation-hover"] = {}, a.text = " ", a.alias = "Shape", a.type = "shape", a.style = "", a.internal_class = "tp-shape tp-shapewrapper", a.autolinebreak = !1, a.deformation["background-color"] = jQuery('input[name="adshape-color-1"]').val(), a.deformation["border-color"] = jQuery('input[name="adshape-border-color"]').val(), a.deformation["border-width"] = jQuery('input[name="adshape-border-width"]').val(), a.deformation["border-style"] = "solid", a.deformation["border-radius"] = [jQuery(".example-shape").css("borderTopLeftRadius"), jQuery(".example-shape").css("borderTopRightRadius"), jQuery(".example-shape").css("borderBottomRightRadius"), jQuery(".example-shape").css("borderBottomLeftRadius")], jQuery('input[name="shape_fullwidth"]')[0].checked ? (a.max_width = "100%", a.cover_mode = "fullwidth") : a.max_width = jQuery('input[name="shape_width"]').val(), jQuery('input[name="shape_fullheight"]')[0].checked ? (a.max_height = "100%", a.cover_mode = "fullheight") : a.max_height = jQuery('input[name="shape_height"]').val(), jQuery('input[name="shape_fullheight"]')[0].checked && jQuery('input[name="shape_fullwidth"]')[0].checked && (a.cover_mode = "cover"), a.createdOnInit = !1, addLayer(a), jQuery("#dialog_addshape").dialog("close")
							},
							Close: function () {
					...
					if (confirm(rev_lang.import_selected_layer)) {
						...
						if (null !== g && g.length > 0)
							if (g.length > 1 && confirm(rev_lang.import_all_layer_from_actions)) {
								var h = [];
					...
					if (a.is(":visible")) {
						var b = jQuery("#object_library_results"),
							c = jQuery(window).height(),
							d = jQuery("#addobj-dialog-header").height(),
							e = a.parent().find(".tp-slider-new-dialog-title").height(),
							f = c - (d + e + 100);
					...
					if ("" !== d) {
						d = d.toString().split(",");
						for (var e in d)
							if ("backgroundvideo" !== d[e] && "firstvideo" !== d[e] && -1 == jQuery.inArray(d[e], c)) {
								c.push(d[e]);
					...
					if (void 0 !== a.layer_action && void 0 !== a.layer_action.action && a.layer_action.action.length > 0)
						for (var c in a.layer_action.action) switch (a.layer_action.action[c]) {
							case "start_in":
							case "start_out":
							case "toggle_layer":
							case "start_video":
					...
					for (var d in a)
						if (a[d].unique_id == b && (c.push(jQuery.extend(!0, {}, a[d])), void 0 !== a[d].layer_action && void 0 !== a[d].layer_action.action && a[d].layer_action.action.length > 0)) {
							...
							for (var f in e.action) switch (e.action[f]) {
								...
								case "toggle_class":
									if (e.layer_target[f]) {
										var g = !0;
										for (var h in c)
											if (c[h].unique_id == e.layer_target[f]) {
												g = !1;
												break
											}
										if (g)
											for (var i in a)
												if (a[i].unique_id == e.layer_target[f]) {
					...
					for (var c in a)
						if (void 0 !== a[c].layer_action && void 0 !== a[c].layer_action.action && a[c].layer_action.action.length > 0) {
							for (var d in a[c].layer_action.layer_target)
								for (var e in b)
									if (e == a[c].layer_action.layer_target[d]) {
					...
					var a = jQuery("#rs-import-layer-slider option:selected").val();
					...
					var a = jQuery("#rs-import-layer-slider option:selected").val(),
						b = jQuery("#rs-import-layer-slide option:selected").val(),
						c = jQuery("#rs-import-layer-type option:selected").val();
					if ("-" == a) return !1;
					if (void 0 === import_slides[a]) return !1;
					for (var d in import_slides[a])
						if ("all" == b || "-" == b || b == d) {
							...
							for (var e in import_slides[a][d].layers)
								if ("all" == c || "-" == c || c == import_slides[a][d].layers[e].type) {
									var f = [];
					...
					if (void 0 !== a.layer_action && void 0 !== a.layer_action.action && a.layer_action.action.length > 0)
						for (var e in a.layer_action.action) switch (a.layer_action.action[e]) {
							case "start_in":
							case "start_out":
							case "toggle_layer":
							case "start_video":
							...
							case "toggle_class":
								if (void 0 !== a.layer_action.layer_target && void 0 !== a.layer_action.layer_target[e] && "backgroundvideo" !== a.layer_action.layer_target[e] && "firstvideo" !== a.layer_action.layer_target[e] && -1 == jQuery.inArray(a.layer_action.layer_target[e], c)) {
									...
									for (var f in d)
										if (d[f].unique_id == a.layer_action.layer_target[e]) {
			...
			createNewAnimObj = function (a) {
				var b = new Object;
				return "start" == a ? (b.movex = jQuery('input[name="layer_anim_xstart"]').val(), b.movey = jQuery('input[name="layer_anim_ystart"]').val(), b.mask = jQuery("#masking-start")[0].checked, b.use_text_c = jQuery("#use_text_color_start")[0].checked, b.use_bg_c = jQuery("#use_bg_color_start")[0].checked, b.movez = jQuery('input[name="layer_anim_zstart"]').val(), b.rotationx = jQuery('input[name="layer_anim_xrotate"]').val(), b.rotationy = jQuery('input[name="layer_anim_yrotate"]').val(), b.rotationz = jQuery('input[name="layer_anim_zrotate"]').val(), b.scalex = jQuery('input[name="layer_scale_xstart"]').val(), b.scaley = jQuery('input[name="layer_scale_ystart"]').val(), b.skewx = jQuery('input[name="layer_skew_xstart"]').val(), b.skewy = jQuery('input[name="layer_skew_ystart"]').val(), b.captionopacity = jQuery('input[name="layer_opacity_start"]').val(), b.blurfilter = jQuery('input[name="blurfilter_start"]').val(), b.grayscalefilter = jQuery('input[name="grayscalefilter_start"]').val(), b.brightnessfilter = jQuery('input[name="brightnessfilter_start"]').val(), b.mask_x = jQuery('input[name="mask_anim_xstart"]').val(), b.mask_y = jQuery('input[name="mask_anim_ystart"]').val(), b.text_c = jQuery('input[name="text_color_start"]').val(), b.bg_c = jQuery('input[name="bg_color_start"]').val(), b.mask_ease = jQuery('input[name="mask_easing"]').val(), b.mask_speed = jQuery('input[name="mask_speed"]').val(), b.easing = jQuery('select[name="layer_easing"] option:selected').val(), b.speed = jQuery('input[name="layer_speed"]').val(), b.split = jQuery('select[name="layer_split"] option:selected').val(), b.split_direction = jQuery('select[name="layer_split_direction"] option:selected').val(), b.splitdelay = jQuery('input[name="layer_splitdelay"]').val(), b.sfx_effect = jQuery("#sfx_in_effect").val(), b.movex_reverse = jQuery("#layer_anim_xstart_reverse")[0].checked, b.movey_reverse = jQuery("#layer_anim_ystart_reverse")[0].checked, b.rotationx_reverse = jQuery("#layer_anim_xrotate_reverse")[0].checked, b.rotationy_reverse = jQuery("#layer_anim_yrotate_reverse")[0].checked, b.rotationz_reverse = jQuery("#layer_anim_zrotate_reverse")[0].checked, b.scalex_reverse = jQuery("#layer_scale_xstart_reverse")[0].checked, b.scaley_reverse = jQuery("#layer_scale_ystart_reverse")[0].checked, b.skewx_reverse = jQuery("#layer_skew_xstart_reverse")[0].checked, b.skewy_reverse = jQuery("#layer_skew_ystart_reverse")[0].checked, b.mask_x_reverse = jQuery("#mask_anim_xstart_reverse")[0].checked, b.mask_y_reverse = jQuery("#mask_anim_ystart_reverse")[0].checked) : (b.use_text_c = jQuery("#use_text_color_end")[0].checked, b.use_bg_c = jQuery("#use_bg_color_end")[0].checked, b.text_c = jQuery('input[name="text_color_end"]').val(), b.bg_c = jQuery('input[name="bg_color_end"]').val(), b.movex = jQuery("#layer_anim_xend").val(), b.movey = jQuery("#layer_anim_yend").val(), b.movez = jQuery("#layer_anim_zend").val(), b.rotationx = jQuery("#layer_anim_xrotate_end").val(), b.rotationy = jQuery("#layer_anim_yrotate_end").val(), b.rotationz = jQuery("#layer_anim_zrotate_end").val(), b.scalex = jQuery("#layer_scale_xend").val(), b.scaley = jQuery("#layer_scale_yend").val(), b.skewx = jQuery("#layer_skew_xend").val(), b.skewy = jQuery("#layer_skew_yend").val(), b.captionopacity = jQuery("#layer_opacity_end").val(), b.mask = jQuery("#masking-end")[0].checked, b.mask_x = jQuery("#mask_anim_xend").val(), b.mask_y = jQuery("#mask_anim_yend").val(), b.easing = jQuery("#layer_endeasing option:selected").val(), b.speed = jQuery("#layer_endspeed").val(), b.split = jQuery("#layer_endsplit option:selected").val(), b.split_direction = jQuery("#layer_endsplit_direction option:selected").val(), b.splitdelay = jQuery("#layer_endsplitdelay").val(), b.sfx_effect = jQuery("#sfx_out_effect").val(), b.movex_reverse = jQuery("#layer_anim_xend_reverse")[0].checked, b.movey_reverse = jQuery("#layer_anim_yend_reverse")[0].checked, b.rotationx_reverse = jQuery("#layer_anim_xrotate_end_reverse")[0].checked, b.rotationy_reverse = jQuery("#layer_anim_yrotate_end_reverse")[0].checked, b.rotationz_reverse = jQuery("#layer_anim_zrotate_end_reverse")[0].checked, b.scalex_reverse = jQuery("#layer_scale_xend_reverse")[0].checked, b.scaley_reverse = jQuery("#layer_scale_yend_reverse")[0].checked, b.skewx_reverse = jQuery("#layer_skew_xend_reverse")[0].checked, b.skewy_reverse = jQuery("#layer_skew_yend_reverse")[0].checked, b.mask_x_reverse = jQuery("#mask_anim_xend_reverse")[0].checked, b.mask_y_reverse = jQuery("#mask_anim_xend_reverse")[0].checked), b
			},
			...
			checkIfAnimExists = function (a) {
				if ("object" == typeof initLayerAnims && !jQuery.isEmptyObject(initLayerAnims))
					for (var b in initLayerAnims)
						if (initLayerAnims[b].handle == a) return initLayerAnims[b].id;
				return !1
			},
			...
			deleteAnimInDb = function (a) {
				if (UniteAdminRev.setErrorMessageID("dialog_error_message"), "" != (a = jQuery.trim(a))) {
					...
					UniteAdminRev.ajaxRequest("delete_custom_anim", a, function (b) {
						jQuery("#layer_animation option:selected") != a && jQuery("#layer_animation option:selected") != a.replace("customout", "customin") || jQuery('#layer_animation option[value="tp-fade"]').attr("selected", !0), jQuery("#layer_endanimation option:selected") != a && jQuery("#layer_endanimation option:selected") != a.replace("customin", "customout") || jQuery('#layer_endanimation option[value="tp-fade"]').attr("selected", !0), t.updateInitLayerAnim(b.customfull), updateLayerAnimsInput(b.customin, "customin"), updateLayerAnimsInput(b.customout, "customout")
					})
				}
			},
			...
			updateLayerAnimsInput = function (a, b) {
				if ("customin" == b) var c = jQuery("#layer_animation"),
					d = jQuery("#layer_animation option"),
					e = jQuery("#layer_animation option:selected").val();
				else var c = jQuery("#layer_endanimation"),
					d = jQuery("#layer_endanimation option"),
					e = jQuery("#layer_endanimation option:selected").val();
				if (d.each(function () {
						jQuery(this).val().indexOf(b) > -1 && jQuery(this).remove()
					}), "object" == typeof a && !jQuery.isEmptyObject(a))
					for (key in a) c.append(new Option(a[key], key));
				c.val(e), c.change()
			},
		...
		t.clickInsideElement = function (a, b) {
			...
			for (; c = c.parentNode;)
				if (c.classList && c.classList.contains(b)) return c;
			return !1
		};
		var unselectAllFocusedGroup = function () {
			...
			refreshEvents = function (a) {
				var b = t.getHtmlLayerFromSerial(a),
					c = jQuery("#rs-grid-sizes option:selected").val(),
					d = b[0].classList.contains("slide_layer_type_row") ? "#row-zone-top, #row-zone-middle, #row-zone-bottom" : b[0].classList.contains("slide_layer_type_column") || b[0].classList.contains("slide_layer_type_group") ? "" : ".slide_layer_type_column .tp_layer_group_inner_wrapper",
					e = !!b[0].classList.contains("slide_layer_type_row") && ".row_moveme";
				b.draggable({
					handle: e,
					...
					if (c.metaKey || -1 !== navigator.platform.toUpperCase().indexOf("WIN") && c.ctrlKey) {
						var e = t.getLayer(a),
							f = jQuery("input#lots_id_" + e.unique_id);
						"checked" == f.attr("checked") ? f.prop("checked", !1) : f.attr("checked", "checked"), u.checkMultipleSelectedItems()
					} else {
						...
						if (-1 == jQuery.inArray(e.unique_id, t.selectedLayers) && u.checkMultipleSelectedItems(!0), f.attr("checked", "checked"), t.setLayerSelected(a), b.hasClass("slide_layer_type_row")) {
							...
							if (void 0 !== c.srcElement && ("eg-icon-menu" === c.srcElement.className || "row_editor" === c.srcElement.className) || void 0 != c.target && ("eg-icon-menu" === c.target.className || "row_editor" === c.target.className)) {
								var g = b.find(".row_editor"),
									h = jQuery("#rs-layout-row-composer");
								jQuery(".row_editor.open_re").removeClass("open_re"), g.addClass("open_re"), h.show(), jQuery(".rs-row-break-selector").removeClass("selected"), jQuery(".rs-row-break-selector.rs-slide-ds-" + jQuery("#column_break_at option:selected").val()).addClass("selected")
		...
		t.getSerialFromID = function (a) {
			...
			if (b || (b = !1), b) var c = jQuery("#demo_layer_" + a);
			else var c = jQuery("#slide_layer_" + a);
			...
			for (var b in t.arrLayers)
				if (t.arrLayers[b].unique_id == a) return t.getLayer(b);
			for (var b in t.arrLayersDemo)
				if (t.arrLayersDemo[b].unique_id == a) return t.getLayer(b);
			return !1
		}, t.getLayerIdByUniqueId = function (a) {
			for (var b in t.arrLayers)
				if (t.arrLayers[b].unique_id == a) return b;
			for (var b in t.arrLayersDemo)
				if (t.arrLayersDemo[b].unique_id == a) return b;
			return !1
		}, t.getUniqueIdByLayer = function (a) {
			for (var b in t.arrLayers)
				if (b == a) return t.arrLayers[b].unique_id;
			return !1
		}, t.getLayer = function (a, b) {
			if (b) var c = t.arrLayersDemo[a];
			else var c = t.arrLayers[a];
			...
			var d = "text";
			b.type && (d = b.type);
			var e = Number(b.order) + 100,
				f = "z-index:" + e + ";position:absolute;",
				g = "",
				h = "",
				i = "",
				j = "";
			...
			if (m = void 0 === m ? 0 : m, m = "ldles_" + m, "image" == d && (f += "line-height:0;"), "column" == d && (i = '<div class="slide_layer_col_sizer">', j = "</div>", h = '<div class="column_background"></div>'), c) {
				rev_adv_resp_sizes,
				void 0 != b.static_styles && (f += " font-size: " + t.getVal(b.static_styles, "font-size") + ";", f += " line-height: " + t.getVal(b.static_styles, "line-height") + ";", f += " font-weight: " + t.getVal(b.static_styles, "font-weight") + ";", f += " color: " + t.getVal(b.static_styles, "color") + ";", f += " letter-spacing: " + t.getVal(b.static_styles, "letter-spacing") + ";");
			...
			switch (d) {
				...
				case "video":
					...
					if (void 0 !== b.video_data) var q = "" != jQuery.trim(b.video_data.previewimage) ? b.video_data.previewimage : b.video_image_url;
					else var q = b.video_image_url;
					var r = b.video_type;
					switch (b.video_type) {
						case "youtube":
						case "vimeo":
			...
			if (void 0 !== a.style) {
				...
				!1 !== d && (void 0 !== d.params["font-size"] && (void 0 !== b && void 0 !== c ? -1 !== jQuery.inArray("font-size", b) && (a.static_styles = t.setVal(a.static_styles, "font-size", d.params["font-size"], !1, c), -1 !== jQuery.inArray(layout, c) && jQuery("#layer_font_size_s").val(d.params["font-size"])) : jQuery("#layer_font_size_s").val(d.params["font-size"])), void 0 !== d.params["line-height"] && (void 0 !== b && void 0 !== c ? -1 !== jQuery.inArray("line-height", b) && (a.static_styles = t.setVal(a.static_styles, "line-height", d.params["line-height"], !1, c), -1 !== jQuery.inArray(layout, c) && jQuery("#layer_line_height_s").val(d.params["line-height"])) : jQuery("#layer_line_height_s").val(d.params["line-height"])), void 0 !== d.params["letter-spacing"] && (void 0 !== b && void 0 !== c ? -1 !== jQuery.inArray("letter-spacing", b) && (a.static_styles = t.setVal(a.static_styles, "letter-spacing", d.params["letter-spacing"], !1, c), -1 !== jQuery.inArray(layout, c) && jQuery("#letter_spacing_s").val(d.params["letter-spacing"])) : jQuery("#letter_spacing_s").val(d.params["letter-spacing"])), void 0 !== d.params["font-weight"] && (void 0 !== b && void 0 !== c ? -1 !== jQuery.inArray("font-weight", b) && (a.static_styles = t.setVal(a.static_styles, "font-weight", d.params["font-weight"], !1, c), -1 !== jQuery.inArray(layout, c) && jQuery('#layer_font_weight_s option[value="' + d.params["font-weight"] + '"]').attr("selected", !0)) : jQuery('#layer_font_weight_s option[value="' + d.params["font-weight"] + '"]').attr("selected", !0)), void 0 !== d.params.color && (void 0 !== b && void 0 !== c ? (-1 !== jQuery.inArray("color", b) && (a.static_styles = t.setVal(a.static_styles, "color", d.params.color, !1, c)), -1 !== jQuery.inArray(layout, c) && (jQuery("#layer_color_s").val(d.params.color).tpColorPicker("refresh"), jQuery(".wp-color-result").each(function () {
			...
			if (!e) return !1;
			var f = !1;
			if (void 0 !== b.style && b.style !== e.style && "none" == jQuery("#dialog-change-style-from-css").css("display") && (f = !0), void 0 !== c)
				for (var g in c) delete e[c[g]];
			for (var g in b)
				if ("object" == typeof b[g])
					for (var h in b[g])
						if ("object" == typeof e[g])
							if ("object" == typeof e[g][h])
								for (var i in b[g][h]) e[g][h][i] = b[g][h][i];
							else e[g][h] = b[g][h];
			else e[g] = {}, e[g][h] = b[g][h];
			else e[g] = b[g];
			...
			a.find(".undoredostep").remove(), jQuery.each(t.arrLayersChanges.undo, function (b, c) {
				var d = '<div data-undoindex="' + b + '" class="undoredostep undostep">',
					e = t.arrLayers[c.serial].alias;
				...
				var d = '<div data-redoindex="' + b + '" class="undoredostep redostep">',
					e = void 0 === t.arrLayers[c.serial] ? c.backup[c.serial].alias : t.arrLayers[c.serial].alias;
		...
		var addLayer = function (a, b, c, d) {
			...
			var f = "video" === a.type ? initLeftVideo : initLeft,
				g = "video" === a.type ? initTopVideo : initTop;
			...
			if (void 0 == a.padding)
				if (void 0 !== a.deformation && void 0 !== a.deformation.padding) a = t.setVal(a, "padding", a.deformation.padding, !0);
				else {
					a.padding = {};
					var k = [];
		...
		var deleteCurrentLayer = function () {
			...
			duplicateCurrentLayer = function () {
				if (-1 == t.selectedLayerSerial) return !1;
				var a = t.arrLayers[t.selectedLayerSerial],
					b = jQuery.extend(!0, {}, a);
		...
		t.updateHtmlLayerCorners = function (a) {
			...
			var b = htmlLayer.outerHeight(),
				c = htmlLayer.css("backgroundColor"),
				d = UniteAdminRev.getTransparencyFromRgba(htmlLayer.css("backgroundColor"));
		...
		var getjQueryLayer = function () {
			...
			updateLayerTextField = function (a, b, c) {
				var d = getjQueryLayer(); - 1 != t.selectedLayerSerial && d.length > 0 && (d[0].getElementsByClassName("innerslide_layer")[0].innerHTML = c);
				var e = b.closest("li");
		...
		t.updateCrossIconPosition = function (a) {
			var b = jQuery(a.references.htmlLayer[0].getElementsByClassName("icon_cross")[0]),
				c = b.width(),
				d = b.height(),
				e = a.references.htmlLayer.outerWidth(),
				f = a.references.htmlLayer.outerHeight(),
				g = Math.round(c / 2),
				h = Math.round(d / 2),
				i = 0,
				j = 0;
		...
		var checkUpdateFullwidthVideo = function (a) {
			...
			updateHtmlLayersFromObject = function (a, b, c) {
				...
				if (!d) return !1;
				var e = d.references.htmlLayer,
					f = "innerslide_layer tp-caption";
		...
		t.set_cover_mode = function () {
			...
			UniteCssEditorRev.compare_to_original(), a.style = document.getElementById("layer_caption").value, a.hover = document.getElementById("hover_allow").checked, a.toggle = document.getElementById("toggle_allow").checked, a.toggle_use_hover = document.getElementById("toggle_use_hover").checked, a.toggle_inverse_content = document.getElementById("toggle_inverse_content").checked, a["visible-desktop"] = document.getElementById("visible-desktop").checked, a["visible-notebook"] = document.getElementById("visible-notebook").checked, a["visible-tablet"] = document.getElementById("visible-tablet").checked, a["visible-mobile"] = document.getElementById("visible-mobile").checked, a["show-on-hover"] = document.getElementById("layer_on_slider_hover").checked, a["lazy-load"] = jQuery("#layer-lazy-loading option:selected").val(), a["image-size"] = jQuery("#layer-image-size option:selected").val(), a["css-position"] = jQuery("#layer-css-position option:selected").val(), a.text = document.getElementById("layer_text").value, a.texttoggle = document.getElementById("layer_text_toggle").value || "", a.alias = jQuery("#layer_sort_" + t.selectedLayerSerial + ">.layer_sort_inner_wrapper .timer-layer-text").val(), jQuery("#layer_text").data("new_content") && jQuery("#layer_sort_" + t.selectedLayerSerial + ">.layer_sort_inner_wrapper .timer-layer-text").val(a.text), jQuery("#layer_quicksort_" + t.selectedLayerSerial + " .layer-title-in-list").val(a.alias), jQuery("#the_current-editing-layer-title").val(a.alias), jQuery("#layer-short-toolbar").data("serial", t.selectedLayerSerial), a = t.setVal(a, "top", Number(parseInt(document.getElementById("layer_top").value, 0))), a = t.setVal(a, "left", Number(parseInt(document.getElementById("layer_left").value, 0))), a = t.setVal(a, "whitespace", jQuery("#layer_whitespace option:selected").val()), a = t.setVal(a, "display", jQuery("#layer_display option:selected").val()), a = t.setVal(a, "max_height", document.getElementById("layer_max_height").value), a = t.setVal(a, "min_height", document.getElementById("layer_min_height").value), a = t.setVal(a, "max_width", document.getElementById("layer_max_width").value), a = t.setVal(a, "video_height", document.getElementById("layer_video_height").value), a = t.setVal(a, "video_width", document.getElementById("layer_video_width").value), a = t.setVal(a, "scaleX", document.getElementById("layer_scaleX").value), a = t.setVal(a, "scaleY", document.getElementById("layer_scaleY").value), a = t.setVal(a, "cover_mode", jQuery("#layer_cover_mode option:selected").val()), a["2d_rotation"] = parseInt(document.getElementById("layer_2d_rotation").value, 0), a["2d_origin_x"] = parseInt(document.getElementById("layer_2d_origin_x").value, 0), a["2d_origin_y"] = parseInt(document.getElementById("layer_2d_origin_y").value, 0), a.static_start = jQuery("#layer_static_start option:selected").val(), a.static_end = jQuery("#layer_static_end option:selected").val(), a.layer_bg_position = jQuery("#layer_bg_position option:selected").val(), a.layer_bg_size = jQuery("#layer_bg_size option:selected").val(), a.layer_bg_repeat = jQuery("#layer_bg_repeat option:selected").val(), a.loop_animation = jQuery("#layer_loop_animation option:selected").val(), a.loop_easing = document.getElementById("layer_loop_easing").value, a.loop_speed = document.getElementById("layer_loop_speed").value, a.loop_startdeg = parseInt(document.getElementById("layer_loop_startdeg").value, 0), a.loop_enddeg = parseInt(document.getElementById("layer_loop_enddeg").value, 0), a.loop_xorigin = parseInt(document.getElementById("layer_loop_xorigin").value, 0), a.loop_yorigin = parseInt(document.getElementById("layer_loop_yorigin").value, 0), a.loop_xstart = parseInt(document.getElementById("layer_loop_xstart").value, 0), a.loop_xend = parseInt(document.getElementById("layer_loop_xend").value, 0), a.loop_ystart = parseInt(document.getElementById("layer_loop_ystart").value, 0), a.loop_yend = parseInt(document.getElementById("layer_loop_yend").value, 0), a.loop_zoomstart = document.getElementById("layer_loop_zoomstart").value, a.loop_zoomend = document.getElementById("layer_loop_zoomend").value, a.loop_angle = document.getElementById("layer_loop_angle").value, a.loop_radius = document.getElementById("layer_loop_radius").value, a.html_tag = jQuery("#layer_html_tag option:selected").val(), a.parallax_layer_ddd_zlevel = jQuery("#parallax_layer_ddd_zlevel option:selected").val();
			var b = t.getHtmlLayerFromSerial(t.selectedLayerSerial);
			1 != document.getElementById("layer__scalex").value || 1 != document.getElementById("layer__scaley").value || 0 != parseInt(document.getElementById("layer__skewx").value, 0) || 0 != parseInt(document.getElementById("layer__skewy").value, 0) || 0 != parseInt(document.getElementById("layer__xrotate").value, 0) || 0 != parseInt(document.getElementById("layer__yrotate").value, 0) || 0 != parseInt(document.getElementById("layer_2d_rotation").value, 0) ? (jQuery(document.getElementsByClassName("mask-not-available")[0]).show(), jQuery(document.getElementsByClassName("mask-is-available")[0]).hide(), document.getElementById("masking-start").removeAttribute("checked"), document.getElementById("masking-end").removeAttribute("checked"), jQuery(document.getElementsByClassName("mask-start-settings")[0]).hide(), jQuery(document.getElementsByClassName("mask-end-settings")[0]).hide(), jQuery(".tp-showmask").removeClass("tp-showmask"), RevSliderSettings.onoffStatus(jQuery("#masking-start")), RevSliderSettings.onoffStatus(jQuery("#masking-end")), b.find(".tp-mask-wrap").css({
				overflow: "visible"
			})) : (jQuery(document.getElementsByClassName("mask-not-available")[0]).hide(), jQuery(document.getElementsByClassName("mask-is-available")[0]).show()), a.mask_start = document.getElementById("masking-start").checked, a.mask_end = document.getElementById("masking-end").checked, a.mask_x_start = document.getElementById("mask_anim_xstart").value, a.mask_y_start = document.getElementById("mask_anim_ystart").value, a.mask_x_end = document.getElementById("mask_anim_xend").value, a.mask_y_end = document.getElementById("mask_anim_yend").value, a = t.setVal(a, "align_hor", document.getElementById("layer_align_hor").value), a = t.setVal(a, "align_vert", document.getElementById("layer_align_vert").value), a.hiddenunder = document.getElementById("layer_hidden").checked, a.resizeme = document.getElementById("layer_resizeme").checked, a["resize-full"] = document.getElementById("layer_resize-full").checked, a.basealign = document.getElementById("layer_align_base").value, a.responsive_offset = document.getElementById("layer_resp_offset").checked, a.frames = {}, a.frames.frame_0 = {}, a.frames.frame_999 = {}, a.frames.frame_0.use_text_c = document.getElementById("use_text_color_start").checked, a.frames.frame_0.use_bg_c = document.getElementById("use_bg_color_start").checked, a.frames.frame_0.text_c = document.getElementById("text_color_start").value, a.frames.frame_0.bg_c = document.getElementById("bg_color_start").value, a.frames.frame_0.animation = jQuery("#layer_animation option:selected").val(), a.frames.frame_0.speed = document.getElementById("layer_speed").value, a.frames.frame_0.easing = document.getElementById("layer_easing").value, a.frames.frame_0.sfx_effect = document.getElementById("sfx_in_effect").value, a.frames.frame_0.sfxcolor = document.getElementById("sfx_color_start").value, a.frames.frame_0.split = document.getElementById("layer_split").value, a.frames.frame_0.split_direction = document.getElementById("layer_split_direction").value, a.frames.frame_0.splitdelay = document.getElementById("layer_splitdelay").value, a.frames.frame_999.split = document.getElementById("layer_endsplit").value, a.frames.frame_999.split_direction = document.getElementById("layer_endsplit_direction").value, a.frames.frame_999.splitdelay = document.getElementById("layer_endsplitdelay").value, a.frames.frame_999.animation = document.getElementById("layer_endanimation").value, a.frames.frame_999.speed = document.getElementById("layer_endspeed").value, a.frames.frame_999.sfxcolor = document.getElementById("sfx_color_end").value, a.frames.frame_999.easing = document.getElementById("layer_endeasing").value, a.frames.frame_999.sfx_effect = document.getElementById("sfx_out_effect").value, a.frames.frame_999.use_text_c = document.getElementById("use_text_color_end").checked, a.frames.frame_999.use_bg_c = document.getElementById("use_bg_color_end").checked, a.frames.frame_999.text_c = document.getElementById("text_color_end").value, a.frames.frame_999.bg_c = document.getElementById("bg_color_end").value, a.alt_option = jQuery("#layer_alt_option option:selected").val(), a.alt = document.getElementById("layer_alt").value, a = t.setVal(a, "scaleX", jQuery("#layer_scaleX").val()), a = t.setVal(a, "scaleY", jQuery("#layer_scaleY").val()), a.x_start = document.getElementById("layer_anim_xstart").value, a.y_start = document.getElementById("layer_anim_ystart").value, a.z_start = document.getElementById("layer_anim_zstart").value, a.x_end = document.getElementById("layer_anim_xend").value, a.y_end = document.getElementById("layer_anim_yend").value, a.z_end = document.getElementById("layer_anim_zend").value, a.opacity_start = document.getElementById("layer_opacity_start").value, a.opacity_end = document.getElementById("layer_opacity_end").value, a.blurfilter_start = document.getElementById("blurfilter_start").value, a.blurfilter_end = document.getElementById("blurfilter_end").value, a.grayscalefilter_start = document.getElementById("grayscalefilter_start").value, a.grayscalefilter_end = document.getElementById("grayscalefilter_end").value, a.brightnessfilter_start = document.getElementById("brightnessfilter_start").value, a.brightnessfilter_end = document.getElementById("brightnessfilter_end").value, a.x_rotate_start = document.getElementById("layer_anim_xrotate").value, a.y_rotate_start = document.getElementById("layer_anim_yrotate").value, a.z_rotate_start = document.getElementById("layer_anim_zrotate").value, a.x_rotate_end = document.getElementById("layer_anim_xrotate_end").value, a.y_rotate_end = document.getElementById("layer_anim_yrotate_end").value, a.z_rotate_end = document.getElementById("layer_anim_zrotate_end").value, a.scale_x_start = document.getElementById("layer_scale_xstart").value, a.scale_y_start = document.getElementById("layer_scale_ystart").value, a.scale_x_end = document.getElementById("layer_scale_xend").value, a.scale_y_end = document.getElementById("layer_scale_yend").value, a.skew_x_start = document.getElementById("layer_skew_xstart").value, a.skew_y_start = document.getElementById("layer_skew_ystart").value, a.skew_x_end = document.getElementById("layer_skew_xend").value, a.skew_y_end = document.getElementById("layer_skew_yend").value, a.x_start_reverse = document.getElementById("layer_anim_xstart_reverse").checked || !1, a.y_start_reverse = document.getElementById("layer_anim_ystart_reverse").checked || !1, a.x_end_reverse = document.getElementById("layer_anim_xend_reverse").checked || !1, a.y_end_reverse = document.getElementById("layer_anim_yend_reverse").checked || !1, a.x_rotate_start_reverse = document.getElementById("layer_anim_xrotate_reverse").checked || !1, a.y_rotate_start_reverse = document.getElementById("layer_anim_yrotate_reverse").checked || !1, a.z_rotate_start_reverse = document.getElementById("layer_anim_zrotate_reverse").checked || !1, a.x_rotate_end_reverse = document.getElementById("layer_anim_xrotate_end_reverse").checked || !1, a.y_rotate_end_reverse = document.getElementById("layer_anim_yrotate_end_reverse").checked || !1, a.z_rotate_end_reverse = document.getElementById("layer_anim_zrotate_end_reverse").checked || !1, a.scale_x_start_reverse = document.getElementById("layer_scale_xstart_reverse").checked || !1, a.scale_y_start_reverse = document.getElementById("layer_scale_ystart_reverse").checked || !1, a.scale_x_end_reverse = document.getElementById("layer_scale_xend_reverse").checked || !1, a.scale_y_end_reverse = document.getElementById("layer_scale_yend_reverse").checked || !1, a.skew_x_start_reverse = document.getElementById("layer_skew_xstart_reverse").checked || !1, a.skew_y_start_reverse = document.getElementById("layer_skew_ystart_reverse").checked || !1, a.skew_x_end_reverse = document.getElementById("layer_skew_xend_reverse").checked || !1, a.skew_y_end_reverse = document.getElementById("layer_skew_yend_reverse").checked || !1, a.mask_x_start_reverse = document.getElementById("mask_anim_xstart_reverse").checked || !1, a.mask_y_start_reverse = document.getElementById("mask_anim_ystart_reverse").checked || !1, a.mask_x_end_reverse = document.getElementById("mask_anim_xend_reverse").checked || !1, a.mask_y_end_reverse = document.getElementById("mask_anim_yend_reverse").checked || !1, a.autolinebreak = jQuery("#layer_auto_line_break")[0].checked, a.displaymode = jQuery("#layer_displaymode")[0].checked, a.scaleProportional = jQuery("#layer_proportional_scale")[0].checked, a.attrID = document.getElementById("layer_id").value, a.attrWrapperID = document.getElementById("layer_wrapper_id").value, a.attrClasses = document.getElementById("layer_classes").value, a.attrWrapperClasses = document.getElementById("layer_wrapper_classes").value, a.attrTitle = document.getElementById("layer_title").value, a.attrTabindex = document.getElementById("layer_tabindex").value, a.attrRel = document.getElementById("layer_rel").value, a = t.setVal(a, "scaleY", jQuery("#layer_scaleY").val()), jQuery("#clayer_start_speed").val(a.speed), jQuery("#clayer_end_speed").val(a.endspeed);
			var c = "layer_color_s" == lastchangedinput,
				d = "checked" == jQuery("#on_all_devices_color").attr("checked") || !1,
				e = "layer_font_size_s" == lastchangedinput,
				f = "checked" == jQuery("#on_all_devices_fontsize").attr("checked") || !1,
				g = "layer_font_weight_s" == lastchangedinput,
				h = "checked" == jQuery("#on_all_devices_fontweight").attr("checked") || !1,
				i = "layer_line_height_s" == lastchangedinput,
				j = "checked" == jQuery("#on_all_devices_lineheight").attr("checked") || !1,
				k = "letter_spacing_s" == lastchangedinput,
				l = "checked" == jQuery("#on_all_devices_letterspacing").attr("checked") || !1;
			void 0 == a.static_styles && (a.static_styles = {}), a.static_styles = t.setVal(a.static_styles, "font-size", jQuery("#layer_font_size_s").val(), e, null, f), a.static_styles = t.setVal(a.static_styles, "line-height", jQuery("#layer_line_height_s").val(), i, null, j), a.static_styles = t.setVal(a.static_styles, "font-weight", jQuery("#layer_font_weight_s option:selected").val(), g, null, h), a.static_styles = t.setVal(a.static_styles, "color", jQuery("#layer_color_s").val(), c, null, d), a.static_styles = t.setVal(a.static_styles, "letter-spacing", jQuery("#letter_spacing_s").val(), k, null, l), void 0 == a.deformation && (a.deformation = {}), void 0 == a.deformation["border-radius"] && (a.deformation["border-radius"] = ["0", "0", "0", "0"]), a["layer-selectable"] = jQuery("#css_layer_selectable option:selected").val(), a.deformation["font-style"] = jQuery("#css_font-style")[0].checked ? "italic" : "normal", a.deformation["font-family"] = document.getElementById("css_font-family").value;
			var m = [];
			...
			}), a = t.setVal(a, "margin", n, !0), a = t.setVal(a, "text-align", jQuery("#css_text-align option:selected").val()), a.deformation["text-decoration"] = jQuery("#css_text-decoration option:selected").val(), a.deformation.overflow = jQuery("#css_overflow option:selected").val(), a.column_break_at = jQuery("#column_break_at option:selected").val(), a.deformation["vertical-align"] = jQuery("#css_vertical-align option:selected").val(), a.deformation["text-transform"] = jQuery("#css_text-transform option:selected").val(), a.deformation["background-color"] = document.getElementById("css_background-color").value, a.deformation["border-color"] = document.getElementById("css_border-color-show").value, a.deformation["border-style"] = jQuery("#css_border-style option:selected").val(), void 0 == a.deformation["border-width"] && (a.deformation["border-width"] = new Array), jQuery('input[name="css_border-width[]"]').each(function (b) {
				a.deformation["border-width"][b] = jQuery(this).val()
			}), void 0 == a.deformation["border-radius"] && (a.deformation["border-radius"] = new Array), jQuery('input[name="css_border-radius[]"]').each(function (b) {
				a.deformation["border-radius"][b] = jQuery(this).val()
			}), a.layer_blend_mode = jQuery("#layer_blend_mode option:selected").val(), a.deformation.x = 0, a.deformation.y = 0, a.deformation.z = parseInt(document.getElementById("layer__z").value, 0), a.deformation.skewx = document.getElementById("layer__skewx").value, a.deformation.skewy = document.getElementById("layer__skewy").value, a.deformation.scalex = document.getElementById("layer__scalex").value, a.deformation.scaley = document.getElementById("layer__scaley").value, a.deformation.opacity = document.getElementById("layer__opacity").value, a.deformation.xrotate = parseInt(document.getElementById("layer__xrotate").value, 0), a.deformation.yrotate = parseInt(document.getElementById("layer__yrotate").value, 0), a["2d_rotation"] = parseInt(document.getElementById("layer_2d_rotation").value, 0), a.deformation["2d_origin_x"] = document.getElementById("layer_2d_origin_x").value, a.deformation["2d_origin_y"] = document.getElementById("layer_2d_origin_y").value, a.deformation.pers = document.getElementById("layer__pers").value, a.deformation.corner_left = jQuery("#layer_cornerleft option:selected").val(), a.deformation.corner_right = jQuery("#layer_cornerright option:selected").val(), a.deformation.parallax = jQuery("#parallax_level option:selected").val(), a.deformation.blurfilter = document.getElementById("blurfilter_idle").value, a.deformation.grayscalefilter = document.getElementById("grayscalefilter_idle").value, a.deformation.brightnessfilter = document.getElementById("brightnessfilter_idle").value, (void 0 == a["deformation-hover"] || jQuery.isEmptyObject(a["deformation-hover"])) && (a["deformation-hover"] = {}), a["deformation-hover"].color = document.getElementById("hover_layer_color_s").value, a["deformation-hover"]["text-decoration"] = jQuery("#hover_css_text-decoration option:selected").val(), a["deformation-hover"]["background-color"] = document.getElementById("hover_css_background-color").value, a["deformation-hover"].blurfilter = document.getElementById("blurfilter_hover").value, a["deformation-hover"].grayscalefilter = document.getElementById("grayscalefilter_hover").value, a["deformation-hover"].brightnessfilter = document.getElementById("brightnessfilter_hover").value, a["deformation-hover"]["border-color"] = document.getElementById("hover_css_border-color-show").value, a["deformation-hover"]["border-style"] = jQuery("#hover_css_border-style option:selected").val(), void 0 == a["deformation-hover"]["border-width"] && (a["deformation-hover"]["border-width"] = new Array), jQuery('input[name="hover_css_border-width[]"]').each(function (b) {
				a["deformation-hover"]["border-width"][b] = jQuery(this).val()
			}), void 0 == a["deformation-hover"]["border-radius"] && (a["deformation-hover"]["border-radius"] = new Array), jQuery('input[name="hover_css_border-radius[]"]').each(function (b) {
				a["deformation-hover"]["border-radius"][b] = jQuery(this).val()
			}), a["deformation-hover"].skewx = document.getElementById("hover_layer__skewx").value, a["deformation-hover"].skewy = document.getElementById("hover_layer__skewy").value, a["deformation-hover"].scalex = document.getElementById("hover_layer__scalex").value, a["deformation-hover"].scaley = document.getElementById("hover_layer__scaley").value, a["deformation-hover"].opacity = document.getElementById("hover_layer__opacity").value, a["deformation-hover"].xrotate = parseInt(document.getElementById("hover_layer__xrotate").value, 0), a["deformation-hover"].yrotate = parseInt(document.getElementById("hover_layer__yrotate").value, 0), a["deformation-hover"]["2d_rotation"] = parseInt(document.getElementById("hover_layer_2d_rotation").value, 0), a["deformation-hover"].speed = document.getElementById("hover_speed").value, a["deformation-hover"].zindex = document.getElementById("hover_zindex").value, a["deformation-hover"].easing = jQuery("#hover_easing option:selected").val(), a["deformation-hover"].css_cursor = jQuery("#css_cursor option:selected").val(), void 0 == a.svg && (a.svg = {}), a.svg["svgstroke-color"] = document.getElementById("css_svgstroke-color-show").value, a.svg["svgstroke-dasharray"] = document.getElementById("css_svgstroke-dasharray").value, a.svg["svgstroke-dashoffset"] = document.getElementById("css_svgstroke-dashoffset").value, a.svg["svgstroke-width"] = document.getElementById("css_svgstroke-width").value, a.svg["svgstroke-hover-color"] = document.getElementById("css_svgstroke-hover-color-show").value, a.svg["svgstroke-hover-dasharray"] = document.getElementById("css_svgstroke-hover-dasharray").value, a.svg["svgstroke-hover-dashoffset"] = document.getElementById("css_svgstroke-hover-dashoffset").value, a.svg["svgstroke-hover-width"] = document.getElementById("css_svgstroke-hover-width").value, (void 0 == a.layer_action || jQuery.isEmptyObject(a.layer_action)) && (a.layer_action = {}), a.layer_action.tooltip_event = [], jQuery('select[name="layer_tooltip_event[]"] option:selected').each(function () {
			...
			}), a.animation_overwrite = jQuery("#layer-animation-overwrite option:selected").val(), a.trigger_memory = jQuery("#layer-tigger-memory option:selected").val(), jQuery.each(t.addon_callbacks, function (b, c) {
				var d = c.callback,
					e = c.environment,
					f = c.function_position;
		...
		var updateHtmlSortboxFromObject = function (a) {
				...
				var b = t.getLayer(a),
					c = u.getHtmlSortItemFromSerial(a);
				if (!b || !c) return !1;
			...
			redrawLayerHtml = function (a, b) {
				void 0 == b && (b = !1);
				var c = t.getLayer(a, b),
					d = t.makeLayerHtml(a, c, b);
			...
			updateSubStyleParameters = function (a, b) {
				var c = void 0 !== b && !0 === b,
					d = UniteCssEditorRev.getStyleSettingsByHandle(a.style),
					e = d.params,
					f = UniteCssEditorRev.getStyleSettingsByHandle(a.svg),
					g = d.hover;
				void 0 == g && (g = {});
				var h = !1;
				try {
				...
				if (void 0 != a.deformation && void 0 !== e) {
					if ((nix(a.deformation["font-style"]) || c) && (a.deformation["font-style"] = nix(e["font-style"]) ? "normal" : e["font-style"]), (nix(a.deformation["font-family"]) || c) && (a.deformation["font-family"] = nix(e["font-family"]) ? "Arial" : e["font-family"]), nix(a.padding) || c)
						if (nix(e.padding))
							if (void 0 == a.padding) {
								a.padding = {};
								var i = [];
							...
							} else "object" != typeof a.padding && (a = t.setVal(a, "padding", a.padding, !0));
					else void 0 != a.padding && delete a.padding, "object" == typeof e.padding && null !== e.padding ? a.padding = e.padding : a = t.setVal(a, "padding", e.padding.split(" "), !0);
					if (nix(a.margin) || c)
						if (nix(e.margin))
							if (void 0 == a.margin) {
								a.margin = {};
					...
					else void 0 != a.margin && delete a.margin, "object" == typeof e.margin && null !== e.margin ? a.margin = e.margin : a = t.setVal(a, "margin", e.margin.split(" "), !0);
					if (nix(a["text-align"]) || c)
						if (nix(e["text-align"]))
							if (void 0 == a["text-align"]) {
								a["text-align"] = {};
								var i = [];
								jQuery('input[name="css_text-align[]"]').each(function () {
									i.push(0)
								}), a = t.setVal(a, "text-align", i, !0)
							} else "object" != typeof a["text-align"] && (a = t.setVal(a, "text-align", a["text-align"], !0));
					else void 0 != a["text-align"] && delete a["text-align"], "object" == typeof e["text-align"] && null !== e["text-align"] ? a["text-align"] = e["text-align"] : a = t.setVal(a, "text-align", e["text-align"], !0);
				...
				if (void 0 != a.svg && void 0 != f && ((nix(a.svg["svgstroke-color"]) || c) && (a.svg["svgstroke-color"] = nix(f["svgstroke-color"]) ? "transparent" : f["svgstroke-color"]), (nix(a.svg["svgstroke-dasharray"]) || c) && (a.svg["svgstroke-dasharray"] = nix(f["svgstroke-dasharray"]) ? "0" : f["svgstroke-dasharray"]), (nix(a.svg["svgstroke-dashoffset"]) || c) && (a.svg["svgstroke-dashoffset"] = nix(f["svgstroke-dashoffset"]) ? "0" : f["svgstroke-dashoffset"]), (nix(a.svg["svgstroke-width"]) || c) && (a.svg["svgstroke-width"] = nix(f["svgstroke-width"]) ? "0" : f["svgstroke-width"]), (nix(a.svg["svgstroke-hover-color"]) || c) && (a.svg["svgstroke-hover-color"] = nix(f["svgstroke-hover-color"]) ? "transparent" : f["svgstroke-hover-color"]), (nix(a.svg["svgstroke-hover-dasharray"]) || c) && (a.svg["svgstroke-hover-dasharray"] = nix(f["svgstroke-hover-dasharray"]) ? "0" : f["svgstroke-hover-dasharray"]), (nix(a.svg["svgstroke-hover-dashoffset"]) || c) && (a.svg["svgstroke-hover-dashoffset"] = nix(f["svgstroke-hover-dashoffset"]) ? "0" : f["svgstroke-hover-dashoffset"]), (nix(a.svg["svgstroke-hover-width"]) || c) && (a.svg["svgstroke-hover-width"] = nix(f["svgstroke-hover-width"]) ? "0" : f["svgstroke-hover-width"])), c && ("true" === h || !0 === h ? (jQuery("#hover_allow").attr("checked", !0), jQuery("#idle-hover-swapper").show()) : (jQuery("#hover_allow").attr("checked", !1), jQuery("#idle-hover-swapper").hide())), RevSliderSettings.onoffStatus(jQuery("#hover_allow")), RevSliderSettings.onoffStatus(jQuery("#toggle_allow")), RevSliderSettings.onoffStatus(jQuery("#toggle_use_hover")), RevSliderSettings.onoffStatus(jQuery("#toggle_inverse_content")), jQuery('#css_layer_selectable option[value="' + a["layer-selectable"] + '"]').attr("selected", !0), void 0 != a.deformation) {
					...
					if (void 0 === k && (k = a.deformation.margin), void 0 === k && (k = [0, 0, 0, 0]), jQuery('input[name="css_margin[]"]').each(function (a) {
							jQuery(this).val(k[a])
						}), "italic" == a.deformation["font-style"] ? jQuery("#css_font-style").attr("checked", !0) : jQuery("#css_font-style").attr("checked", !1), RevSliderSettings.onoffStatus(jQuery("#css_font-style")), jQuery('#css_text-align option[value="' + t.getVal(a, "text-align") + '"]').attr("selected", !0), jQuery('#css_text-decoration option[value="' + a.deformation["text-decoration"] + '"]').attr("selected", !0), jQuery('#css_overflow option[value="' + a.deformation.overflow + '"]').attr("selected", !0), jQuery('#column_break_at option[value="' + a.column_break_at + '"]').attr("selected", !0), jQuery('#css_vertical-align option[value="' + a.deformation["vertical-align"] + '"]').attr("selected", !0), jQuery('#css_text-transform option[value="' + a.deformation["text-transform"] + '"]').attr("selected", !0), jQuery("#css_background-color").val(a.deformation["background-color"]).tpColorPicker("refresh"), jQuery("#css_border-color-show").val(a.deformation["border-color"]).tpColorPicker("refresh"), jQuery('#css_border-style option[value="' + a.deformation["border-style"] + '"]').attr("selected", !0), jQuery('input[name="css_border-width[]"]').each(function (b) {
		...
		t.updateLayerFormFields = function (a) {
			...
			jQuery("#internal_classes").val(b.internal_class), jQuery(".rs-internal-class-wrapper").text(b.internal_class), jQuery("#layer_caption").val(b.style), jQuery("#layer_text").val(UniteAdminRev.stripslashes(b.text)), void 0 != b.texttoggle ? jQuery("#layer_text_toggle").val(UniteAdminRev.stripslashes(b.texttoggle)) : jQuery("#layer_text_toggle").val(""), jQuery("#layer_text").data("new_content", !1), jQuery('#layer_alt_option option[value="' + b.alt_option + '"]').attr("selected", "selected"), jQuery("#layer_alt").val(b.alt), jQuery("#layer_alias_name").val(b.alias), "true" == b.hover || 1 == b.hover ? (jQuery("#hover_allow").prop("checked", !0), jQuery("#idle-hover-swapper").show()) : (jQuery("#hover_allow").prop("checked", !1), jQuery("#idle-hover-swapper").hide()), "true" == b.toggle || 1 == b.toggle ? jQuery("#toggle_allow").prop("checked", !0) : jQuery("#toggle_allow").prop("checked", !1), "true" == b.toggle_use_hover || 1 == b.toggle_use_hover ? jQuery("#toggle_use_hover").prop("checked", !0) : jQuery("#toggle_use_hover").prop("checked", !1), "true" == b.toggle_inverse_content || 1 == b.toggle_inverse_content ? jQuery("#toggle_inverse_content").prop("checked", !0) : jQuery("#toggle_inverse_content").prop("checked", !1), "true" == b["visible-notebook"] || 1 == b["visible-notebook"] ? jQuery("#visible-notebook").prop("checked", !0) : jQuery("#visible-notebook").prop("checked", !1), "true" == b["visible-desktop"] || 1 == b["visible-desktop"] ? jQuery("#visible-desktop").prop("checked", !0) : jQuery("#visible-desktop").prop("checked", !1), "true" == b["visible-tablet"] || 1 == b["visible-tablet"] ? jQuery("#visible-tablet").prop("checked", !0) : jQuery("#visible-tablet").prop("checked", !1), "true" == b["visible-mobile"] || 1 == b["visible-mobile"] ? jQuery("#visible-mobile").prop("checked", !0) : jQuery("#visible-mobile").prop("checked", !1), "true" == b["show-on-hover"] || 1 == b["show-on-hover"] ? jQuery("#layer_on_slider_hover").prop("checked", !0) : jQuery("#layer_on_slider_hover").prop("checked", !1), jQuery('#layer-lazy-loading option[value="' + b["lazy-load"] + '"]').attr("selected", "selected"), jQuery('#layer-image-size option[value="' + b["image-size"] + '"]').attr("selected", "selected"), jQuery('#layer-css-position option[value="' + b["css-position"] + '"]').attr("selected", "selected"), RevSliderSettings.onoffStatus(jQuery("#hover_allow")), RevSliderSettings.onoffStatus(jQuery("#toggle_allow")), RevSliderSettings.onoffStatus(jQuery("#toggle_use_hover")), RevSliderSettings.onoffStatus(jQuery("#toggle_inverse_content")), RevSliderSettings.onoffStatus(jQuery("#visible-desktop")), RevSliderSettings.onoffStatus(jQuery("#visible-notebook")), RevSliderSettings.onoffStatus(jQuery("#visible-tablet")), RevSliderSettings.onoffStatus(jQuery("#visible-mobile")), RevSliderSettings.onoffStatus(jQuery("#layer_on_slider_hover")), jQuery("#layer_scaleX").val(specOrVal(t.getVal(b, "scaleX"), ["auto", "#1/1#", "#1/2#", "#1/3#", "#1/4#", "#1/5#", "#1/6#", "#2/3#", "#3/4#", "#2/5#", "#3/5#", "#4/5#", "#4/6#", "#5/6#"], "px")), jQuery("#layer_scaleY").val(specOrVal(t.getVal(b, "scaleY"), ["auto", "#1/1#", "#1/2#", "#1/3#", "#1/4#", "#1/5#", "#1/6#", "#2/3#", "#3/4#", "#2/5#", "#3/5#", "#4/5#", "#4/6#", "#5/6#"], "px")), jQuery('#layer_cover_mode option[value="' + b.cover_mode + '"]').attr("selected", "selected"), jQuery("#layer_max_height").val(specOrVal(t.getVal(b, "max_height"), ["auto", "#1/1#", "#1/2#", "#1/3#", "#1/4#", "#1/5#", "#1/6#", "#2/3#", "#3/4#", "#2/5#", "#3/5#", "#4/5#", "#4/6#", "#5/6#"], "px")), jQuery("#layer_min_height").val(specOrVal(t.getVal(b, "min_height"), ["auto", "#1/1#", "#1/2#", "#1/3#", "#1/4#", "#1/5#", "#1/6#", "#2/3#", "#3/4#", "#2/5#", "#3/5#", "#4/5#", "#4/6#", "#5/6#"], "px")), jQuery("#layer_max_width").val(specOrVal(t.getVal(b, "max_width"), ["auto", "#1/1#", "#1/2#", "#1/3#", "#1/4#", "#1/5#", "#1/6#", "#2/3#", "#3/4#", "#2/5#", "#3/5#", "#4/5#", "#4/6#", "#5/6#"], "px")), jQuery("#layer_video_height").val(specOrVal(t.getVal(b, "video_height"), ["auto", "#1/1#", "#1/2#", "#1/3#", "#1/4#", "#1/5#", "#1/6#", "#2/3#", "#3/4#", "#2/5#", "#3/5#", "#4/5#", "#4/6#", "#5/6#"], "px")), jQuery("#layer_video_width").val(specOrVal(t.getVal(b, "video_width"), ["auto", "#1/1#", "#1/2#", "#1/3#", "#1/4#", "#1/5#", "#1/6#", "#2/3#", "#3/4#", "#2/5#", "#3/5#", "#4/5#", "#4/6#", "#5/6#"], "px")), jQuery("#layer_2d_rotation").val(b["2d_rotation"]), jQuery("#layer_2d_origin_x").val(b["2d_origin_x"]), jQuery("#layer_2d_origin_y").val(b["2d_origin_y"]), jQuery("#layer_static_start option[value='" + b.static_start + "']").attr("selected", "selected"), changeEndStaticFunctions(), jQuery("#layer_static_end option[value='" + b.static_end + "']").attr("selected", "selected"), jQuery("#layer_whitespace option[value='" + t.getVal(b, "whitespace") + "']").attr("selected", "selected"), jQuery("#layer_display option[value='" + t.getVal(b, "display") + "']").attr("selected", "selected"), "true" == b.scaleProportional || 1 == b.scaleProportional ? (jQuery(".rs-proportion-check").removeClass("notselected"), jQuery("#layer_proportional_scale").prop("checked", !0)) : (jQuery("#layer_proportional_scale").prop("checked", !1), jQuery(".rs-proportion-check").addClass("notselected")), "normal" === t.getVal(b, "whitespace") ? (jQuery(".rs-linebreak-check").removeClass("notselected"), jQuery("#layer_auto_line_break").prop("checked", !0)) : (jQuery(".rs-linebreak-check").addClass("notselected"), jQuery("#layer_auto_line_break").prop("checked", !1)), "block" === t.getVal(b, "display") ? (jQuery("#layer-displaymode-wrapper").removeClass("notselected"), jQuery("#layer_displaymode").prop("checked", !0)) : (jQuery("#layer-displaymode-wrapper").addClass("notselected"), jQuery("#layer_displaymode").prop("checked", !1)), RevSliderSettings.onoffStatus(jQuery(".rs-proportion-check")), RevSliderSettings.onoffStatus(jQuery(".rs-linebreak-check")), jQuery("#layer_top").val(parseInt(t.getVal(b, "top"), 0) + "px"), jQuery("#layer_left").val(parseInt(t.getVal(b, "left"), 0) + "px"), jQuery("#layer_bg_position option[value='" + b.layer_bg_position + "']").attr("selected", "selected"), jQuery("#layer_bg_size option[value='" + b.layer_bg_size + "']").attr("selected", "selected"), jQuery("#layer_bg_repeat option[value='" + b.layer_bg_repeat + "']").attr("selected", "selected"), jQuery("#layer_loop_animation option[value='" + b.loop_animation + "']").attr("selected", "selected"), jQuery("#layer_loop_easing").val(b.loop_easing), jQuery("#layer_loop_speed").val(b.loop_speed), jQuery("#layer_loop_startdeg").val(b.loop_startdeg), jQuery("#layer_loop_enddeg").val(b.loop_enddeg), jQuery("#layer_loop_xorigin").val(b.loop_xorigin), jQuery("#layer_loop_yorigin").val(b.loop_yorigin), jQuery("#layer_loop_xstart").val(b.loop_xstart), jQuery("#layer_loop_xend").val(b.loop_xend), jQuery("#layer_loop_ystart").val(b.loop_ystart), jQuery("#layer_loop_yend").val(b.loop_yend), jQuery("#layer_loop_zoomstart").val(b.loop_zoomstart), jQuery("#layer_loop_zoomend").val(b.loop_zoomend), jQuery("#layer_loop_angle").val(b.loop_angle), jQuery("#layer_loop_radius").val(b.loop_radius), void 0 != b.svg && (jQuery("#css_svgstroke-color-show").val(b.svg["svgstroke-color"]), jQuery("#css_svgstroke-dasharray").val(b.svg["svgstroke-dasharray"]), jQuery("#css_svgstroke-dashoffset").val(b.svg["svgstroke-dashoffset"]), jQuery("#css_svgstroke-width").val(b.svg["svgstroke-width"]), jQuery("#css_svgstroke-hover-color-show").val(b.svg["svgstroke-hover-color"]), jQuery("#css_svgstroke-hover-dasharray").val(b.svg["svgstroke-hover-dasharray"]), jQuery("#css_svgstroke-hover-dashoffset").val(b.svg["svgstroke-hover-dashoffset"]), jQuery("#css_svgstroke-hover-width").val(b.svg["svgstroke-hover-width"])), jQuery("#layer_html_tag option[value='" + b.html_tag + "']").attr("selected", "selected"), jQuery("#parallax_layer_ddd_zlevel option[value='" + b.parallax_layer_ddd_zlevel + "']").attr("selected", "selected"), "true" == b.mask_start || 1 == b.mask_start ? (jQuery("#masking-start").attr("checked", !0), jQuery(".mask-start-settings").show()) : (jQuery("#masking-start").prop("checked", !1), jQuery(".mask-start-settings").hide()), "true" == b.mask_end || 1 == b.mask_end ? (jQuery("#masking-end").attr("checked", !0), jQuery(".mask-end-settings").show()) : (jQuery("#masking-end").prop("checked", !1), jQuery(".mask-end-settings").hide()), "true" == b.frames.frame_0.use_text_c || 1 == b.frames.frame_0.use_text_c ? (jQuery("#use_text_color_start").attr("checked", !0), jQuery(".use_text_color_wrap_start").show()) : (jQuery("#use_text_color_start").attr("checked", !1), jQuery(".use_text_color_wrap_start").hide()), "true" == b.frames.frame_0.use_bg_c || 1 == b.frames.frame_0.use_bg_c ? (jQuery("#use_bg_color_start").attr("checked", !0), jQuery(".use_bg_color_wrap_start").show()) : (jQuery("#use_bg_color_start").attr("checked", !1), jQuery(".use_bg_color_wrap_start").hide()), "true" == b.frames.frame_999.use_text_c || 1 == b.frames.frame_999.use_text_c ? (jQuery("#use_text_color_end").attr("checked", !0), jQuery(".use_text_color_wrap_end").show()) : (jQuery("#use_text_color_end").attr("checked", !1), jQuery(".use_text_color_wrap_end").hide()), "true" == b.frames.frame_999.use_bg_c || 1 == b.frames.frame_999.use_bg_c ? (jQuery("#use_bg_color_end").attr("checked", !0), jQuery(".use_bg_color_wrap_end").show()) : (jQuery("#use_bg_color_end").attr("checked", !1), jQuery(".use_bg_color_wrap_end").hide()), RevSliderSettings.onoffStatus(jQuery("#masking-start")), RevSliderSettings.onoffStatus(jQuery("#masking-end")), RevSliderSettings.onoffStatus(jQuery("#use_text_color_start")), RevSliderSettings.onoffStatus(jQuery("#use_bg_color_start")), RevSliderSettings.onoffStatus(jQuery("#use_text_color_end")), RevSliderSettings.onoffStatus(jQuery("#use_bg_color_end")), jQuery("#text_color_start").val(b.frames.frame_0.text_c).tpColorPicker("refresh"), jQuery("#bg_color_start").val(b.frames.frame_0.bg_c).tpColorPicker("refresh"), jQuery("#text_color_end").val(b.frames.frame_999.text_c).tpColorPicker("refresh"), jQuery("#bg_color_end").val(b.frames.frame_999.bg_c).tpColorPicker("refresh"), jQuery("#mask_anim_xstart").val(b.mask_x_start), jQuery("#mask_anim_ystart").val(b.mask_y_start), jQuery("#mask_speed").val(b.mask_speed_start), jQuery("#mask_easing").val(b.mask_ease_start), jQuery("#mask_anim_xend").val(b.mask_x_end), jQuery("#mask_anim_yend").val(b.mask_y_end), jQuery("#layer_animation option[value='" + b.frames.frame_0.animation + "']").attr("selected", "selected"), jQuery("#layer_easing").val(b.frames.frame_0.easing), jQuery("#sfx_in_effect").val(b.frames.frame_0.sfx_effect), jQuery("#sfx_out_effect").val(b.frames.frame_999.sfx_effect), jQuery("#layer_split").val(b.frames.frame_0.split), jQuery("#layer_split_direction").val(b.frames.frame_0.split_direction), jQuery("#layer_endsplit").val(b.frames.frame_999.split), jQuery("#layer_endsplit_direction").val(b.frames.frame_999.split_direction), jQuery("#layer_splitdelay").val(b.frames.frame_0.splitdelay), jQuery("#layer_endsplitdelay").val(b.frames.frame_999.splitdelay), jQuery("#layer_speed").val(b.frames.frame_0.speed), jQuery("#sfx_color_start").val(b.frames.frame_0.sfxcolor).tpColorPicker("refresh"), jQuery("#layer_align_hor").val(t.getVal(b, "align_hor")), jQuery("#layer_align_vert").val(t.getVal(b, "align_vert")), "true" == b.hiddenunder || 1 == b.hiddenunder ? jQuery("#layer_hidden").prop("checked", !0) : jQuery("#layer_hidden").prop("checked", !1), "true" == b.resizeme || 1 == b.resizeme ? jQuery("#layer_resizeme").prop("checked", !0) : jQuery("#layer_resizeme").prop("checked", !1), "true" == b["seo-optimized"] || 1 == b["seo-optimized"] ? jQuery("#layer-seo-optimized").prop("checked", !0) : jQuery("#layer-seo-optimized").prop("checked", !1), "true" != b["resize-full"] && 1 != b["resize-full"] || "row" === b.type || "column" === b.type ? (jQuery("#layer_resize-full").prop("checked", !1), jQuery("#layer_resizeme").prop("checked", !1), b.resizeme = !1) : (jQuery("#layer_resize-full").prop("checked", !0), "group" === b.type && (jQuery("#layer_resizeme").prop("checked", !1), b.resizeme = !1)), jQuery("#layer_align_base").val(b.basealign), "true" == b.responsive_offset || 1 == b.responsive_offset ? jQuery("#layer_resp_offset").prop("checked", !0) : jQuery("#layer_resp_offset").prop("checked", !1), RevSliderSettings.onoffStatus(jQuery("#layer_hidden")), RevSliderSettings.onoffStatus(jQuery("#layer_resizeme")), RevSliderSettings.onoffStatus(jQuery("#layer_resize-full")), RevSliderSettings.onoffStatus(jQuery("#layer_resp_offset")), RevSliderSettings.onoffStatus(jQuery("#layer-seo-optimized")), jQuery("#layer_image_link").val(b.link), jQuery("#layer_link_follow").val(b.link_follow), jQuery("#layer_link_open_in").val(b.link_open_in), jQuery("#layer_link_id").val(b.link_id), jQuery("#layer_link_class").val(b.link_class), jQuery("#layer_link_title").val(b.link_title), jQuery("#layer_link_rel").val(b.link_rel), jQuery("#layer_auto_line_break").val(b.autolinebreak), jQuery("#layer_displaymode").val(b.displaymode), jQuery("#layer_endanimation").val(b.frames.frame_999.animation), jQuery("#layer_endeasing").val(b.frames.frame_999.easing), jQuery("#layer_endspeed").val(b.frames.frame_999.speed), jQuery("#sfx_color_end").val(b.frames.frame_999.sfxcolor).tpColorPicker("refresh"), jQuery("#layer_anim_xstart").val(b.x_start), jQuery("#layer_anim_ystart").val(b.y_start), jQuery("#layer_anim_zstart").val(b.z_start), jQuery("#layer_anim_xend").val(b.x_end), jQuery("#layer_anim_yend").val(b.y_end), jQuery("#layer_anim_zend").val(b.z_end), jQuery("#layer_opacity_start").val(b.opacity_start), jQuery("#layer_opacity_end").val(b.opacity_end), jQuery("#layer_anim_xrotate").val(b.x_rotate_start), jQuery("#layer_anim_yrotate").val(b.y_rotate_start), jQuery("#layer_anim_zrotate").val(b.z_rotate_start), jQuery("#layer_anim_xrotate_end").val(b.x_rotate_end), jQuery("#layer_anim_yrotate_end").val(b.y_rotate_end), jQuery("#layer_anim_zrotate_end").val(b.z_rotate_end), jQuery("#layer_scale_xstart").val(b.scale_x_start), jQuery("#layer_scale_ystart").val(b.scale_y_start), jQuery("#layer_scale_xend").val(b.scale_x_end), jQuery("#layer_scale_yend").val(b.scale_y_end), jQuery("#layer_skew_xstart").val(b.skew_x_start), jQuery("#layer_skew_ystart").val(b.skew_y_start), jQuery("#layer_skew_xend").val(b.skew_x_end), jQuery("#layer_skew_yend").val(b.skew_y_end), jQuery("#layer_pers_start").val(b.pers_start), jQuery("#layer_pers_end").val(b.pers_end), jQuery("#blurfilter_start").val(b.blurfilter_start), jQuery("#blurfilter_end").val(b.blurfilter_end), jQuery("#grayscalefilter_start").val(b.grayscalefilter_start), jQuery("#grayscalefilter_end").val(b.grayscalefilter_end), jQuery("#brightnessfilter_start").val(b.brightnessfilter_start), jQuery("#brightnessfilter_end").val(b.brightnessfilter_end), void 0 !== b["layer-selectable"] ? jQuery('#css_layer_selectable option[value="' + b["layer-selectable"] + '"]').attr("selected", !0) : jQuery('#css_layer_selectable option[value="default"]').attr("selected", !0), void 0 === b.x_start_reverse || "true" != b.x_start_reverse && 1 != b.x_start_reverse ? jQuery("#layer_anim_xstart_reverse").prop("checked", !1) : jQuery("#layer_anim_xstart_reverse").attr("checked", !0), void 0 === b.y_start_reverse || "true" != b.y_start_reverse && 1 != b.y_start_reverse ? jQuery("#layer_anim_ystart_reverse").prop("checked", !1) : jQuery("#layer_anim_ystart_reverse").attr("checked", !0), void 0 === b.x_end_reverse || "true" != b.x_end_reverse && 1 != b.x_end_reverse ? jQuery("#layer_anim_xend_reverse").prop("checked", !1) : jQuery("#layer_anim_xend_reverse").attr("checked", !0), void 0 === b.y_end_reverse || "true" != b.y_end_reverse && 1 != b.y_end_reverse ? jQuery("#layer_anim_yend_reverse").prop("checked", !1) : jQuery("#layer_anim_yend_reverse").attr("checked", !0), void 0 === b.x_rotate_start_reverse || "true" != b.x_rotate_start_reverse && 1 != b.x_rotate_start_reverse ? jQuery("#layer_anim_xrotate_reverse").prop("checked", !1) : jQuery("#layer_anim_xrotate_reverse").attr("checked", !0), void 0 === b.y_rotate_start_reverse || "true" != b.y_rotate_start_reverse && 1 != b.y_rotate_start_reverse ? jQuery("#layer_anim_yrotate_reverse").prop("checked", !1) : jQuery("#layer_anim_yrotate_reverse").attr("checked", !0), void 0 === b.z_rotate_start_reverse || "true" != b.z_rotate_start_reverse && 1 != b.z_rotate_start_reverse ? jQuery("#layer_anim_zrotate_reverse").prop("checked", !1) : jQuery("#layer_anim_zrotate_reverse").attr("checked", !0), void 0 === b.x_rotate_end_reverse || "true" != b.x_rotate_end_reverse && 1 != b.x_rotate_end_reverse ? jQuery("#layer_anim_xrotate_end_reverse").prop("checked", !1) : jQuery("#layer_anim_xrotate_end_reverse").attr("checked", !0), void 0 === b.y_rotate_end_reverse || "true" != b.y_rotate_end_reverse && 1 != b.y_rotate_end_reverse ? jQuery("#layer_anim_yrotate_end_reverse").prop("checked", !1) : jQuery("#layer_anim_yrotate_end_reverse").attr("checked", !0), void 0 === b.z_rotate_end_reverse || "true" != b.z_rotate_end_reverse && 1 != b.z_rotate_end_reverse ? jQuery("#layer_anim_zrotate_end_reverse").prop("checked", !1) : jQuery("#layer_anim_zrotate_end_reverse").attr("checked", !0), void 0 === b.scale_x_start_reverse || "true" != b.scale_x_start_reverse && 1 != b.scale_x_start_reverse ? jQuery("#layer_scale_xstart_reverse").prop("checked", !1) : jQuery("#layer_scale_xstart_reverse").attr("checked", !0), void 0 === b.scale_y_start_reverse || "true" != b.scale_y_start_reverse && 1 != b.scale_y_start_reverse ? jQuery("#layer_scale_ystart_reverse").prop("checked", !1) : jQuery("#layer_scale_ystart_reverse").attr("checked", !0), void 0 === b.scale_x_end_reverse || "true" != b.scale_x_end_reverse && 1 != b.scale_x_end_reverse ? jQuery("#layer_scale_xend_reverse").prop("checked", !1) : jQuery("#layer_scale_xend_reverse").attr("checked", !0), void 0 === b.scale_y_end_reverse || "true" != b.scale_y_end_reverse && 1 != b.scale_y_end_reverse ? jQuery("#layer_scale_yend_reverse").prop("checked", !1) : jQuery("#layer_scale_yend_reverse").attr("checked", !0), void 0 === b.skew_x_start_reverse || "true" != b.skew_x_start_reverse && 1 != b.skew_x_start_reverse ? jQuery("#layer_skew_xstart_reverse").prop("checked", !1) : jQuery("#layer_skew_xstart_reverse").attr("checked", !0), void 0 === b.skew_y_start_reverse || "true" != b.skew_y_start_reverse && 1 != b.skew_y_start_reverse ? jQuery("#layer_skew_ystart_reverse").prop("checked", !1) : jQuery("#layer_skew_ystart_reverse").attr("checked", !0), void 0 === b.skew_x_end_reverse || "true" != b.skew_x_end_reverse && 1 != b.skew_x_end_reverse ? jQuery("#layer_skew_xend_reverse").prop("checked", !1) : jQuery("#layer_skew_xend_reverse").attr("checked", !0), void 0 === b.skew_y_end_reverse || "true" != b.skew_y_end_reverse && 1 != b.skew_y_end_reverse ? jQuery("#layer_skew_yend_reverse").prop("checked", !1) : jQuery("#layer_skew_yend_reverse").attr("checked", !0), void 0 === b.mask_x_start_reverse || "true" != b.mask_x_start_reverse && 1 != b.mask_x_start_reverse ? jQuery("#mask_anim_xstart_reverse").prop("checked", !1) : jQuery("#mask_anim_xstart_reverse").attr("checked", !0), void 0 === b.mask_y_start_reverse || "true" != b.mask_y_start_reverse && 1 != b.mask_y_start_reverse ? jQuery("#mask_anim_ystart_reverse").prop("checked", !1) : jQuery("#mask_anim_ystart_reverse").attr("checked", !0), void 0 === b.mask_x_end_reverse || "true" != b.mask_x_end_reverse && 1 != b.mask_x_end_reverse ? jQuery("#mask_anim_xend_reverse").prop("checked", !1) : jQuery("#mask_anim_xend_reverse").attr("checked", !0), void 0 === b.mask_y_end_reverse || "true" != b.mask_y_end_reverse && 1 != b.mask_y_end_reverse ? jQuery("#mask_anim_yend_reverse").prop("checked", !1) : jQuery("#mask_anim_yend_reverse").attr("checked", !0), t.updateReverseList(), void 0 != b.static_styles && (jQuery("#layer_font_size_s").val(t.getVal(b.static_styles, "font-size")), jQuery("#layer_line_height_s").val(t.getVal(b.static_styles, "line-height")), jQuery("#layer_font_weight_s option[value='" + t.getVal(b.static_styles, "font-weight") + "']").attr("selected", !0), jQuery("#layer_color_s").val(t.getVal(b.static_styles, "color")).tpColorPicker("refresh"), jQuery("#letter_spacing_s").val(t.getVal(b.static_styles, "letter-spacing"))), void 0 != b.animation_overwrite ? jQuery('#layer-animation-overwrite option[value="' + b.animation_overwrite + '"]').attr("selected", !0) : jQuery('#layer-animation-overwrite option[value="wait"]').attr("selected", !0), void 0 != b.trigger_memory ? jQuery('#layer-tigger-memory option[value="' + b.trigger_memory + '"]').attr("selected", !0) : jQuery('#layer-tigger-memory option[value="keep"]').attr("selected", !0), t.remove_layer_actions(), t.add_layer_actions(b), b = updateSubStyleParameters(b);
			var c = t.getVal(b, "align_hor"),
				d = t.getVal(b, "align_vert");
		...
		t.toolbarInPos = function (a) {
			...
			var b = t.getSimpleLayers(),
				c = t.getUniqueIdByLayer(a);
			for (var d in b)
				if (void 0 !== b[d].layer_action)
					for (var e in b[d].layer_action.action) switch (b[d].layer_action.action[e]) {
						case "start_in":
						case "start_out":
						case "start_video":
						case "stop_video":
			...
			if (void 0 !== a && void 0 !== a.layer_action && void 0 !== a.layer_action.action)
				for (var e in a.layer_action.action) {
					var j = {};
			...
			jQuery('select[name="jump_to_slide[]"], select[name="no_jump_to_slide[]"]').each(function () {
				jQuery(this).html("");
				for (var a in slideIDs)
					for (var b in slideIDs[a]) jQuery(this).append(jQuery("<option></option>").val(b).text("Slide: " + slideIDs[a][b]));
				var c = jQuery(this).data("selectoption");
				jQuery(this).find('option[value="' + c + '"]').attr("selected", !0)
				...
				jQuery(this).find('option[value="' + d + '"]').attr("selected", !0);
			...
			return {
				animation_overwrite: b.animation_overwrite,
				trigger_memory: b.trigger_memory
			}
			...
			var b = !1,
				c = a.references.htmlLayer;
			(jQuery("#layer_proportional_scale")[0].checked || "svg" === a.type) && (b = !0);
			try {
				c.resizable("destroy")
			} catch (a) {}
			c.resizable({
					...
					switch (a.type) {
						...
						default:
							if ("svg" === a) c.find(".innerslide_layer.tp-caption").first().css({
								...
								var g = c.outerWidth(),
									h = "shape" === a.type ? "none" : c.outerHeight();
								"shape" !== a.type && c.css({
									height: "auto"
								}), punchgs.TweenLite.set(e.element[0].getElementsByClassName("innerslide_layer")[0], {
									height: "auto",
									maxHeight: "none",
									minHeight: h,
									maxWidth: g
				...
				resize: function (c, d) {
					switch (a.type) {
						...
						case "image":
							...
							break;
						default:
							var f = d.element[0].getElementsByClassName("innerslide_layer")[0],
								g = jQuery(f),
								h = g.outerHeight(),
								j = (g.outerWidth(), Math.round(d.size.height) + 1),
								k = Math.round(d.size.width) + 1;
							"shape" !== a.type && "group" !== a.type ? (j = h >= j ? "auto" : j + "px", punchgs.TweenLite.set(f, {
								maxWidth: k
			...
			var c = document.getElementById("id-esw"),
				d = "column" === t.getObjLayerType(a.p_uid);
			...
			"row" !== a.type && "column" !== a.type && (t.setLayerResizable(a), t.makeCurrentLayerRotatable()), jQuery("#hover_allow")[0].checked ? jQuery("#idle-hover-swapper").show() : jQuery("#idle-hover-swapper").hide(), RevSliderSettings.onoffStatus(jQuery("#hover_allow")), RevSliderSettings.onoffStatus(jQuery("#toggle_allow")), RevSliderSettings.onoffStatus(jQuery("#toggle_use_hover")), RevSliderSettings.onoffStatus(jQuery("#toggle_inverse_content")), jQuery("#layer_caption").catcomplete("close"), jQuery(".wp-color-result").each(function () {
				jQuery(this).css("backgroundColor", jQuery(this).parent().find(".my-color-field").val())
		...
		t.updateHtmlLayerPosition = function (a, b, c, d, e, f) {
			if (void 0 !== b && !1 !== b) {
				var g = b.references.htmlLayer.outerWidth(),
					h = b.references.htmlLayer.outerHeight();
				totalWidth = container.width(), totalHeight = container.height();
				var i = totalWidth,
					j = totalHeight; - 1 !== b.p_uid && "group" === t.getObjLayerType(b.p_uid) && (i = t.getLayerByUniqueId(b.p_uid).references.htmlLayer.width(), j = t.getLayerByUniqueId(b.p_uid).references.htmlLayer.height()), 1 == a && "image" == b.type && (-1 != t.getVal(b, "width") && (g = t.getVal(b, "width")), -1 != t.getVal(b, "height") && (h = t.getVal(b, "height")));
				var k = {};
				switch (b.type) {
					case "row":
					case "column":
				...
				switch (f) {
					...
					break;
					case "middle":
							var n = (j - h) / 2;n = "row" === b.type ? 0 : Math.round(n) + c,
						k.top = l ? "auto" : n + "px",
						k.bottom = "auto";
						break;
					case "bottom":
							k.top = "auto",
						k.bottom = l ? "auto" : c + "px"
				}
		...
		var onLayerDragStart = function () {
			...
			var a = t.getSerialFromID(this.id),
				b = jQuery(this),
				c = t.getLayer(a); - 1 == jQuery.inArray(c.unique_id, t.selectedLayers) && u.checkMultipleSelectedItems(!0), b.closest(".slide_layer_type_group").addClass("dragfromgroup"), b.data("originalPosition", b.position()), b.addClass("draggable_toponall"), selectedLayerWidth = b.outerWidth(), selectedlayerHeight = b.outerHeight(), totalWidth = container.width(), totalHeight = container.height(), b.closest(".slide_layer_type_column").addClass("column_from_draggable"), b.closest(".slide_layer_type_row").css({
				zIndex: 190
			}), jQuery("#layer_text_wrapper").removeClass("currently_editing_txt"), t.setLayerSelected(a), t.groupMove.x = 0, t.groupMove.y = 0, t.groupMove.sameGroup = t.getSameLinkedElements(c)
		};
		...
		t.updateMovedLayers = function (a) {
			...
			t.keyboardmovedlayers = t.getCurLinkedElements(), jQuery.each(t.keyboardmovedlayers, function (c, d) {
				void 0 !== d.references && ("top" == a ? punchgs.TweenLite.set(d.references.htmlLayer, {
					top: Math.round(d.references.htmlLayer.position().top) + b
				}) : punchgs.TweenLite.set(d.references.htmlLayer, {
					left: Math.round(d.references.htmlLayer.position().left) + b
				}))
			})
			...
			var e = c.position(),
				...
				h = 0,
				i = 0,
				j = void 0 === b.originapPosition ? t.getLayer(b) : t.getLayer(t.selectedLayerSerial),
				k = totalWidth,
				l = totalHeight;
			...
			if ("divLayers" === c.parent().attr("id") && (j.p_uid = -1), -1 !== m && -1 !== j.p_uid || m != j.p_uid && ("row" === j.type || -1 !== j.p_uid && "column" === t.getObjLayerType(j.p_uid) ? punchgs.TweenLite.set(c, {
					...
					display: "block",
					position: "absolute"
				})), -1 !== j.p_uid && "group" === t.getObjLayerType(j.p_uid) && (k = t.getLayerByUniqueId(j.p_uid).references.htmlLayer.width(), l = t.getLayerByUniqueId(j.p_uid).references.htmlLayer.height()), void 0 !== a.offsetX && void 0 !== b.originalPosition && t.groupMove.sameGroup.length > 0)
				for (var n = {
		...
		t.clickOnAutoLineBreak = function () {
			var a = t.selectedLayerSerial,
				b = jQuery("#slide_layer_" + a);
			...
			if (jQuery("#layer_auto_line_break")[0].checked) {
				...
				b.css({
					height: "auto"
				}), b.find(".innerslide_layer.tp-caption").first().css({
					maxHeight: "none",
					minHeight: e,
					maxWidth: d
				}), jQuery("#layer_max_width").val(d + "px"), jQuery("#layer_max_height").val("auto")
			} else jQuery(".rs-linebreak-check").addClass("notselected"), jQuery("#layer_whitespace option[value='nowrap']").attr("selected", "selected"), jQuery("#layer_max_width").val("auto"), jQuery("#layer_max_height").val("auto"), b.css({
				width: "auto"
			}), b.find(".innerslide_layer.tp-caption").first().css({
				maxHeight: "none",
				minHeight: "none",
		...
		var resetCurrentElementSize = function () {
				...
				if ("text" == a.type || "button" == a.type) {
					...
					"image" == a.type && jQuery('#layer_cover_mode option[value="custom"]').attr("selected", !0);
					...
					var d = void 0 != a.image_librarysize ? a.image_librarysize.width : c.width,
						e = void 0 != a.image_librarysize ? a.image_librarysize.height : c.height;
			...
			scaleNormal = function () {
				var a = t.selectedLayerSerial,
					c = (resetImageDimensions(), jQuery("#slide_layer_" + a)),
					d = jQuery("#layer_scaleX").val(),
					e = jQuery("#layer_scaleY").val();
				d = jQuery.isNumeric(d) ? d + "px" : d, e = jQuery.isNumeric(e) ? e + "px" : e, punchgs.TweenLite.set(c, {
					...
					width: d,
					height: e
				}), punchgs.TweenLite.set(c.find("img"), {
					width: d,
					height: e
				})
			},
			scaleProportionalVideo = function (a) {
				var b = t.selectedLayerSerial,
					c = jQuery("#slide_layer_" + b).find(".slide_layer_video");
				if (a) {
			...
			scaleNormalVideo = function () {
				var a = t.selectedLayerSerial,
					b = jQuery("#slide_layer_" + a).find(".slide_layer_video"),
					c = jQuery("#layer_video_width").val(),
					d = jQuery("#layer_video_height").val();
		...
		t.getLayerGeneralParamsStatus = function () {
			...
			var b = jQuery("#ken_burn_example"),
				c = b.data(),
				e = (b.find(".defaultimg"), c.lastsrc),
				g = (c.owidth, c.oheight, b.width()),
				h = b.height();
			...
			var a = new Image,
				b = jQuery("#ken_burn_slot_example").data("src"),
				c = jQuery("#ken_burn_example").data("lastsrc");
		...
		var buildKenBurnExample = function () {
				var a = jQuery("#ken_burn_example"),
					c = (jQuery("#ken_burn_slot_example"), jQuery("#divLayers")),
					d = a.width() / c.width() * c.height();
				a.css({
					height: d + "px"
			...
			initBackgroundFunctions = function () {
				jQuery("body").on("change", 'select[name="layer_target[]"]', function () {
					...
					jQuery(this).closest("li").find('select[name="do-layer-animation-overwrite[]"] option[value="' + a.animation_overwrite + '"]').attr("selected", !0), jQuery(this).closest("li").find('select[name="do-layer-trigger-memory[]"] option[value="' + a.trigger_memory + '"]').attr("selected", !0)
					...
					var a = jQuery(this).closest("li").find('select[name="layer_target[]"] option:selected').val(),
						b = jQuery(this).val(),
						c = t.getLayerIdByUniqueId(a),
						d = {};
					d.animation_overwrite = b, update_layer_changes = !1, t.updateLayer(c, d), update_layer_changes = !0, t.getLayer(t.selectedLayerSerial).unique_id == a && jQuery('#layer-animation-overwrite option[value="' + b + '"]').attr("selected", !0), jQuery('select[name="layer_target[]"] option:selected').each(function () {
						jQuery(this).val() == a && jQuery(this).closest("li").find('select[name="do-layer-animation-overwrite[]"] option[value="' + b + '"]').attr("selected", !0)
					})
					...
					var a = jQuery(this).closest("li").find('select[name="layer_target[]"] option:selected').val(),
						...
						c = t.getLayerIdByUniqueId(a),
						d = {};
					d.trigger_memory = b, update_layer_changes = !1, t.updateLayer(c, d), update_layer_changes = !0, t.getLayer(t.selectedLayerSerial).unique_id == a && jQuery('#layer-tigger-memory option[value="' + b + '"]').attr("selected", !0), jQuery('select[name="layer_target[]"] option:selected').each(function () {
						jQuery(this).val() == a && jQuery(this).closest("li").find('select[name="do-layer-trigger-memory[]"] option[value="' + b + '"]').attr("selected", !0)
					})
				...
				var a = jQuery("#media-filter-type option:selected").val();
				void 0 !== a && (jQuery(".inst-filter-griditem.selected").removeClass("selected"), jQuery(".inst-filter-griditem.filter_" + a).addClass("selected"), jQuery(".oldslotholder").attr("class", "oldslotholder " + a), jQuery(".slotholder").attr("class", "slotholder " + a)), jQuery("#slide_bg_end_position").change(function () {
					...
					var d = "";
					jQuery("#radio_back_image")[0].checked ? d = jQuery("#image_url").val() : jQuery("#radio_back_external")[0].checked && (d = jQuery("#slide_bg_external").val()), "" != d && (c.src = d), t.changeSlotBGs()
				});
				...
				jQuery("#layer_resize-full").change(function () {
					...
					if ("on" == jQuery('input[name="kenburn_effect"]:checked').val()) {
						var a = parseInt(jQuery('input[name="kb_start_fit"]').val()),
							c = new Image;
						c.onload = function () {
							b(a, c.width, c.height, jQuery("#divbgholder"))
						};
						var d = "";
						jQuery("#radio_back_image")[0].checked ? d = jQuery("#image_url").val() : jQuery("#radio_back_external")[0].checked && (d = jQuery("#slide_bg_external").val()), "" != d && (c.src = d)
					}
			...
			changeEndStaticFunctions = function () {
				jQuery("#layer_static_start").each(function () {
					var a = parseInt(jQuery(this).val()),
						b = jQuery("#layer_static_end option:selected").val(),
						c = parseInt(jQuery("#layer_static_start option:last-child").val());
					jQuery("#layer_static_end").empty();
					for (var d = a + 1; d <= c; d++) jQuery("#layer_static_end").append('<option value="' + d + '">' + d + "</option>");
					jQuery("#layer_static_end").append('<option value="last">' + rev_lang.last_slide + "</option>"), jQuery("#layer_static_end option[value='" + b + "']").attr("selected", "selected")
				})
			};
		t.get_current_selected_layer = function () {
			...
			window.onbeforeunload = function (a) {
				if (save_needed) {
					var b = rev_lang.leave_not_saved,
						a = a || window.event;
