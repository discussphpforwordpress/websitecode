...
var tpLayerTimelinesRev = new function () {
		...
		jQuery("#tp-addiconbutton, .addbutton-icon").click(function () {
			jQuery("#dialog_insert_icon").dialog({
				...
				resize: function () {
					...
					a.css({
						width: a.parent().width() - 30,
						height: a.parent().height() - 60
					})
				},
				modal: !0,
				create: function (a, b) {
	...
	function theLayerInAnimation(a) {
		var b = a.closest(".slide_layer"),
			c = u.getSerialFromID(b.attr("id")),
			d = new Object;
		...
		var e = b.find(".tp-mask-wrap"),
			g = (d.animation, b.hasClass("slide_layer_type_column") ? b.find(".column_background").first() : void 0),
			h = d.frames.frame_0.speed / 1e3,
			i = d.frames.frame_0.easing,
			j = d.frames.frame_0.splitdelay / 100,
			k = d.frames.frame_0.split,
			l = d.frames.frame_999.split,
			m = a,
			n = new Object,
			o = new Object,
			p = d.frames.frame_0.split_direction;
		if (n.transx = 0, n.transy = 0, n.transz = 0, n.rotatex = 0, n.rotatey = 0, n.rotatez = 0, n.scalex = 1, n.scaley = 1, n.skewx = 0, n.skewy = 0, n.opac = 0, n.tper = parseFloat(d.deformation.pers), n.origin = "center,center", o.transx = 0, o.transy = 0, o.transz = parseFloat(d.deformation.z), o.rotatex = parseFloat(d.deformation.xrotate), o.rotatey = parseFloat(d.deformation.yrotate), o.rotatez = parseFloat(d["2d_rotation"]), o.scalex = parseFloat(d.deformation.scalex), o.scaley = parseFloat(d.deformation.scaley), o.skewx = parseFloat(d.deformation.skewx), o.skewy = parseFloat(d.deformation.skewy), o.opac = parseFloat(d.deformation.opacity), o.tper = parseFloat(d.deformation.pers), n["-webkit-filter"] = "", n.filter = "", o["-webkit-filter"] = "", o.filter = "", void 0 !== d.deformation.blurfilter && parseInt(d.deformation.blurfilter, 0) > 0 || void 0 !== d.blurfilter_start && parseInt(d.blurfilter_start, 0) > 0) {
			var q = "blur(" + parseInt(d.deformation.blurfilter, 0) + "px)",
				r = "inherit" === d.blurfilter_start ? q : "blur(" + parseInt(d.blurfilter_start, 0) + "px)";
		...
		if (void 0 !== d.deformation.grayscalefilter && parseInt(d.deformation.grayscalefilter, 0) > 0 || void 0 !== d.grayscalefilter_start && parseInt(d.grayscalefilter_start, 0) > 0) {
			var s = "grayscale(" + parseInt(d.deformation.grayscalefilter, 0) + "%)",
				t = "inherit" === d.grayscalefilter_start ? s : "grayscale(" + parseInt(d.grayscalefilter_start, 0) + "%)";
		...
		if (void 0 !== d.deformation.brightnessfilter && 100 != parseInt(d.deformation.brightnessfilter, 0) || void 0 !== d.brightnessfilter_start && 100 != parseInt(d.brightnessfilter_start, 0)) {
			var v = "brightness(" + parseInt(d.deformation.brightnessfilter, 0) + "%)",
				w = "inherit" === d.brightnessfilter_start ? v : "brightness(" + parseInt(d.brightnessfilter_start, 0) + "%)";
		...
		var x = d.layer_2d_origin_x + "%",
			y = d.layer_2d_origin_y + "%",
			z = x + " " + y;
		if (void 0 != a.data("mySplitText") && ("none" != k || "none" != l)) try {
			a.data("mySplitText").revert()
		} catch (a) {}
		switch ("chars" == k || "words" == k || "lines" == k || "chars" == l || "words" == l || "lines" == l ? a.find("a").length > 0 ? a.data("mySplitText", new SplitText(a.find("a"), {
			type: "lines,words,chars"
		})) : a.data("mySplitText", new SplitText(a, {
			type: "lines,words,chars"
		})) : a.data("mySplitText", "none"), k) {
			case "chars":
		...
		m.length;
		punchgs.TweenLite.killTweensOf(a, !1), punchgs.TweenLite.killTweensOf(m, !1), punchgs.TweenLite.set(e, {
		...
		if (!1 !== D) "block" === D.type && (D.ft[0].background = window.RevColor.get(d.frames.frame_0.sfxcolor), B.add(punchgs.TweenLite.fromTo(D.bmask_in, h / 2, D.ft[0], D.ft[1], j)), B.add(punchgs.TweenLite.fromTo(D.bmask_in, h / 2, D.ft[1], D.t, j + h / 2)), B.add(C.set(m, {
			clearProps: "transform"
		}), 0), B.add(C.staggerFromTo(m, .05, {
			x: 0,
			y: 0,
			scale: 1,
			autoAlpha: 0
		...
		if (void 0 != g && B.add(punchgs.TweenLite.fromTo(g, h, {
				...
				overwrite: "all",
				force3D: "auto"
			}), 0), d.mask_start || B.add(punchgs.TweenLite.set(e, {
				overflow: "visible"
			}), 0), d.mask_start) {
			var M = new Object;
		...
		return d.mask_start || d.mask_end ? e.addClass("tp-showmask") : e.removeClass("tp-showmask"), a.data("startanimobj", n), B.add(punchgs.TweenLite.fromTo(jQuery("#startanim_wrapper"), C.totalDuration(), {
			...
			width: 67,
			ease: i
		}), 0), m != a && B.add(punchgs.TweenLite.fromTo(a.parent(), .2, {
			autoAlpha: 0
		}, {
			autoAlpha: 1
		}), 0), B
	...
	function theLayerOutAnimation(a) {
		...
		var e = b.find(".tp-mask-wrap"),
			f = b.hasClass("slide_layer_type_column") ? b.find(".column_background").first() : void 0,
			g = d.frames.frame_999.animation,
			h = d.frames.frame_999.speed / 1e3,
			i = d.frames.frame_999.easing,
			j = d.frames.frame_999.splitdelay / 100,
			k = d.frames.frame_999.split,
			l = a;
		if (theanim = new Object, theresult = new Object, originx = d.layer_2d_origin_x + "%", originy = d.layer_2d_origin_y + "%", origin = originx + " " + originy, $splitdir = d.frames.frame_999.split_direction, i = "nothing" == i ? d.frames.frame_999.easing : i, theanim.transx = 0, theanim.transy = 0, theanim.transz = 0, theanim.rotatex = 0, theanim.rotatey = 0, theanim.rotatez = 0, theanim.scalex = 1, theanim.scaley = 1, theanim.skewx = 0, theanim.skewy = 0, theanim.opac = 0, theanim.tper = parseFloat(d.deformation.pers), theresult.transx = 0, theresult.transy = 0, theresult.transz = parseFloat(d.deformation.z), theresult.rotatex = parseFloat(d.deformation.xrotate), theresult.rotatey = parseFloat(d.deformation.yrotate), theresult.rotatez = parseFloat(d["2d_rotation"]), theresult.scalex = parseFloat(d.deformation.scalex), theresult.scaley = parseFloat(d.deformation.scaley), theresult.skewx = parseFloat(d.deformation.skewx), theresult.skewy = parseFloat(d.deformation.skewy), theresult.opac = parseFloat(d.deformation.opacity), theresult.tper = parseFloat(d.deformation.pers), theanim["-webkit-filter"] = "", theanim.filter = "", theresult["-webkit-filter"] = "", theresult.filter = "", void 0 !== d.deformation.blurfilter && parseInt(d.deformation.blurfilter, 0) > 0 || void 0 !== d.blurfilter_start && parseInt(d.blurfilter_start, 0) > 0) {
			var m = "blur(" + parseInt(d.deformation.blurfilter, 0) + "px)",
				n = "inherit" === d.blurfilter_end ? m : "blur(" + parseInt(d.blurfilter_end, 0) + "px)";
		...
		if (void 0 !== d.deformation.grayscalefilter && parseInt(d.deformation.grayscalefilter, 0) > 0 || void 0 !== d.grayscalefilter_end && parseInt(d.grayscalefilter_end, 0) > 0) {
			var o = "grayscale(" + parseInt(d.deformation.grayscalefilter, 0) + "%)",
				p = "inherit" === d.grayscalefilter_end ? o : "grayscale(" + parseInt(d.grayscalefilter_end, 0) + "%)";
		...
		if (void 0 !== d.deformation.brightnessfilter && 100 != parseInt(d.deformation.brightnessfilter, 0) || void 0 !== d.brightnessfilter_end && 100 != parseInt(d.brightnessfilter_end, 0)) {
			var q = "brightness(" + parseInt(d.deformation.brightnessfilter, 0) + "%)",
				r = "inherit" === d.brightnessfilter_end ? q : "brightness(" + parseInt(d.brightnessfilter_end, 0) + "%)";
		...
		var t = (l.length, new punchgs.TimelineLite),
			v = new punchgs.TimelineLite;
		null == g && (g = "auto"), d.mask_end && ("auto" !== g || d.mask_start) || t.add(punchgs.TweenLite.set(e, {
			overflow: "visible"
		}));
		var w = checkSFXAnimations(d, d.frames.frame_999.sfx_effect, e, j, i, h);
		if (!1 !== w) "block" === w.type && (w.ft[0].background = window.RevColor.get(d.frames.frame_999.sfxcolor), t.add(punchgs.TweenLite.fromTo(w.bmask_out, h / 2, w.ft[0], w.ft[1], j)), t.add(punchgs.TweenLite.fromTo(w.bmask_out, h / 2, w.ft[1], w.t, j + h / 2)), t.add(v.set(l, {
			clearProps: "transform"
		}), 0), t.add(v.staggerTo(l, .05, {
			x: 0,
			y: 0,
			autoAlpha: 0,
			delay: h / 2
			...
			if ("auto" === g) theanim = a.data("startanimobj");
			else {
			...
			if (d.frames.frame_999.use_text_c && (y.color = d.frames.frame_999.text_c), d.frames.frame_999.use_bg_c && (y.backgroundColor = d.frames.frame_999.bg_c), l.length > 1) {
				var z = getSplitTextDirs(l.length - 1, $splitdir),
					A = {
						to: getCycles(jQuery.extend({}, y, !0))
					};
				for (var B in l) {
		...
		return t.add(punchgs.TweenLite.fromTo(jQuery("#endanim_timerunnerbox"), v.totalDuration(), {
			x: 0
		}, {
			x: -67,
			ease: i
		}), 0), t.add(punchgs.TweenLite.fromTo(jQuery("#endanim_timerunner"), v.totalDuration(), {
			x: 0
		}, {
			x: -67,
			ease: i
		}), 0), l != a && t.add(punchgs.TweenLite.fromTo(a.parent(), .2, {
			autoAlpha: 1
		}, {
			autoAlpha: 0
		}), v.totalDuration() - .2), t
	...
	function loadMusicTimeLine(a, b) {
		...
		var c = new XMLHttpRequest,
			d = a.references.sorttable.timeline,
			e = null;
	...
	function displayAudioBuffer(a, b) {
		try {
			var c = a.references.sorttable.timeline,
				d = b.getChannelData(0),
				f = (c.find(".timeline_full"), 100 * b.duration),
				g = 19,
				i = (a.video_data.start_at, getStartSec(a.video_data.start_at)),
				j = getStartSec(a.video_data.end_at);
			...
			for (var o = 0, p = j - i, q = 0; q < j - i; q += 200) {
				var r = Math.floor(f * q / p),
					s = d[i + q] * g;
				m.beginPath(), m.moveTo(r, 0), m.lineTo(r + 1, s), m.stroke(), o++
			}
			if ("none" != a.video_data.videoloop)
				for (var u = m.getImageData(0, 0, f, g), v = t.mainMaxTimeLeft / f, q = 0; q < v; q++) m.beginPath(), m.moveTo(q * f, -50), m.lineTo(q * f, g), m.lineWidth = 3, m.strokeStyle = "#c0392b", m.stroke(), m.putImageData(u, q * f, 0);
	...
	t.timelinetype = "absolute", t.mainMaxTimeLeft = 0, t.layout = "desktop", t.timercorrectur = 0, t.init = function () {
		...
		var g, d = new punchgs.TimelineLite,
			f = jQuery("#form_slide_params").offset();
		jQuery("body").on("click", ".remove-trans-from-list", function () {
			...
			var b = jQuery(this).find('input[name="slide_transition[]"]'),
				c = jQuery(".slide-trans-example-inner .slotholder"),
				e = jQuery(".slide-trans-example-inner .oldslotholder"),
				g = jQuery(".slide-trans-example");
			c.find(".slot").each(function () {
				jQuery(this).remove()
			}), e.find(".slot").each(function () {
				jQuery(this).remove()
			}), d.kill(), punchgs.TweenLite.set(c, {
				clearProps: "transform"
			...
			var c = a.keyCode ? a.keyCode : a.which,
				d = void 0 != jQuery(document.activeElement).data("steps") ? parseFloat(jQuery(document.activeElement).data("steps")) : 1;
			...
			var b = a.parent().find(".inp-deep-list"),
				c = '<span class="inp-deep-listitems">',
				d = a.data("reverse"),
				e = a.data("deepwidth"),
				f = void 0 != a.data("selects") ? a.data("selects").split("||") : "",
				g = void 0 != a.data("svalues") ? a.data("svalues").split("||") : "",
				h = void 0 != a.data("icons") ? a.data("icons").split("||") : "",
				i = a.attr("id");
			void 0 !== e && punchgs.TweenLite.set(b, {
				minWidth: e + "px"
			}), "on" == d && (c = c + "<span class='reverse_input_wrapper'><span class='reverse_input_text'>Direction Auto Reverse</span><input class='reverse_input_check tp-moderncheckbox' name='" + i + "_reverse' id='" + i + "_reverse' type='checkbox'></span>"), void 0 !== f && "" != f && jQuery.each(f, function (a) {
				var b = g[a] || "",
					d = f[a] || "",
					a = h[a] || "";
			...
			var a = jQuery(this),
				b = a.closest(".inp-deep-wrapper").find("input");
			...
			var a = jQuery(this),
				b = a.closest("li"),
				c = a.closest(".timeline_frame"),
				d = jQuery("#timline-manual-dialog"),
				e = c.position().left,
				g = (b.width(), c.data("frameindex")),
				h = u.getLayerByUniqueId(b.data("uniqueid")),
				i = h.frames["frame_" + g].time,
				j = h.frames["frame_" + g].speed;
			d.appendTo(b), e = 999 === g ? e - d.width() + c.width() - 20 : 0 === g ? e : e - d.width() / 2 + 10, e = e < 20 ? 20 : e, d.css({
				left: e
			}), jQuery("#clayer_start_time").val(i), jQuery("#clayer_start_speed").val(j), d.data("frameindex", g), d.data("uniqueid", h.unique_id), d.show()
			...
			u.selectedLayers = [], jQuery(".layer-on-timeline-selector").each(function () {
				var b = jQuery(this),
					c = b.closest(".mastertimer-layer").data("uniqueid"),
					d = u.getLayerByUniqueId(c);
		...
		jQuery(".layer-on-timeline-selector").each(function () {
			var b = jQuery(this),
				c = u.getLayerByUniqueId(b.closest(".mastertimer-layer").data("uniqueid"));
		...
		for (var a = document.getElementsByClassName("innerslide_layer"), b = 0; b < a.length; b++) {
			...
			if ((a[b].parentNode.classList.contains("rs-preview-inside-looper") || a[b].parentNode.parentNode.classList.contains("rs-preview-inside-looper")) && c.unwrap(), void 0 != c.data("tl")) {
				...
				punchgs.TweenLite.set(c[0].parentNode, {
					autoAlpha: 1
				}), t.rebuildLayerIdle(c.closest(".slide_layer")), u.removeCurrentLayerRotatable()
			}
		}
		...
		var a = jQuery(".slide_layer.layer_selected"),
			b = a.find(".innerslide_layer").first();
		...
		var d = a.find(".rs-preview-inside-looper"),
			e = params.loop_startdeg,
			f = params.loop_enddeg,
			g = params.loop_speed,
			h = params.loop_xorigin + "% " + params.loop_yorigin + "%",
			i = params.loop_easing,
			j = params.loop_angle,
			k = parseInt(params.loop_radius, 0),
			l = params.loop_xstart,
			m = params.loop_ystart,
			n = params.loop_xend,
			o = params.loop_yend,
			p = params.loop_zoomstart,
			q = params.loop_zoomend;
		factor = 1;
		var r = new punchgs.TimelineLite;
		switch (r.pause(), loopanim) {
			case "rs-pendulum":
				r.add(punchgs.TweenLite.fromTo(d, g, {
					force3D: "auto",
					rotation: e,
					transformOrigin: h
				}, {
			...
			case "rs-pulse":
				...
				break;
			case "rs-wave":
				var s = (parseInt(params.loop_xorigin, 0) / 100 - .5) * d.width(),
					v = (parseInt(params.loop_yorigin, 0) / 100 - .5) * d.height(),
					w = -1 * k + v,
					x = 0 + s,
					y = {
						a: 0,
					...
					z = parseInt(j, 0);
				r.add(punchgs.TweenLite.fromTo(y, g, {
					a: 0 + z
				}, {
					a: 360 + z,
					force3D: "auto",
					...
					onUpdate: function () {
						var a = y.a * (Math.PI / 180),
							b = y.yoffset + y.unit * (1 - Math.sin(a)),
							c = y.xoffset + Math.cos(a) * y.unit;
		...
		var e = u.getSerialFromID(a.attr("id")),
			f = u.getLayer(e, c),
			g = a.find(".tp-caption img");
		if (u.updateHtmlLayerPosition(!1, f, u.getVal(f, "top"), u.getVal(f, "left"), u.getVal(f, "align_hor"), u.getVal(f, "align_vert")), g.length > 0 && !jQuery(g).hasClass("loaded")) {
			...
			h.onload = function () {
				...
				g[0].src = f.image_url = g_revslider_url + "/admin/assets/images/tp-brokenimage.png", u.updateHtmlLayerPosition(!1, f, u.getVal(f, "top"), u.getVal(f, "left"), u.getVal(f, "align_hor"), u.getVal(f, "align_vert"))
			}, h.onabort = function () {
		...
		if (0 == b.length) return !1;
		if (void 0 == b.data("tl")) var c = new punchgs.TimelineLite;
		else var c = b.data("tl");
		c.clear(), c.kill(), c.pause(), b.data("inanim", theLayerInAnimation(b)), b.data("outanim", theLayerOutAnimation(b)), c.addLabel("inanimation"), c.add(b.data("inanim"), "=+0.2"), c.addLabel("outanimation"), c.add(punchgs.TweenLite.fromTo(jQuery("#startanim_timerunner"), 1, {
			...
			y: 41
		}), "outanimation"), c.add(punchgs.TweenLite.fromTo(jQuery("#startanim_timerunnerbox"), 1, {
			x: 0,
			y: 0
		}, {
			y: 41
		}), "outanimation"), c.add(punchgs.TweenLite.fromTo(jQuery("#endanim_timerunnerbox"), 1, {
			x: 0,
			y: -41
		}, {
			x: 0,
			y: 0
		}), "outanimation"), c.add(punchgs.TweenLite.fromTo(jQuery("#endanim_timerunner"), 1, {
			x: 0,
			y: -41
		}, {
			y: 0
		}), "outanimation"), c.add(punchgs.TweenLite.set(jQuery("#endanim_wrapper"), {
			width: 67,
			autoAlpha: 1
	...
	var checkAnimValue = function (a, b, c, d, e) {
			...
			var j = jQuery("#divLayers").width(),
				k = jQuery("#divLayers").height(),
				l = c.closest(".slide_layer"),
				m = l.width(),
				n = l.height(),
				o = l.position();
			if (f.match(/%]/g)) f = f.split("[")[1].split("]")[0], "horizontal" == d ? f = m * parseInt(f, 0) / 100 : "vertical" == d && (f = n * parseInt(f, 0) / 100);
			else switch (f.toLowerCase()) {
				case "top":
				case "stage_top":
					f = 0 - n - o.top;
					break;
		...
		initSlideDuration = function () {
			...
			void 0 != a && 0 != a && "undefined" != a || (a = g_slideTime), jQuery("#mastertimer-maxtime").css({
				left: a / 10
			})
		};
	t.masterTimerPositionChange = function (a) {
		var b = jQuery(document.getElementById("mastertimer-position")),
			c = (b[0].getBoundingClientRect().left - document.getElementById("master-rightheader").getBoundingClientRect().left + t.timercorrectur) / 100,
			d = jQuery(document.getElementById("divbgholder")).data("slidetimeline");
		if (b[0].className = b[0].classList.contains("hovering") ? b[0].className : b[0].className + " hovering", c <= 0 && ("wasnotidle" == b.data("wasidle") || void 0 == b.data("wasidle")) && (t.stopAllLayerAnimation(), b.data("wasidle", "wasidle"), void 0 != b.data("tl") && b.data("tl").kill(), void 0 != d && (d.stop(), d.seek(1e5)), t.allLayerToIdle()), c > 0 && ("wasidle" == b.data("wasidle") || void 0 == b.data("wasidle")) && (b.data("wasidle", "wasnotidle"), createGlobalTimeline(!0), document.getElementById("mastertimer-playpause-wrapper").innerHTML = '<i class="eg-icon-play"></i><span>播放</span>', b[0].className = b[0].classList.contains("inaction") ? b[0].className : b[0].className + " inaction"), c > 0 && "wasnotidle" == b.data("wasidle")) {
		...
		var b = Math.floor(a / 6e3),
			c = Math.floor(Math.ceil(a - 6e3 * b) / 100),
			d = Math.round(a - 100 * c - 6e3 * b);
	...
	var initMasterTimer = function () {
		...
		jQuery("#mastertimer-position").on("poschanged", function () {
			var a = jQuery(this),
				b = Math.round(a.position().left + t.timercorrectur),
				c = t.convToTime(b);
			b < 0 && (c = "IDLE"), document.getElementById("master-timer-time").innerHTML = c
		}), jQuery("#mastertimer-backtoidle").click(function () {
			jQuery("#mastertimer-position").removeClass("inaction"), document.getElementById("mastertimer-playpause-wrapper").innerHTML = '<i class="eg-icon-play"></i><span>播放</span>', document.getElementById("master-timer-time").innerHTML = "IDLE", t.stopAllLayerAnimation();
			var a = jQuery("#mastertimer-position"),
				b = jQuery("#divbgholder").data("slidetimeline");
			a.css({
				left: "-15px"
			}), void 0 != a.data("tl") && a.data("tl").kill(), void 0 != b && (b.stop(), b.seek(1e5)), t.allLayerToIdle()
		}), jQuery("#divLayers").hover(function () {
			var a = jQuery(document.getElementById("mastertimer-position")),
				b = document.getElementById("mastertimer-playpause-wrapper"),
				c = jQuery(document.getElementById("divbgholder")).data("slidetimeline");
			void 0 != a.data("tl") && a.data("tl").stop(), void 0 != c && (c.stop(), c.seek(1e5)), a.removeClass("inaction"), b.innerHTML = '<i class="eg-icon-play"></i><span>播放</span>', a.hasClass("hovering") && (a.removeClass("hovering"), t.stopAllLayerAnimation(), t.allLayerToIdle(), jQuery("#layeranimation-playpause").hasClass("inpuase") || t.checkAnimationTab() && t.animateCurrentSelectedLayer(1), jQuery("#loopanimation-playpause").hasClass("inpuase") || t.checkLoopTab() && t.animateCurrentSelectedLayer(2))
			...
			var b = jQuery("#mastertimer-linear").offset().left,
				c = jQuery("#master-rightheader").scrollLeft();
			...
			0 == __ctime.data("offset") && (punchgs.TweenLite.set(__ctime, {
				...
				left: b + 15
			}), __ctimei[0].innerHTML = t.convToTime(b - 10))
			...
			if (punchgs.TweenLite.to(jQuery("#mastertimer-poscurtime"), .3, {
				...
				document.getElementById("mastertimer-playpause-wrapper").innerHTML = '<i class="eg-icon-play"></i><span>播放</span>', t.stopAllLayerAnimation();
				var b = jQuery("#mastertimer-position");
				void 0 != b.data("tl") && b.data("tl").kill()
			} else {
				createGlobalTimeline(!0), document.getElementById("mastertimer-playpause-wrapper").innerHTML = '<i class="eg-icon-pause"></i><span>暂停</span>', jQuery("#mastertimer-position").addClass("inaction");
				var b = jQuery("#mastertimer-position"),
					c = b.data("tl"),
					d = jQuery("#divbgholder").data("slidetimeline"),
					e = b.position().left / 100;
	...
	var setFakeAnim = function () {
		var b = jQuery(".slide-trans-cur-ul li").first(),
			c = b.data("animval"),
			d = b.text();
	...
	t.setSlideTransitionTimerBar = function () {
		var a = document.getElementById("slide_in_sort_time"),
			b = a.getElementsByClassName("timeline_frame")[0],
			c = a.getElementsByClassName("timeline_full")[0],
			d = document.getElementById("transition_duration") ? document.getElementById("transition_duration").value : 0;
		a.getElementsByClassName("duration_cont")[0].innerHTML = d, jQuery.isNumeric(d) || (d = 500), punchgs.TweenLite.set(b, {
			width: d / 10
	...
	var addSlideToSortbox = function () {
		...
		var a = document.getElementById("slide_in_sort_time"),
			b = a.getElementsByClassName("timeline_frame")[0],
			c = a.getElementsByClassName("duration_cont")[0];
		jQuery(b).resizable({
			minWidth: 0,
			handles: "e",
			start: function (a, b) {},
	...
	t.rerenderAllAudioMap = function () {
		...
		if (b.data("lastaudio") == a.video_data.urlAudio && void 0 != b.data("audiobuffer") ? displayAudioBuffer(a, b.data("audiobuffer")) : loadMusicTimeLine(a, a.video_data.urlAudio), b.data("lastaudio", a.video_data.urlAudio), !AudioContext) return console.log("您的浏览器不支持音频地图，尝试最新的Chrome或Firefox内核浏览器. "), !1
		...
		var c = "",
			e = (t.isLayerVisible(b.references.htmlLayer), ""),
			f = "",
			g = t.getSortboxText(b.alias),
			h = Number(b.order) + 5,
			i = "",
			j = "";
		...
		switch (b.deleted && (e += " layer-deleted"), i += '<li data-uniqueid="' + b.unique_id + '" id="layer_sort_' + a + '" data-type="' + b.type + '" class="mastertimer-layer ui-state-default' + e + '" data-grouptype="' + b.grouptype + '" data-pid="' + b.p_uid + '">', i += '\t<div class="layer_sort_inner_wrapper ' + f + '">', i += '\t\t<span class="mastertimer-timeline-selector-row tipsy_enabled_top" title="在时间轴选择层">', i += '\t\t\t<input data-uniqueid="' + b.unique_id + '"  id="lots_id_' + b.unique_id + '" class="layer-on-timeline-selector" style="margin:0px" type="checkbox"/>', i += "\t\t</span>", i += '\t\t<span data-uniqueid="' + b.unique_id + '" class="list-of-layer-links tipsy_enabled_top" title="选择层群组链接">', i += '\t\t\t<span class="layer-link-type-element layer-link-type-element-cs layer-link-type-' + groupLink + '"></span>', i += '\t\t\t<span class="list-of-layer-links-inner">', i += '\t\t\t\t<span data-linktype="1" class="layer-link-type-element layer-link-type-1"></span>', i += '\t\t\t\t<span data-linktype="2" class="layer-link-type-element layer-link-type-2"></span>', i += '\t\t\t\t<span data-linktype="3" class="layer-link-type-element layer-link-type-3"></span>', i += '\t\t\t\t<span data-linktype="4" class="layer-link-type-element layer-link-type-4"></span>', i += '\t\t\t\t<span data-linktype="5" class="layer-link-type-element layer-link-type-5"></span>', i += '\t\t\t\t<span data-linktype="0" class="layer-link-type-element layer-link-type-0"></span>', i += "\t\t\t</span>", i += "\t\t</span>", "column" != b.type ? "row" !== b.type ? (i += '\t<span  class="mastertimer-timeline-zindex-row tipsy_enabled_top" title="z-Index">', i += '\t\t<i style="margin-left:15px;margin-right:0px;" class="layersortclass eg-icon-sort"></i>', i += '\t\t<span class="sortbox_depth" title="z-Index">' + h + "</span>", i += "\t</span>") : i += '\t<span  class="mastertimer-timeline-zindex-row tipsy_enabled_top" style="cursor:default !important" title="z-Index"></span>' : i += ' \t<span class="column_sort_row_spacer"></span>', i += '\t\t<span class="mastertimer-timeline-tillendcontainer" style="">', i += '\t\t\t<span data-uniqueid="' + b.unique_id + '" data-serial="' + a + '" class="till_slideend tipsy_enabled_top ' + c + '" title="等待幻灯片结束/自定义结束"><i class="eg-icon-back-in-time"></i><i class="eg-icon-download-2"></i></span>', i += "\t\t</span>", i += '\t\t<span class="sort-hover-part layer_sort_layer_text_field">', i += '\t\t\t<span class="sortbox_text"><i class="layertypeclass ', b.type) {
			case "group":
		...
		var m = "",
			n = "logical_o" === b.grouptype ? " hide_timeline" : "";
		m += '<li data-uniqueid="' + b.unique_id + '" data-serial="' + a + '" id="layer_sort_time_' + a + '" class="sortable_elements mastertimer-layer ui-state-default' + e + n + '" data-grouptype="' + b.grouptype + '" data-pid="' + b.p_uid + '">', m += '\t\t<div class="timeline_full"></div>', m += '  <div class="timeline">', m += '  \t<div class="timeline-relative-marker trm-groupandrowmarker"></div>', m += '\t\t<div data-frameindex="0" id="tl_' + b.unique_id + '_frame_0" class="timeline_frame tf_startframe tl_layer_frame" data-uniqueid="' + b.unique_id + '" data-serial="' + a + '" style="z-index:50;">', m += ' \t\t\t<span class="timebefore_cont"></span>', m += '\t\t\t<div class="tl_speed_wrapper">', m += '\t\t\t\t<div class="tlf_speed"><span class="duration_cont"></span></div>', m += '\t\t\t\t<div class="tlf_splitdelay"></div>', m += "\t\t\t</div>", m += '\t\t\t<span class="show_timeline_helper">编辑</span>', m += "\t\t</div>", m += '\t\t<div data-frameindex="999" id="tl_' + b.unique_id + '_frame_999" class="timeline_frame tf_endframe tl_layer_frame" data-uniqueid="' + b.unique_id + '" data-serial="' + a + '" style="z-index:48;">', m += ' \t\t\t<span class="timebefore_cont"></span>', m += '\t\t\t<div class="tl_speed_wrapper">', m += '\t\t\t\t<div class="tlf_speed"><span class="duration_cont"></span></div>', m += '\t\t\t\t<div class="tlf_splitdelay"></div>', m += "\t\t\t</div>", m += '\t\t\t<span class="show_timeline_helper">编辑</span>', m += "\t\t</div>", m += " </div>", m += ' <div class="slide-idle-section"></div>', m += "</li>";
		var o = !0;
		...
		var p = document.getElementById("layer_sort_time_" + a),
			q = jQuery(p),
			r = p.getElementsByClassName("timeline")[0];
		jQuery(r);
		b.references.sorttable = void 0 === b.references.sorttable ? {} : b.references.sorttable, b.references.sorttable.layer = jQuery(document.getElementById("layer_sort_" + a)), b.references.sorttable.timeline = q, b.references.quicklayer = jQuery(document.getElementById("layer_quicksort_" + a)), "audio" == b.type && (q.data("objref", b), t.drawAudioMap(b), q.on("mousemove", function (a) {
			try {
				var b = jQuery(this),
					c = b.data("objref"),
					d = b.data("serial"),
					e = jQuery("#slide_layer_" + d + " audio")[0];
				...
				clearTimeout(b.data("audiopreview")), b.find(".audio-progress").remove(), e.pause(), b.data("audiopreview", setTimeout(function () {
					...
					if (!(h < f || h > f + g)) {
						...
						var j = b.find(".audio-progress"),
							k = getStartSec(c.video_data.start_at),
							l = getStartSec(c.video_data.end_at);
						k = -1 == k ? 0 : k, l = -1 == l ? 999999999 : l, k /= 60, l /= 60, l = l > e.duration ? e.duration : l;
						var m = l - k,
							n = Math.floor(i / (100 * m));
			...
			try {
				var b = jQuery(this),
					c = b.data("serial"),
					d = jQuery("#slide_layer_" + c + " audio")[0];
	...
	var checkTillSlideEnd = function (a) {
		var b = 10 * t.mainMaxTimeLeft,
			c = document.getElementById("layer_sort_" + a.serial);
	...
	t.setTLFrame = function (a) {
		var b = a.getElementsByClassName("tlf_speed")[0],
			c = a.getElementsByClassName("tlf_splitdelay")[0],
			d = a.getElementsByClassName("duration_cont")[0],
			e = a.getElementsByClassName("timebefore_cont")[0],
			f = a.parentNode.parentNode.getElementsByClassName("timeline-relative-marker")[0],
			a = jQuery(a),
			g = u.getLayerByUniqueId(a.data("uniqueid")),
			h = u.checkLayerTriggered(g),
			i = u.getObjectLength(g.frames);
		...
		var j = a.data("frameindex"),
			k = g.frames["frame_" + j].speed,
			l = g.frames["frame_" + j].time,
			m = getSplitCounts(g.text, g.frames["frame_" + j].split, g.frames["frame_" + j].splitdelay),
			n = l;
		if (g.frames["frame_" + j].split_extratime = m, 0 !== m ? (punchgs.TweenLite.set(b, {
				width: k / 10 - m
			}), punchgs.TweenLite.set(c, {
				width: m
		...
		l == 10 * t.mainMaxTimeLeft && (e.innerHTML = '<span class="wait_slide_end">等待</span>'), g.frames["frame_" + j].time_relative = n, 0 == j && h.in && (e.innerHTML = '<span class="triggered_layer_on_timeline">a</span>'), 999 == j && h.out && (e.innerHTML = '<span class="triggered_layer_on_timeline">a</span>'), t.updateFullTime(g), checkTillSlideEnd(g)
	}, t.updateTLFrame = function (a, b, c, d) {
		t.recordFrameStatusForce && t.recordFrameStatus(a);
		var e = u.getCurrentLayer().serial,
			f = a.getElementsByClassName("tlf_speed")[0],
			g = a.getElementsByClassName("tlf_splitdelay")[0],
			h = a.getElementsByClassName("duration_cont")[0],
			i = a.getElementsByClassName("timebefore_cont")[0],
			j = a.parentNode.parentNode.getElementsByClassName("timeline-relative-marker")[0],
			a = jQuery(a),
			k = u.getLayerByUniqueId(a.data("uniqueid")),
			l = {
				frames: {}
			},
			m = u.getObjectLength(k.frames),
			n = u.checkLayerTriggered(k);
		if (fi = a.data("frameindex"), speed = 10 * a.outerWidth(), time = 10 * a.position().left, splitdelay = getSplitCounts(k.text, k.frames["frame_" + fi].split, k.frames["frame_" + fi].splitdelay), currentframe = k.frames["frame_" + fi], updateTimerText = !0, timedif = time, l.frames["frame_" + fi] = {}, speed - 10 * splitdelay < 0 && (speed = 10 * splitdelay, punchgs.TweenLite.set(a, {
				width: splitdelay
			})), 0 !== splitdelay ? (punchgs.TweenLite.set(f, {
				...
				width: 0
			})), h.innerHTML = speed, (time == 10 * t.mainMaxTimeLeft || 0 == fi && n.in || 999 == fi && n.out) && (updateTimerText = !1), void 0 !== k.p_uid && -1 !== k.p_uid && void 0 !== u.getLayerByUniqueId(k.p_uid) && "object" == typeof u.getLayerByUniqueId(k.p_uid)) {
		...
		if (999 !== fi) {
			var w = fi + 1 >= m - 1 ? 999 : fi + 1,
				x = k.frames["frame_" + w];
			void 0 != x && (x.time_relative = x.time - (currentframe.time + currentframe.speed + 10 * currentframe.split_extratime), l.frames["frame_" + w] = {
				time_relative: x.time_relative
			}, k.frames["frame_" + w].time_relative = x.time_relative)
		} else {
			var w = "frame_0";
		...
		if ("row" === a.type || "column" == a.type || "group" === a.type) {
			...
			if ("row" === a.type)
				for (var d = 0; d <= c.columns.length - 1; d++) {
		...
		var a = jQuery(a),
			c = a.data("frameindex"),
			d = u.getLayerByUniqueId(a.data("uniqueid"));
		...
		for (var e = 0; e <= u.selectedLayers.length - 1; e++) {
			var f = u.selectedLayers[e],
				g = -1 !== f ? u.getLayerByUniqueId(f) : -1,
				h = document.getElementById("tl_" + f + "_frame_" + c);
		...
		t.recordFrameStatusForce && t.recordFrameStatus(a);
		var a = jQuery(a),
			e = u.getLayerByUniqueId(a.data("uniqueid")),
			f = a.prev(),
			g = a.next(),
			h = g.data("frameindex"),
			i = a.data("frameindex"),
			j = void 0 !== b && !1 !== b ? b.position.left : a.position().left,
			k = a.outerWidth(),
			l = u.getObjectLength(e.frames),
			m = e.frames["frame_" + i];
		...
		if (void 0 !== b && !1 !== b && (b.position.left = j), punchgs.TweenLite.set(a, {
				left: j
			}), u.selectedLayers.length > 0 && !c || void 0 != u.currentGroupElements && u.currentGroupElements.length > 0 && !c) {
			...
			if (0 === i && void 0 !== u.currentGroupElements && u.currentGroupElements.length > 0)
				for (var s = 0; s <= u.currentGroupElements.length - 1; s++) {
		...
		var c = a.references.sorttable.timeline[0].getElementsByClassName("timeline_full")[0],
			d = jQuery(a.references.sorttable.timeline[0]).find(".timeline_audio"),
			b = void 0 === b ? 15 + a.frames.frame_0.time / 10 : b + 15,
			e = 10 * (b - 15);
		punchgs.TweenLite.set(c, {
			left: b,
		...
		if (u.selectedLayers.length > 0)
			for (var d = 0; d <= u.selectedLayers.length - 1; d++) {
				var e = u.selectedLayers[d];
				e != b && t.updateTLFrame(document.getElementById("tl_" + e + "_frame_" + c), !1, !0)
			}
		if (0 === c && void 0 !== u.currentGroupElements && u.currentGroupElements.length > 0)
			for (var d = 0; d <= u.currentGroupElements.length - 1; d++) {
	...
	t.deleteLayerFromSortbox = function (a) {
		var b = t.getHtmlSortItemFromSerial(a),
			c = t.getHtmlSortTimeItemFromSerial(a),
			d = t.getHtmlQuickTimeItemFromSerial(a);
		try {
		...
		var d = b ? u.arrLayersDemo : u.arrLayers,
			e = !1;
		for (var f in d) {
			var g = d[f];
			if ("group" != g.type && "row" != g.type && void 0 != g.p_uid && -1 != g.p_uid) {
				var h = b ? null : g.references.sorttable.layer,
					i = u.getLayerByUniqueId(g.p_uid),
					j = !b && i ? i.references.sorttable.layer[0].getElementsByClassName("sgw_def")[0] : void 0,
					k = g.references.htmlLayer,
					l = i ? i.references.htmlLayer : void 0;
				if (l && k && !l[0].contains(k[0])) {
					var m = l[0].getElementsByClassName("tp_layer_group_inner_wrapper")[0];
					if (void 0 !== m && void 0 !== k[0])
						if ("column" !== g.type) {
							var p, o = 99999;
							for (var q in d) {
								var r = d[q];
				...
				g.p_uid = -1;
				var k = g.references.htmlLayer,
					h = b ? null : g.references.sorttable.layer;
				if ("row" === g.type) {
					var x, s = "row-zone-" + u.getVal(g, "align_vert"),
						w = 99999,
		...
		for (j in u.arrLayers) {
			...
			if ("column" != b.type && "row" != b.type && "group" != b.type) {
				var c = b.references.sorttable.layer,
					d = c[0].parentNode.parentNode.classList.contains("sortable_column"),
					e = c[0].parentNode.parentNode.classList.contains("sortable_group"),
					f = -1;
				if (!d && !e || "layers-left-ul" == c[0].parentNode.parentNode.id);
				else {
		...
		for (var i = jQuery("#layers-left-ul").sortable("toArray", {
				attribute: "data-uniqueid"
			}), j = 0; j < i.length; j++) {
			var b = u.getLayerByUniqueId(i[j]),
				k = j + 5;
		...
		for (var a in u.arrLayers) {
			var b = u.arrLayers[a],
				c = void 0 !== b.order ? b.order + 5 : 5,
				d = {
					zIndex: c
				};
			void 0 !== b.order && punchgs.TweenLite.set(b.references.htmlLayer, {
				zIndex: Number(b.order) + 100
			}), u.updateLayer(b.serial, d, !1, !0)
		}
	};
	...
	var reinitSortBox = function (a) {
			jQuery("#last_drop_zone_layers").appendTo("#layers-left-ul"), a && jQuery(".layer_sortbox ul").sortable({
				...
				update: function (a, b) {
					...
					var d = c.parent(),
						e = d.closest(".sortable_group"),
						f = jQuery("#layers-left-ul");
				...
				drop: function (a, b) {
					...
					jQuery(a.target).removeClass("readytodrop");
					var f, d = jQuery(a.target).attr("class"),
						e = jQuery(a.srcElement).closest(".sortable_elements.sortable_layers");
		...
		initSortbox = function () {
			t.redrawSortbox(), reinitSortBox(!0), jQuery("body").delegate(".layer_sort_inner_wrapper", "mousedown", function (a) {
				...
				var b = jQuery(this),
					c = b.closest(".sortable_column"),
					d = c.length ? c : b.closest(".sortable_group"),
					e = c.length ? d.find(".sortable_layers_in_columns") : d.find(".sortable_groups_wrap");
				b.toggleClass("collapsed"), b.hasClass("collapsed") ? e.css({
					...
					maxHeight: "none",
					overflow: "visible"
				}), e.find(".sortable_elements").each(function (a, c) {
					var c = jQuery(c),
						d = c.data("uniqueid");
	...
	t.hideLayer = function (a, b) {
		if (void 0 !== a.references && void 0 !== a.references.htmlLayer) {
			...
			c.css({
				visibility: "hidden"
			}), c.addClass("currently_not_visible"), a.isDemo || setSortboxItemHidden(a.serial), 1 != b && t.isAllLayersHidden() && jQuery("#button_sort_visibility").addClass("e-disabled")
		}
		...
		if (void 0 !== a.references && void 0 !== a.references.htmlLayer) {
			...
			c.css({
				visibility: "visible"
			}), c.removeClass("currently_not_visible"), a.isDemo || setSortboxItemVisible(a.serial), 1 != b && jQuery("#button_sort_visibility").removeClass("e-disabled")
		}
	...
	var emptySortbox = function () {
		...
		prepareOneSlide = function (a, b, c, d, e, f) {
			var g = a,
				k = (g.find(".defaultimg"), g.data("zoomstart"), g.data("rotationstart"), g.find(".defaultimg").css("backgroundImage")),
				l = g.find(".defaultimg").css("backgroundColor"),
				m = 0,
				n = g.find(".defaultimg").css("backgroundSize"),
				o = g.find(".defaultimg").css("backgroundRepeat"),
				p = g.find(".defaultimg").css("backgroundPosition");
			k = k.replace('"', ""), k = k.replace('"', ""), void 0 == n && (n = "cover"), void 0 == o && (o = "no-repeat"), void 0 == p && (p = "center center");
			var e = void 0 != e ? e : jQuery("#divbgholder").width(),
				f = void 0 != f ? f : jQuery("#divbgholder").height();
		...
		slideAnimation = function (a, b, c, d, e) {
			...
			if (void 0 != a) {
				...
				var a = f = jQuery("#divbgholder").find(".slotholder"),
					b = g = jQuery("#divbgholder").find(".oldslotholder"),
					h = new Object,
					c = jQuery("#fake-select-label").data("valu"),
					i = new Object;
			...
			var j = punchgs.Power1.easeIn,
				k = punchgs.Power1.easeOut,
				l = punchgs.Power1.easeInOut,
				m = punchgs.Power2.easeIn,
				n = punchgs.Power2.easeOut,
				o = punchgs.Power2.easeInOut,
				q = (punchgs.Power3.easeIn, punchgs.Power3.easeOut),
				r = punchgs.Power3.easeInOut,
				u = 0,
				v = 1,
				w = 0,
				x = 0,
				y = new Array,
				z = [
					["boxslide", 0, 1, 10, 0, "box", !1, null, 0, k, k, 500, 6],
					["boxfade", 1, 0, 10, 0, "box", !1, null, 1, l, l, 700, 5],
					["slotslide-horizontal", 2, 0, 0, 200, "horizontal", !0, !1, 2, o, o, 700, 3],
					["slotslide-vertical", 3, 0, 0, 200, "vertical", !0, !1, 3, o, o, 700, 3],
					["curtain-1", 4, 3, 0, 0, "horizontal", !0, !0, 4, k, k, 300, 5],
					["curtain-2", 5, 3, 0, 0, "horizontal", !0, !0, 5, k, k, 300, 5],
					["curtain-3", 6, 3, 25, 0, "horizontal", !0, !0, 6, k, k, 300, 5],
					["slotzoom-horizontal", 7, 0, 0, 400, "horizontal", !0, !0, 7, k, k, 300, 7],
					["slotzoom-vertical", 8, 0, 0, 0, "vertical", !0, !0, 8, n, n, 500, 8],
					["slotfade-horizontal", 9, 0, 0, 500, "horizontal", !0, null, 9, n, n, 500, 25],
					["slotfade-vertical", 10, 0, 0, 500, "vertical", !0, null, 10, n, n, 500, 25],
					["fade", 11, 0, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["crossfade", 11, 1, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["fadethroughdark", 11, 2, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["fadethroughlight", 11, 3, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["fadethroughtransparent", 11, 4, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["slideleft", 12, 0, 1, 0, "horizontal", !0, !0, 12, r, r, 1e3, 1],
					["slideup", 13, 0, 1, 0, "horizontal", !0, !0, 13, r, r, 1e3, 1],
					["slidedown", 14, 0, 1, 0, "horizontal", !0, !0, 14, r, r, 1e3, 1],
					["slideright", 15, 0, 1, 0, "horizontal", !0, !0, 15, r, r, 1e3, 1],
					["slideoverleft", 12, 7, 1, 0, "horizontal", !0, !0, 12, r, r, 1e3, 1],
					["slideoverup", 13, 7, 1, 0, "horizontal", !0, !0, 13, r, r, 1e3, 1],
					["slideoverdown", 14, 7, 1, 0, "horizontal", !0, !0, 14, r, r, 1e3, 1],
					["slideoverright", 15, 7, 1, 0, "horizontal", !0, !0, 15, r, r, 1e3, 1],
					["slideremoveleft", 12, 8, 1, 0, "horizontal", !0, !0, 12, r, r, 1e3, 1],
					["slideremoveup", 13, 8, 1, 0, "horizontal", !0, !0, 13, r, r, 1e3, 1],
					["slideremovedown", 14, 8, 1, 0, "horizontal", !0, !0, 14, r, r, 1e3, 1],
					["slideremoveright", 15, 8, 1, 0, "horizontal", !0, !0, 15, r, r, 1e3, 1],
					["papercut", 16, 0, 0, 600, "", null, null, 16, r, r, 1e3, 2],
					["3dcurtain-horizontal", 17, 0, 20, 100, "vertical", !1, !0, 17, l, l, 500, 7],
					["3dcurtain-vertical", 18, 0, 10, 100, "horizontal", !1, !0, 18, l, l, 500, 5],
					["cubic", 19, 0, 20, 600, "horizontal", !1, !0, 19, r, r, 500, 1],
					["cube", 19, 0, 20, 600, "horizontal", !1, !0, 20, r, r, 500, 1],
					["flyin", 20, 0, 4, 600, "vertical", !1, !0, 21, q, r, 500, 1],
					["turnoff", 21, 0, 1, 500, "horizontal", !1, !0, 22, r, r, 500, 1],
					["incube", 22, 0, 20, 200, "horizontal", !1, !0, 23, o, o, 500, 1],
					["cubic-horizontal", 23, 0, 20, 500, "vertical", !1, !0, 24, n, n, 500, 1],
					["cube-horizontal", 23, 0, 20, 500, "vertical", !1, !0, 25, n, n, 500, 1],
					["incube-horizontal", 24, 0, 20, 500, "vertical", !1, !0, 26, o, o, 500, 1],
					["turnoff-vertical", 25, 0, 1, 200, "horizontal", !1, !0, 27, o, o, 500, 1],
					["fadefromright", 12, 1, 1, 0, "horizontal", !0, !0, 28, o, o, 1e3, 1],
					["fadefromleft", 15, 1, 1, 0, "horizontal", !0, !0, 29, o, o, 1e3, 1],
					["fadefromtop", 14, 1, 1, 0, "horizontal", !0, !0, 30, o, o, 1e3, 1],
					["fadefrombottom", 13, 1, 1, 0, "horizontal", !0, !0, 31, o, o, 1e3, 1],
					["fadetoleftfadefromright", 12, 2, 1, 0, "horizontal", !0, !0, 32, o, o, 1e3, 1],
					["fadetorightfadefromleft", 15, 2, 1, 0, "horizontal", !0, !0, 33, o, o, 1e3, 1],
					["fadetobottomfadefromtop", 14, 2, 1, 0, "horizontal", !0, !0, 34, o, o, 1e3, 1],
					["fadetotopfadefrombottom", 13, 2, 1, 0, "horizontal", !0, !0, 35, o, o, 1e3, 1],
					["parallaxtoright", 12, 3, 1, 0, "horizontal", !0, !0, 36, o, m, 1500, 1],
					["parallaxtoleft", 15, 3, 1, 0, "horizontal", !0, !0, 37, o, m, 1500, 1],
					["parallaxtotop", 14, 3, 1, 0, "horizontal", !0, !0, 38, o, j, 1500, 1],
					["parallaxtobottom", 13, 3, 1, 0, "horizontal", !0, !0, 39, o, j, 1500, 1],
					["scaledownfromright", 12, 4, 1, 0, "horizontal", !0, !0, 40, o, m, 1e3, 1],
					["scaledownfromleft", 15, 4, 1, 0, "horizontal", !0, !0, 41, o, m, 1e3, 1],
					["scaledownfromtop", 14, 4, 1, 0, "horizontal", !0, !0, 42, o, m, 1e3, 1],
					["scaledownfrombottom", 13, 4, 1, 0, "horizontal", !0, !0, 43, o, m, 1e3, 1],
					["zoomout", 13, 5, 1, 0, "horizontal", !0, !0, 44, o, m, 1e3, 1],
					["zoomin", 13, 6, 1, 0, "horizontal", !0, !0, 45, o, m, 1e3, 1],
					["slidingoverlayup", 27, 0, 1, 0, "horizontal", !0, !0, 47, l, k, 2e3, 1],
					["slidingoverlaydown", 28, 0, 1, 0, "horizontal", !0, !0, 48, l, k, 2e3, 1],
					["slidingoverlayright", 30, 0, 1, 0, "horizontal", !0, !0, 49, l, k, 2e3, 1],
					["slidingoverlayleft", 29, 0, 1, 0, "horizontal", !0, !0, 50, l, k, 2e3, 1],
					["notransition", 26, 0, 1, 0, "horizontal", !0, null, 46, o, m, 1e3, 1],
					["grayscale", 11, 5, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["grayscalecross", 11, 6, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["brightness", 11, 7, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["brightnesscross", 11, 8, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["blurlight", 11, 9, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["blurlightcross", 11, 10, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["blurstrong", 11, 9, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1],
					["blurstrongcross", 11, 10, 1, 300, "horizontal", !0, null, 11, o, o, 1e3, 1]
				];
			...
			D.add(punchgs.TweenLite.set(a.find(".defaultimg"), {
				autoAlpha: 0
			})), D.pause(), D.add(punchgs.TweenLite.set(b, {
				autoAlpha: 1,
				force3D: "auto",
				zIndex: 0
			...
			var E = jQuery("select[name=transition_ease_in]").val(),
				F = jQuery("select[name=transition_ease_out]").val(),
				G = 1;
			if (E = "default" === E ? y[9] || punchgs.Power2.easeInOut : E || y[9] || punchgs.Power2.easeInOut, F = "default" === F ? y[10] || punchgs.Power2.easeInOut : F || y[10] || punchgs.Power2.easeInOut, 0 == u) {
				var H = Math.ceil(i.height / i.sloth),
					I = 0;
			...
			if (6 == u) {
				...
				setTimeout(function () {
					...
					var b = jQuery(this);
					if (a + 1 < i.slots / 2) var c = 90 * (a + 2);
					else var c = 90 * (2 + i.slots - a);
			...
			if (8 == u) {
				...
				b.find(".slotslide").each(function () {
					...
					L.add(punchgs.TweenLite.fromTo(c, C / 1e3, {
						left: 0,
						top: 0,
						opacity: 0,
						force3D: "auto"
			...
			if (11 == u || 26 == u) {
				var O = 0,
					P = 2 == v ? "#000000" : 3 == v ? "#ffffff" : "transparent";
				if (26 == u && (C = 0), e) switch (D.add(punchgs.TweenLite.set(a.parent(), {
					...
					case 1:
						D.add(punchgs.TweenLite.fromTo(b, C / 1e3, {
							...
							force3D: "auto",
							ease: E
						}), 0), D.add(punchgs.TweenLite.fromTo(a, C / 1e3, {
							autoAlpha: 1
						}, {
							autoAlpha: 0,
							force3D: "auto",
					...
					case 3:
					case 4:
						D.add(punchgs.TweenLite.fromTo(a, C / 2e3, {
							autoAlpha: 1
						}, {
							autoAlpha: 0,
							force3D: "auto",
							...
							autoAlpha: 0,
							force3D: "auto"
						}), 0), D.add(punchgs.TweenLite.fromTo(b, C / 2e3, {
							autoAlpha: 0
						}, {
							autoAlpha: 1,
							force3D: "auto",
					...
					case 11:
					case 12:
						var Q = jQuery.inArray(v, [9, 10]) >= 0 ? 5 : jQuery.inArray(v, [11, 12]) >= 0 ? 10 : 0,
							R = jQuery.inArray(v, [5, 6, 7, 8]) >= 0 ? 100 : 0,
							S = jQuery.inArray(v, [7, 8]) >= 0 ? 300 : 0,
							T = "blur(" + Q + "px) grayscale(" + R + "%) brightness(" + S + "%)",
							U = "blur(0px) grayscale(0%) brightness(100%)";
					...
					var b = jQuery(this);
					if (v < 5) D.add(punchgs.TweenLite.fromTo(b, C / 1e3, {
						autoAlpha: 0
					}, {
						autoAlpha: 1,
						force3D: "auto",
						...
						var c = jQuery.inArray(v, [9, 10]) >= 0 ? 5 : jQuery.inArray(v, [11, 12]) >= 0 ? 10 : 0,
							d = jQuery.inArray(v, [5, 6, 7, 8]) >= 0 ? 100 : 0,
							e = jQuery.inArray(v, [7, 8]) >= 0 ? 300 : 0,
							f = "blur(" + c + "px) grayscale(" + d + "%) brightness(" + e + "%)",
			...
			if (12 == u || 13 == u || 14 == u || 15 == u) {
				C = C, C > i.delay && (C = i.delay), setTimeout(function () {
					punchgs.TweenLite.set(b.find(".defaultimg"), {
						autoAlpha: 0
					})
				}, 100);
				var ja = i.width,
				...
				7 == v && (ja = 0, ka = 0);
				var ua = a.find(".slotslide"),
					va = b.find(".slotslide");
				if (D.add(punchgs.TweenLite.set(g, {
						zIndex: 15
					}), 0), D.add(punchgs.TweenLite.set(f, {
						zIndex: 20
					}), 0), 8 == v ? (D.add(punchgs.TweenLite.set(g, {
						zIndex: 20
					}), 0), D.add(punchgs.TweenLite.set(f, {
						zIndex: 15
					}), 0), D.add(punchgs.TweenLite.set(ua, {
						left: 0,
						top: 0,
						scale: 1,
						opacity: 1,
			...
			if (16 == u) {
				...
				var xa = (g.find(".defaultimg"), Math.round(20 * Math.random() - 10)),
					ya = Math.round(20 * Math.random() - 10),
					za = Math.round(20 * Math.random() - 10),
					Aa = .4 * Math.random() - .2,
					Ba = .4 * Math.random() - .2,
					Ca = 1 * Math.random() + 1,
					Da = 1 * Math.random() + 1,
					Ea = .3 * Math.random() + .3;
				D.add(punchgs.TweenLite.set(g.find(".tp-half-one"), {
					overflow: "hidden"
				}), 0), D.add(punchgs.TweenLite.fromTo(g.find(".tp-half-one"), C / 800, {
					width: ja,
					height: ka / 2,
					position: "absolute",
					top: "0px",
				...
				}), 0), L.add(punchgs.TweenLite.set(a.find(".defaultimg"), {
					autoAlpha: 1
				}), 0), null != g.html() && D.add(punchgs.TweenLite.fromTo(f, (C - 200) / 1e3, {
					scale: Ea,
					x: i.width / 4 * Aa,
					y: ka / 4 * Ba,
					rotation: za,
			...
			if (17 == u && a.find(".slotslide").each(function (a) {
				...
				1 == G && (Fa = -90), 19 == u ? (Ga = Ga + "-" + i.height / 2, oa = 0) : Ga += i.height / 2, punchgs.TweenLite.set(h, {
					...
					L.add(punchgs.TweenLite.fromTo(b, C / 1e3, {
						...
						delay: 50 * a / 1e3,
						ease: E
					}), 0), L.add(punchgs.TweenLite.to(b, .1, {
						autoAlpha: 1,
						delay: 50 * a / 1e3
					}), 0), D.add(L)
				}), b.find(".slotslide").each(function (a) {
			...
			if (20 == u) {
				...
				a.find(".slotslide").each(function (a) {
					...
					var b = jQuery(this),
						c = 50 * a / 1e3;
					if (c = a > 0 ? c + C / 9e3 : 0, 1 != G) var d = -i.width / 2,
						e = 30,
						f = "20% 70% -" + i.height / 2;
					else var d = i.width / 2,
						e = -30,
						f = "80% 70% -" + i.height / 2;
			...
			if (23 == u || 24 == u) {
				...
				punchgs.TweenLite.set(h, {
					...
					D.add(punchgs.TweenLite.fromTo(b, C / 1e3, {
						...
						delay: 50 * a / 500,
						ease: F
					}), 0), 23 == u && D.add(punchgs.TweenLite.fromTo(b, C / 2e3, {
						autoAlpha: 1
					}, {
						autoAlpha: 0,
			...
			if (D.add(punchgs.TweenLite.set(a.find(".defaultimg"), {
					autoAlpha: 1
				})), D.add(punchgs.TweenLite.set(a.find(".slot"), {
					autoAlpha: 0
				})), D.seek(1e5), void 0 != d) return D;
	...
	t.resetSlideAnimations = function (a) {
		...
		var b = jQuery("#divbgholder").data("slidetimeline"),
			c = jQuery("#mastertimer-position"),
			d = c.position().left / 100;
