...
<ul id="context-menu-first-ul" class="context-menu__items">
  ...
  <li class="context-menu__item context-with-sub not_in_ctx_bg">
    ...
    <ul class="context-submenu">
    	<li class="context-menu__item">
		    <div class="ctx_item_inner context-menu__link" data-action="nothing"><span class="cx-layer-name"><?php _e('Alignment', 'revslider'); ?></span><div class="context-menu__link ctx-td-option-selector-wrapper" data-action="nothing"><div id="ctx_gridbased" class="ctx-td-option-selector context-menu__link selected" data-action="gridbased">基于网格</div><div id="ctx_slidebased" class="ctx-td-option-selector context-menu__link" data-action="slidebased">基于幻灯片</div></div></div>
		</li>
			...
			if(!$slide->isStaticSlide()){
				...
				<div id="slide-thumbnail-settings-content" style="display:none">
					...
					<div style="margin-top:10px">
						...
						<input type="button" id="slide_thumb_button" style="width:110px !important; display:inline-block;" class="button-image-select button-primary revblue" value="选择图片" original-title="">
						<input type="button" id="slide_thumb_button_remove" style="margin-right:20px !important; width:85px !important; display:inline-block;" class="button-image-remove button-primary revred"  value="删除" original-title="">
