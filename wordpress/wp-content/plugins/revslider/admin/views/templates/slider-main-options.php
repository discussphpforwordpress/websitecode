							...
							<div class="inside" style="display:none;">
								...
								<div id="general-defaults" style="display:none">
									...
									<div id="reset-to-default-inputs">
										...
										<select id="def-background_fit" name="def-background_fit" style="max-width: 105px;" class="withlabel">
											<option value="cover"<?php selected($bgFit, 'cover');?>>覆盖</option>
											<option value="contain"<?php selected($bgFit, 'contain');?>>包含</option>
											<option value="percentage"<?php selected($bgFit, 'percentage');?>>(%, %)</option>
											<option value="normal"<?php selected($bgFit, 'normal');?>>正常</option>
										</select>
										...
										<select name="def-bg_position" id="slide_bg_position" class="withlabel">
											<option value="center top"<?php selected($bgPosition, 'center top');?>>中上</option>
											<option value="center right"<?php selected($bgPosition, 'center right');?>>中右</option>
											<option value="center bottom"<?php selected($bgPosition, 'center bottom');?>>中下</option>
											<option value="center center"<?php selected($bgPosition, 'center center');?>>中心</option>
											<option value="left top"<?php selected($bgPosition, 'left top');?>>左上</option>
											<option value="left center"<?php selected($bgPosition, 'left center');?>>左中</option>
											<option value="left bottom"<?php selected($bgPosition, 'left bottom');?>>左下</option>
											<option value="right top"<?php selected($bgPosition, 'right top');?>>右上</option>
											<option value="right center"<?php selected($bgPosition, 'right center');?>>右中</option>
											<option value="right bottom"<?php selected($bgPosition, 'right bottom');?>>右下</option>
										</select>
										...
										<select name="def-bg_repeat" id="slide_bg_repeat" style="margin-right:20px">
											<option value="no-repeat"<?php selected($bgRepeat, 'no-repeat');?>>不平铺</option>
											<option value="repeat"<?php selected($bgRepeat, 'repeat');?>>平铺</option>
											<option value="repeat-x"<?php selected($bgRepeat, 'repeat-x');?>>水平平铺</option>
											<option value="repeat-y"<?php selected($bgRepeat, 'repeat-y');?>>垂直平铺</option>
										</select>
										<div class="clear"></div>
								...
								<div id="general-progressbar" style="display:none">
									...
									<div id="progressbar_settings">
										...
										<input type="text" class="my-color-field rs-layer-input-field tipsy_enabled_top withlabel"  id="progressbar_color" data-editing="进度条颜色" name="progressbar_color" value="<?php echo TPColorpicker::convert(RevSliderFunctions::getVal($arrFieldsParams, 'progressbar_color', 'rgba(0,0,0,0.15)'), RevSliderFunctions::getVal($arrFieldsParams, 'progress_opa', 'false'));?>" />
										<script>
											jQuery(document).ready(function() {	
							...
							<div class="inside" style="display:none;">
								...
								<div id="navigation-tabs" style="display:none;">
									...
									<div id="nav_tabs_subs">
										...
										<span class="label" id="label_tabs_inner_outer" origtitle="<?php _e("把选项卡放到幻灯片容器里面或外面。在外面添加选项卡将减小幻灯片大小。");?>"><?php _e("Inner / outer", 'revslider');?></span>
										...
										<span class="label" id="label_tabs_align_hor" origtitle="<?php _e("选项卡水平位置");?>"><?php _e("Horizontal Align", 'revslider');?></span>
			...
			jQuery(document).ready(function($) {
				...
				*/
				...
				jQuery(".button-image-select-bg-img").click(function(){
					UniteAdminRev.openAddImageDialog("选择图片",function(urlImage, imageID){
						//update input:
