...
<table class="gwa-table">							
	<tr>
		...
		<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Type of the row.', 'test_plugin_textdomain' ); ?></p></td>
	</tr>
</table>
...
<div class="gwa-popup-tab-contents">
    ...
    <div class="gwa-popup-tab-content gwa-current">
     ...
     <table class="gwa-table" data-parent-id="type" data-parent-value="html"<?php echo empty( $postdata['type'] ) || ( !empty( $postdata['type'] ) && $postdata['type'] != 'html' ) ? ' style="display:none;"' : ''; ?>>
        <tr class="gwa-row-fullwidth">
            ...
            <td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Row content.', 'test_plugin_textdomain' ); ?></p></td>
        </tr>
        <tr class="gwa-row-fullwidth">
	        <th><label><?php _e( 'Tooltip Content', 'test_plugin_textdomain' ); ?></label></th>
            ...
            <td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Tooltip content.', 'test_plugin_textdomain' ); ?></p></td>
        </tr>
     </table>
	<!-- /HTML Content -->     
	...
	<div class="gwa-popup-tab-content">    
         ...
         <!-- HTML Content -->
		<div class="gwa-section" data-parent-id="type" data-parent-value="html"<?php echo empty( $postdata['type'] ) || ( !empty( $postdata['type'] ) && $postdata['type'] != 'html' ) ? ' style="display:none;"' : ''; ?>><span><?php _e( 'Content Style', 'test_plugin_textdomain' ); ?></span></div>         
         <table class="gwa-table" data-parent-id="type" data-parent-value="html"<?php echo empty( $postdata['type'] ) || ( !empty( $postdata['type'] ) && $postdata['type'] != 'html' ) ? ' style="display:none;"' : ''; ?>>
            <tr>
        ...
        <div class="gwa-section" data-parent-id="type" data-parent-value="html"<?php echo empty( $postdata['type'] ) || ( !empty( $postdata['type'] ) && $postdata['type'] != 'html' ) ? ' style="display:none;"' : ''; ?>><span><?php _e( 'Tooltip Style', 'test_plugin_textdomain' ); ?></span></div>  
        <table class="gwa-table" data-parent-id="type" data-parent-value="html"<?php echo empty( $postdata['type'] ) || ( !empty( $postdata['type'] ) && $postdata['type'] != 'html' ) ? ' style="display:none;"' : ''; ?>>
            <tr>
                <th><label><?php _e( 'Font Family', 'test_plugin_textdomain' ); ?></label></th>
                <td>
                ...
                <td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Font family of the tooltip content.', 'test_plugin_textdomain' ); ?></p></td>
            </tr>							
            <tr>
                <th><label><?php _e( 'Font Size / Line H.', 'test_plugin_textdomain' ); ?> <span class="gwa-info">(px)</span></label></th>
                <td><input type="text" name="html[tooltip][font-size]" value="<?php echo !empty( $postdata['html']['tooltip']['font-size'] ) ? esc_attr( $postdata['html']['tooltip']['font-size'] ) : 12; ?>" class="gwa-input-mid"><input type="text" name="html[tooltip][line-height]" value="<?php echo !empty( $postdata['html']['tooltip']['line-height'] ) ? esc_attr( $postdata['html']['tooltip']['line-height'] ) : 16; ?>" class="gwa-input-mid"><div class="gwa-icon-btn"><a href="#" title="<?php esc_attr_e( 'Bold', 'test_plugin_textdomain' ); ?>" data-action="font-style-bold"<?php echo !empty( $postdata['html']['tooltip']['font-style']['bold'] ) ? ' class="gwa-current"' : ''; ?>><i class="fa fa-bold"></i><input type="hidden" name="html[tooltip][font-style][bold]" value="<?php echo !empty( $postdata['html']['tooltip']['font-style']['bold'] ) ? esc_attr( $postdata['html']['tooltip']['font-style']['bold'] ) : ''; ?>"></a><a href="#" title="<?php esc_attr_e( 'Italic', 'test_plugin_textdomain' ); ?>" data-action="font-style-italic"<?php echo !empty( $postdata['html']['tooltip']['font-style']['italic'] ) ? ' class="gwa-current"' : ''; ?>><i class="fa fa-italic"></i><input type="hidden" name="html[tooltip][font-style][italic]" value="<?php echo !empty( $postdata['html']['tooltip']['font-style']['italic'] ) ? esc_attr( $postdata['html']['tooltip']['font-style']['italic'] ) : ''; ?>"></a><a href="#" title="<?php esc_attr_e( 'Strikethrough', 'test_plugin_textdomain' ); ?>" data-action="font-style-strikethrough"<?php echo !empty( $postdata['html']['tooltip']['font-style']['strikethrough'] ) ? ' class="gwa-current"' : ''; ?>><i class="fa fa-strikethrough"></i><input type="hidden" name="html[tooltip][font-style][strikethrough]" value="<?php echo !empty( $postdata['html']['tooltip']['font-style']['strikethrough'] ) ? esc_attr( $postdata['html']['tooltip']['font-style']['strikethrough'] ) : ''; ?>"></a></div></td>
            </tr>
        </table>         
        <!-- /HTML Content --> 
