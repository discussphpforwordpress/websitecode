...
switch ( $col_type ) {
	...
	?>
	<tr>
		<th><label><?php _e( 'Background Image', 'test_plugin_textdomain' ); ?></label></th>
		<td>
			<div class="gwa-img-upload">
				...
				<div class="gwa-input-btn"<?php echo ( !empty( $postdata['custom']['img']['data'] ) ? 'style="display:none;"': '' ); ?>><input type="text" name="custom[img][data]" value="<?php echo ( !empty( $postdata['custom']['img']['data'] ) ? esc_attr( $postdata['custom']['img']['data'] ) : '' ); ?>"><a href="#" title="<?php esc_attr_e( 'Add', 'test_plugin_textdomain' ); ?>" data-action="img-upload"><span class="gwa-icon-add"></span></a></div>
			</div>
		</td>
...
switch ( $col_type ) {
	...
	<tr class="gwa-row-fullwidth">
		<th><label><?php _e( 'HTML Content', 'test_plugin_textdomain' ); ?></label></th>
		...
		<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'HTML content of the header.', 'test_plugin_textdomain' ); ?></p></td>
	</tr>	
	<?php
	break;
}
...
switch ( $col_type ) {
	...
	?>
	<tr class="gwa-row-fullwidth">
		<th><label><?php _e( 'CSS Code', 'test_plugin_textdomain' ); ?></label></th>
		...
		<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'CSS code of the header.', 'test_plugin_textdomain' ); ?></p></td>
	</tr>	
	<?php
	break;
}
...
if ($content != '') : ?>
<div class="gwa-section"><span><?php _e( 'Type Specific Settings', 'test_plugin_textdomain' ); ?></span></div>
<table class="gwa-table">
<?php echo $content; ?>
</table>
<div class="gwa-table-separator"></div>
<div class="gwa-section"><span><?php _e( 'General Settings', 'test_plugin_textdomain' ); ?></span></div>
<?php endif; ?>
<!-- Specific Settings -->
...
switch ( $col_type ) {
	...
	?>
	<tr>
		<th><label><?php _e( 'Replace Header?', 'test_plugin_textdomain' ); ?></label></th>
		<td><p><label><span class="gwa-checkbox<?php echo !empty( $postdata['replace'] ) ? ' gwa-checked' : ''; ?>" tabindex="0"><span></span><input type="checkbox" name="replace" tabindex="-1" value="1" <?php echo !empty( $postdata['replace'] ) ? ' checked="checked"' : ''; ?> data-preview="<?php _e( 'HTML / Custom header', 'test_plugin_textdomain' ); ?>"></span></label></p></td>
		<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to replace to origianal header with custom HTML & CSS code.', 'test_plugin_textdomain' ); ?></p></td>									
	</tr>			
	<?php
	break;
}
