	...
	<form id="test-plugin-form" name="db-update-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
		...
		<div class="gwa-abox">
			<div class="gwa-abox-header">
				...
				<div class="gwa-abox-title"><?php _e( 'Database Update', 'test_plugin_textdomain' ); ?></div>
				...
				<div class="gwa-abox-content">
					<table class="gwa-table">
						<tr class="gwa-row-fullwidth">
							<td>
								<p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( '<strong>Your plugin database update is required.</strong> Create a backup of your existing table data first, then click to the "Update" button.', 'test_plugin_textdomain' ); ?></p>
							</td>					
						</tr>
						<tr class="gwa-row-fullwidth">
							<th><label><?php _e( 'Export Data', 'test_plugin_textdomain' ); ?></label></strong></th>
							<td><textarea rows="10"><?php echo  !empty( $old_db_tables ) ? esc_textarea( base64_encode( serialize( $old_db_tables ) ) ) : ''; ?></textarea></td>
							<td><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Copy the content of the textarea and save into a file on your hard drive.', 'test_plugin_textdomain' ); ?></p></td>									
						</tr>
					</table>			
				</div>
			 </div>
		...
		<!-- Submit -->
		<div class="gwa-submit"><button type="submit" class="gwa-btn-style1"><?php _e( 'Update', 'test_plugin_textdomain' ); ?></button></div>
		<!-- /Submit -->
