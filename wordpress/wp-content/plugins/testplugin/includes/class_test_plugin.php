...
class DX_TestPlugin {
    ...
    protected static $plugin_version = '0.0.1';
    protected static $db_version = '2.1.0';
    protected static $plugin_prefix = 'test_plugin';
    protected static $plugin_slug = 'test-plugin';
	...
	public static function uninstall( $network_wide ) {
		...
		if ( isset( $_COOKIE['test_plugin'] ) ) unset( $_COOKIE['test_plugin'] );
    ...
    public function load_plugin_textdomain() {
        ...
        load_plugin_textdomain( 'test_plugin_textdomain', FALSE, $this->plugin_dir . '/lang7216/' );
