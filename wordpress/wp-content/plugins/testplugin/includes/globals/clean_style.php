...
add_action( 'test_plugin_admin_global_style_opts_clean', 'test_plugin_global_table_style_clean' );

function test_plugin_global_table_style_clean( $table_data ) {
	
	?>
	<div class="gwa-table-separator"></div>
	<table class="gwa-table">
        <tr>
            <th><label><?php _e( 'Enable Column Borders?', 'test_plugin_textdomain' ); ?></label></th>
            ...
            <td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to enable or disable borders of the columns.', 'test_plugin_textdomain' ); ?></p></td>
        </tr>				
        <tr>
            <th><label><?php _e( 'Column Border Radius', 'test_plugin_textdomain' ); ?> <span class="gwa-info">(px)</span></label></th>
            ...
            <td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Top, Right, Bottom and Left border radius of the columns in pixels.', 'test_plugin_textdomain' ); ?></p></td>
        </tr>
        <tr>
            <th><label><?php _e( 'Enable Row Borders?', 'test_plugin_textdomain' ); ?></label></th>
            ...
            <td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to enable or disable row separator borders.', 'test_plugin_textdomain' ); ?></p></td>
        </tr>
        <tr>
            <th><label><?php _e( 'Enable Box Shadow?', 'test_plugin_textdomain' ); ?></label></th>
            ...
            <td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Whether to enable or disable shadow of the columns on hover/highlighted state.', 'test_plugin_textdomain' ); ?></p></td>
        </tr>						
	</table>
	<?php	
}