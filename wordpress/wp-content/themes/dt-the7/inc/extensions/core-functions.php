...
function dt_get_google_fonts( $font = '', $effect = '' ) {
	...
	?>
<!--四亩地	<link rel="stylesheet" type="text/css" href="<?php echo $protocol; ?>://fonts.googleapis.com/css?family=<?php echo str_replace( ' ', '+', $font ) . $effect; ?>">   -->
	<?php
}
...
//四 亩 地	return '//fonts.googleapis.com/css?family=' . str_replace( ' ', '+', $font ) . $effect;
}
