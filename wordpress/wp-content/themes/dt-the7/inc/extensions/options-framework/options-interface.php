...
function optionsframework_interface( $options, $cur_page_id ) {
	...
	foreach ( $options as $value ) {
		...
		case 'web_fonts':
			...
			$output .= '<div class="dt-web-fonts-preview"><span>四亩地是专业的WordPress主题和插件汉化网站simudi professional WordPress themes and plugins Chinese website</span><span class="spinner"></span></div>';
