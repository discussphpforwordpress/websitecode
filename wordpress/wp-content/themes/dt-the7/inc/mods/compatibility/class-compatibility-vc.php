...
if ( ! class_exists( 'Presscore_Modules_Compatibility_VC', false ) ) :
	...
	class Presscore_Modules_Compatibility_VC {
		...
		public static function enqueue_vc_inline_assets() {
			wp_enqueue_style( 'the7-vc-inline-editor', get_template_directory_uri() . '/inc/shortcodes/css/vc-inline-editor.css' );
			wp_enqueue_script( 'the7-vc-inline-editor', get_template_directory_uri() . '/inc/shortcodes/js/vc-inline-editor.js', array(), null, true );
		}
