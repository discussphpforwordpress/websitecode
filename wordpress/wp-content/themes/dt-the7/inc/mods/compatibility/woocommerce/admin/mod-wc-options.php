 ...
 * Heading definition.
 */
$options[] = array( "name" => _x('Product list', 'theme-options', 'the7mk2'), "type" => "heading", "id" => 'product-list' );
 ...
 * Heading definition.
 */
$options[] = array( "name" => _x("Product page", "theme-options", 'the7mk2'), "type" => "heading", "id" => "product-page" );
 ...
 * Heading definition.
 */
$options[] = array( "name" => _x('Cart & Checkout', 'theme-options', 'the7mk2'), "type" => "heading", "id" => "cart-and-checkout" );
