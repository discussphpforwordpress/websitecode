...
//四亩地			if ( ! presscore_theme_is_activated() )  {
				return $transient;
//四亩地			}
	...
	//四亩地		} else {
	//四亩地			echo '<input type="submit" class="button button-primary" name="register_theme" value="' . esc_attr( __( 'Register Theme', 'the7mk2' ) ) . '" />';
	//四亩地		}
		}
...
//四亩地			include 'registration-admin-notice-view.php';
		}
	}
