...
<div class="checkout-page-title">
	...
	<nav class="checkout-breadcrumbs">
	   <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class="current step-cart <?php echo dt_checkout_breadcrumb_class('cart'); ?>">
	   ...
	   <a href="<?php echo $woocommerce->cart->get_checkout_url(); ?>" class="step-checkout <?php echo dt_checkout_breadcrumb_class('checkout') ?>">
